...
set C_modelArgList {
	...
	{ sext_ln1014 int 62 regular  }
	{ N_1 int 15 regular  }
	{ data_buf int 32 regular {array 512 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ps", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ddr","offset": { "type": "dynamic","port_name": "ddr","bundle": "axilites"},"direction": "READWRITE"},{"cName": "driver","offset": { "type": "dynamic","port_name": "driver","bundle": "axilites"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln1014", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "N_1", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln1014 sc_in sc_lv 62 signal 1 } 
	{ N_1 sc_in sc_lv 15 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1014", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1014", "role": "default" }} , 
 	{ "name": "N_1", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "N_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1014 { ap_none {  { sext_ln1014 in_data 0 62 } } }
	N_1 { ap_none {  { N_1 in_data 0 15 } } }
	data_buf { ap_memory {  { data_buf_address0 mem_address 1 9 }  { data_buf_ce0 mem_ce 1 1 }  { data_buf_q0 mem_dout 0 32 } } }
}
