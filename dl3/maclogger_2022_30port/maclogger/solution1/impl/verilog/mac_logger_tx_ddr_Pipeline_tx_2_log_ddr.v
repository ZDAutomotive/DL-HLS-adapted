...
reg   [0:0] icmp_ln956_reg_146;
reg   [31:0] data_buf_load_reg_160;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln956_fu_119_p1;
wire    ap_block_pp0_stage0_01001;
reg   [14:0] i_1_fu_58;
wire   [14:0] add_ln956_fu_113_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln956_fu_107_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln956_reg_146 == 1'd0))) begin
        data_buf_load_reg_160 <= data_buf_q0;
    end
end

always @ (*) begin
    if (((icmp_ln956_fu_107_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln956_reg_146 == 1'd1))) begin
...
assign add_ln956_fu_113_p2 = (ap_sig_allocacmp_i + 15'd1);
...
assign data_buf_address0 = zext_ln956_fu_119_p1;

assign icmp_ln956_fu_107_p2 = ((ap_sig_allocacmp_i == N) ? 1'b1 : 1'b0);
...
assign zext_ln956_fu_119_p1 = ap_sig_allocacmp_i;
