...
wire   [8:0] data_buf_addr_39_reg_757;
...
wire   [63:0] empty_152_fu_459_p2;
wire   [0:0] icmp_ln55_fu_504_p2;
wire   [8:0] zext_ln55_fu_509_p1;
wire   [15:0] empty_153_fu_522_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln53_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10))) begin
        ...
        trunc_ln73_reg_782 <= {{empty_152_fu_459_p2[63:2]}};
    end
end
...
assign data_buf_addr_39_reg_757 = 64'd1;

assign data_buf_addr_reg_752 = 64'd0;

assign empty_152_fu_459_p2 = (fifo_axi_full1 + 64'd4096);

assign empty_153_fu_522_p1 = tmp_buf_q0[15:0];
...
assign icmp_ln80_fu_526_p2 = ((empty_153_fu_522_p1 == 16'd34952) ? 1'b1 : 1'b0);
