...
set Library     "hls"
set IPName      "mac_logger"
set Version     "1.0"
set DisplayName "Mac_logger"
set Revision    "2112771101"
set Description "An IP generated by Vitis HLS"
set Device      "zynquplus"
set AutoFamily  ""
set Taxonomy    "/VITIS_HLS_IP"
set target_part "xczu5ev-sfvc784-2-i"
set target_lang "verilog"
set has_xpm_memory "0"
set has_blackbox "false"
set sdx_kernel_type "hls"
set xo_kernel_name "mac_logger"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/maclogger_2022_30port/maclogger/solution1"
set debug_dir "D:/maclogger_2022_30port/maclogger/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {mac_logger_flow_control_loop_pipe_sequential_init
...
mac_logger_dataflow_in_loop_VITIS_LOOP_1263_1_log_header_RAM_AUTO_1R1W_memcore
mac_logger_dataflow_in_loop_VITIS_LOOP_1263_1_log_header_RAM_AUTO_1R1W
mac_logger_dataflow_in_loop_VITIS_LOOP_1263_1_data_buf3_RAM_AUTO_1R1W_memcore
mac_logger_dataflow_in_loop_VITIS_LOOP_1263_1_data_buf3_RAM_AUTO_1R1W
mac_logger_fifo_w32_d3_S
mac_logger_fifo_w32_d3_S
mac_logger_fifo_w32_d3_S
mac_logger_fifo_w32_d3_S
mac_logger_fifo_w16_d3_S
mac_logger_fifo_w32_d3_S
mac_logger_fifo_w16_d3_S
mac_logger_fifo_w32_d3_S
mac_logger_fifo_w16_d3_S
...
set Interfaces {
    s_axi_axilites {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 fifo_1 W 0x0 "Data signal of fifo" {{0 32 fifo W 0 "Bit 31 to 0 of fifo"}}} {0x14 fifo_2 W 0x0 "Data signal of fifo" {{0 32 fifo W 0 "Bit 63 to 32 of fifo"}}} {0x1c fifo_axi_full_offset_1 W 0x0 "Data signal of fifo_axi_full_offset" {{0 32 fifo_axi_full_offset W 0 "Bit 31 to 0 of fifo_axi_full_offset"}}} {0x20 fifo_axi_full_offset_2 W 0x0 "Data signal of fifo_axi_full_offset" {{0 32 fifo_axi_full_offset W 0 "Bit 63 to 32 of fifo_axi_full_offset"}}} {0x28 ddr_1 W 0x0 "Data signal of ddr" {{0 32 ddr W 0 "Bit 31 to 0 of ddr"}}} {0x2c ddr_2 W 0x0 "Data signal of ddr" {{0 32 ddr W 0 "Bit 63 to 32 of ddr"}}} {0x34 driver_1 W 0x0 "Data signal of driver" {{0 32 driver W 0 "Bit 31 to 0 of driver"}}} {0x38 driver_2 W 0x0 "Data signal of driver" {{0 32 driver W 0 "Bit 63 to 32 of driver"}}} {0x40 status W 0x0 "Data signal of status" {{0 32 status W 0 "Bit 31 to 0 of status"}}} {0x48 writeStatus W 0x0 "Data signal of writeStatus" {{0 16 writeStatus W 0 "Bit 15 to 0 of writeStatus"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 logger_vlan_enable_mask W 0x0 "Data signal of logger_vlan_enable_mask" {{0 32 logger_vlan_enable_mask W 0 "Bit 31 to 0 of logger_vlan_enable_mask"}}} {0x58 vlan100_received R 0x0 "Data signal of vlan100_received" {{0 32 vlan100_received R 0 "Bit 31 to 0 of vlan100_received"}}} {0x5c vlan100_received_ctrl R 0x0 "Control signal of vlan100_received" {{0 1 vlan100_received_ap_vld R 0 "Control signal vlan100_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 vlan101_received R 0x0 "Data signal of vlan101_received" {{0 32 vlan101_received R 0 "Bit 31 to 0 of vlan101_received"}}} {0x64 vlan101_received_ctrl R 0x0 "Control signal of vlan101_received" {{0 1 vlan101_received_ap_vld R 0 "Control signal vlan101_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 vlan102_received R 0x0 "Data signal of vlan102_received" {{0 32 vlan102_received R 0 "Bit 31 to 0 of vlan102_received"}}} {0x6c vlan102_received_ctrl R 0x0 "Control signal of vlan102_received" {{0 1 vlan102_received_ap_vld R 0 "Control signal vlan102_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 vlan103_received R 0x0 "Data signal of vlan103_received" {{0 32 vlan103_received R 0 "Bit 31 to 0 of vlan103_received"}}} {0x74 vlan103_received_ctrl R 0x0 "Control signal of vlan103_received" {{0 1 vlan103_received_ap_vld R 0 "Control signal vlan103_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 vlan104_received R 0x0 "Data signal of vlan104_received" {{0 32 vlan104_received R 0 "Bit 31 to 0 of vlan104_received"}}} {0x7c vlan104_received_ctrl R 0x0 "Control signal of vlan104_received" {{0 1 vlan104_received_ap_vld R 0 "Control signal vlan104_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 vlan105_received R 0x0 "Data signal of vlan105_received" {{0 32 vlan105_received R 0 "Bit 31 to 0 of vlan105_received"}}} {0x84 vlan105_received_ctrl R 0x0 "Control signal of vlan105_received" {{0 1 vlan105_received_ap_vld R 0 "Control signal vlan105_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 vlan106_received R 0x0 "Data signal of vlan106_received" {{0 32 vlan106_received R 0 "Bit 31 to 0 of vlan106_received"}}} {0x8c vlan106_received_ctrl R 0x0 "Control signal of vlan106_received" {{0 1 vlan106_received_ap_vld R 0 "Control signal vlan106_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 vlan107_received R 0x0 "Data signal of vlan107_received" {{0 32 vlan107_received R 0 "Bit 31 to 0 of vlan107_received"}}} {0x94 vlan107_received_ctrl R 0x0 "Control signal of vlan107_received" {{0 1 vlan107_received_ap_vld R 0 "Control signal vlan107_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 vlan108_received R 0x0 "Data signal of vlan108_received" {{0 32 vlan108_received R 0 "Bit 31 to 0 of vlan108_received"}}} {0x9c vlan108_received_ctrl R 0x0 "Control signal of vlan108_received" {{0 1 vlan108_received_ap_vld R 0 "Control signal vlan108_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 vlan109_received R 0x0 "Data signal of vlan109_received" {{0 32 vlan109_received R 0 "Bit 31 to 0 of vlan109_received"}}} {0xa4 vlan109_received_ctrl R 0x0 "Control signal of vlan109_received" {{0 1 vlan109_received_ap_vld R 0 "Control signal vlan109_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 vlan110_received R 0x0 "Data signal of vlan110_received" {{0 32 vlan110_received R 0 "Bit 31 to 0 of vlan110_received"}}} {0xac vlan110_received_ctrl R 0x0 "Control signal of vlan110_received" {{0 1 vlan110_received_ap_vld R 0 "Control signal vlan110_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 vlan111_received R 0x0 "Data signal of vlan111_received" {{0 32 vlan111_received R 0 "Bit 31 to 0 of vlan111_received"}}} {0xb4 vlan111_received_ctrl R 0x0 "Control signal of vlan111_received" {{0 1 vlan111_received_ap_vld R 0 "Control signal vlan111_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb8 vlan112_received R 0x0 "Data signal of vlan112_received" {{0 32 vlan112_received R 0 "Bit 31 to 0 of vlan112_received"}}} {0xbc vlan112_received_ctrl R 0x0 "Control signal of vlan112_received" {{0 1 vlan112_received_ap_vld R 0 "Control signal vlan112_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 vlan113_received R 0x0 "Data signal of vlan113_received" {{0 32 vlan113_received R 0 "Bit 31 to 0 of vlan113_received"}}} {0xc4 vlan113_received_ctrl R 0x0 "Control signal of vlan113_received" {{0 1 vlan113_received_ap_vld R 0 "Control signal vlan113_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc8 vlan114_received R 0x0 "Data signal of vlan114_received" {{0 32 vlan114_received R 0 "Bit 31 to 0 of vlan114_received"}}} {0xcc vlan114_received_ctrl R 0x0 "Control signal of vlan114_received" {{0 1 vlan114_received_ap_vld R 0 "Control signal vlan114_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xd0 vlan115_received R 0x0 "Data signal of vlan115_received" {{0 32 vlan115_received R 0 "Bit 31 to 0 of vlan115_received"}}} {0xd4 vlan115_received_ctrl R 0x0 "Control signal of vlan115_received" {{0 1 vlan115_received_ap_vld R 0 "Control signal vlan115_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xd8 vlan116_received R 0x0 "Data signal of vlan116_received" {{0 32 vlan116_received R 0 "Bit 31 to 0 of vlan116_received"}}} {0xdc vlan116_received_ctrl R 0x0 "Control signal of vlan116_received" {{0 1 vlan116_received_ap_vld R 0 "Control signal vlan116_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xe0 vlan117_received R 0x0 "Data signal of vlan117_received" {{0 32 vlan117_received R 0 "Bit 31 to 0 of vlan117_received"}}} {0xe4 vlan117_received_ctrl R 0x0 "Control signal of vlan117_received" {{0 1 vlan117_received_ap_vld R 0 "Control signal vlan117_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xe8 vlan118_received R 0x0 "Data signal of vlan118_received" {{0 32 vlan118_received R 0 "Bit 31 to 0 of vlan118_received"}}} {0xec vlan118_received_ctrl R 0x0 "Control signal of vlan118_received" {{0 1 vlan118_received_ap_vld R 0 "Control signal vlan118_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xf0 vlan119_received R 0x0 "Data signal of vlan119_received" {{0 32 vlan119_received R 0 "Bit 31 to 0 of vlan119_received"}}} {0xf4 vlan119_received_ctrl R 0x0 "Control signal of vlan119_received" {{0 1 vlan119_received_ap_vld R 0 "Control signal vlan119_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xf8 vlan120_received R 0x0 "Data signal of vlan120_received" {{0 32 vlan120_received R 0 "Bit 31 to 0 of vlan120_received"}}} {0xfc vlan120_received_ctrl R 0x0 "Control signal of vlan120_received" {{0 1 vlan120_received_ap_vld R 0 "Control signal vlan120_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x110 vlan121_received R 0x0 "Data signal of vlan121_received" {{0 32 vlan121_received R 0 "Bit 31 to 0 of vlan121_received"}}} {0x114 vlan121_received_ctrl R 0x0 "Control signal of vlan121_received" {{0 1 vlan121_received_ap_vld R 0 "Control signal vlan121_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x118 vlan122_received R 0x0 "Data signal of vlan122_received" {{0 32 vlan122_received R 0 "Bit 31 to 0 of vlan122_received"}}} {0x11c vlan122_received_ctrl R 0x0 "Control signal of vlan122_received" {{0 1 vlan122_received_ap_vld R 0 "Control signal vlan122_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x120 vlan123_received R 0x0 "Data signal of vlan123_received" {{0 32 vlan123_received R 0 "Bit 31 to 0 of vlan123_received"}}} {0x124 vlan123_received_ctrl R 0x0 "Control signal of vlan123_received" {{0 1 vlan123_received_ap_vld R 0 "Control signal vlan123_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x128 vlan124_received R 0x0 "Data signal of vlan124_received" {{0 32 vlan124_received R 0 "Bit 31 to 0 of vlan124_received"}}} {0x12c vlan124_received_ctrl R 0x0 "Control signal of vlan124_received" {{0 1 vlan124_received_ap_vld R 0 "Control signal vlan124_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x130 vlan125_received R 0x0 "Data signal of vlan125_received" {{0 32 vlan125_received R 0 "Bit 31 to 0 of vlan125_received"}}} {0x134 vlan125_received_ctrl R 0x0 "Control signal of vlan125_received" {{0 1 vlan125_received_ap_vld R 0 "Control signal vlan125_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x138 vlan126_received R 0x0 "Data signal of vlan126_received" {{0 32 vlan126_received R 0 "Bit 31 to 0 of vlan126_received"}}} {0x13c vlan126_received_ctrl R 0x0 "Control signal of vlan126_received" {{0 1 vlan126_received_ap_vld R 0 "Control signal vlan126_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x140 vlan127_received R 0x0 "Data signal of vlan127_received" {{0 32 vlan127_received R 0 "Bit 31 to 0 of vlan127_received"}}} {0x144 vlan127_received_ctrl R 0x0 "Control signal of vlan127_received" {{0 1 vlan127_received_ap_vld R 0 "Control signal vlan127_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x148 vlan128_received R 0x0 "Data signal of vlan128_received" {{0 32 vlan128_received R 0 "Bit 31 to 0 of vlan128_received"}}} {0x14c vlan128_received_ctrl R 0x0 "Control signal of vlan128_received" {{0 1 vlan128_received_ap_vld R 0 "Control signal vlan128_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x150 vlan129_received R 0x0 "Data signal of vlan129_received" {{0 32 vlan129_received R 0 "Bit 31 to 0 of vlan129_received"}}} {0x154 vlan129_received_ctrl R 0x0 "Control signal of vlan129_received" {{0 1 vlan129_received_ap_vld R 0 "Control signal vlan129_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x158 droped R 0x0 "Data signal of droped" {{0 32 droped R 0 "Bit 31 to 0 of droped"}}} {0x15c droped_ctrl R 0x0 "Control signal of droped" {{0 1 droped_ap_vld R 0 "Control signal droped_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x160 multicast_recv_enable W 0x0 "Data signal of multicast_recv_enable" {{0 32 multicast_recv_enable W 0 "Bit 31 to 0 of multicast_recv_enable"}}} {0x168 unicast_filter_enable W 0x0 "Data signal of unicast_filter_enable" {{0 32 unicast_filter_enable W 0 "Bit 31 to 0 of unicast_filter_enable"}}} {0x170 unicast_vlan100_macaddr_lsb W 0x0 "Data signal of unicast_vlan100_macaddr_lsb" {{0 32 unicast_vlan100_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan100_macaddr_lsb"}}} {0x178 unicast_vlan100_macaddr_msb W 0x0 "Data signal of unicast_vlan100_macaddr_msb" {{0 32 unicast_vlan100_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan100_macaddr_msb"}}} {0x180 unicast_vlan101_macaddr_lsb W 0x0 "Data signal of unicast_vlan101_macaddr_lsb" {{0 32 unicast_vlan101_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan101_macaddr_lsb"}}} {0x188 unicast_vlan101_macaddr_msb W 0x0 "Data signal of unicast_vlan101_macaddr_msb" {{0 32 unicast_vlan101_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan101_macaddr_msb"}}} {0x190 unicast_vlan102_macaddr_lsb W 0x0 "Data signal of unicast_vlan102_macaddr_lsb" {{0 32 unicast_vlan102_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan102_macaddr_lsb"}}} {0x198 unicast_vlan102_macaddr_msb W 0x0 "Data signal of unicast_vlan102_macaddr_msb" {{0 32 unicast_vlan102_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan102_macaddr_msb"}}} {0x1a0 unicast_vlan103_macaddr_lsb W 0x0 "Data signal of unicast_vlan103_macaddr_lsb" {{0 32 unicast_vlan103_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan103_macaddr_lsb"}}} {0x1a8 unicast_vlan103_macaddr_msb W 0x0 "Data signal of unicast_vlan103_macaddr_msb" {{0 32 unicast_vlan103_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan103_macaddr_msb"}}} {0x1b0 unicast_vlan104_macaddr_lsb W 0x0 "Data signal of unicast_vlan104_macaddr_lsb" {{0 32 unicast_vlan104_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan104_macaddr_lsb"}}} {0x1b8 unicast_vlan104_macaddr_msb W 0x0 "Data signal of unicast_vlan104_macaddr_msb" {{0 32 unicast_vlan104_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan104_macaddr_msb"}}} {0x1c0 unicast_vlan105_macaddr_lsb W 0x0 "Data signal of unicast_vlan105_macaddr_lsb" {{0 32 unicast_vlan105_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan105_macaddr_lsb"}}} {0x1c8 unicast_vlan105_macaddr_msb W 0x0 "Data signal of unicast_vlan105_macaddr_msb" {{0 32 unicast_vlan105_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan105_macaddr_msb"}}} {0x1d0 unicast_vlan106_macaddr_lsb W 0x0 "Data signal of unicast_vlan106_macaddr_lsb" {{0 32 unicast_vlan106_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan106_macaddr_lsb"}}} {0x1d8 unicast_vlan106_macaddr_msb W 0x0 "Data signal of unicast_vlan106_macaddr_msb" {{0 32 unicast_vlan106_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan106_macaddr_msb"}}} {0x1e0 unicast_vlan107_macaddr_lsb W 0x0 "Data signal of unicast_vlan107_macaddr_lsb" {{0 32 unicast_vlan107_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan107_macaddr_lsb"}}} {0x1e8 unicast_vlan107_macaddr_msb W 0x0 "Data signal of unicast_vlan107_macaddr_msb" {{0 32 unicast_vlan107_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan107_macaddr_msb"}}} {0x1f0 unicast_vlan108_macaddr_lsb W 0x0 "Data signal of unicast_vlan108_macaddr_lsb" {{0 32 unicast_vlan108_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan108_macaddr_lsb"}}} {0x1f8 unicast_vlan108_macaddr_msb W 0x0 "Data signal of unicast_vlan108_macaddr_msb" {{0 32 unicast_vlan108_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan108_macaddr_msb"}}} {0x200 unicast_vlan109_macaddr_lsb W 0x0 "Data signal of unicast_vlan109_macaddr_lsb" {{0 32 unicast_vlan109_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan109_macaddr_lsb"}}} {0x208 unicast_vlan109_macaddr_msb W 0x0 "Data signal of unicast_vlan109_macaddr_msb" {{0 32 unicast_vlan109_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan109_macaddr_msb"}}} {0x210 unicast_vlan110_macaddr_lsb W 0x0 "Data signal of unicast_vlan110_macaddr_lsb" {{0 32 unicast_vlan110_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan110_macaddr_lsb"}}} {0x218 unicast_vlan110_macaddr_msb W 0x0 "Data signal of unicast_vlan110_macaddr_msb" {{0 32 unicast_vlan110_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan110_macaddr_msb"}}} {0x220 unicast_vlan111_macaddr_lsb W 0x0 "Data signal of unicast_vlan111_macaddr_lsb" {{0 32 unicast_vlan111_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan111_macaddr_lsb"}}} {0x228 unicast_vlan111_macaddr_msb W 0x0 "Data signal of unicast_vlan111_macaddr_msb" {{0 32 unicast_vlan111_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan111_macaddr_msb"}}} {0x230 unicast_vlan112_macaddr_lsb W 0x0 "Data signal of unicast_vlan112_macaddr_lsb" {{0 32 unicast_vlan112_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan112_macaddr_lsb"}}} {0x238 unicast_vlan112_macaddr_msb W 0x0 "Data signal of unicast_vlan112_macaddr_msb" {{0 32 unicast_vlan112_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan112_macaddr_msb"}}} {0x240 unicast_vlan113_macaddr_lsb W 0x0 "Data signal of unicast_vlan113_macaddr_lsb" {{0 32 unicast_vlan113_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan113_macaddr_lsb"}}} {0x248 unicast_vlan113_macaddr_msb W 0x0 "Data signal of unicast_vlan113_macaddr_msb" {{0 32 unicast_vlan113_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan113_macaddr_msb"}}} {0x250 unicast_vlan114_macaddr_lsb W 0x0 "Data signal of unicast_vlan114_macaddr_lsb" {{0 32 unicast_vlan114_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan114_macaddr_lsb"}}} {0x258 unicast_vlan114_macaddr_msb W 0x0 "Data signal of unicast_vlan114_macaddr_msb" {{0 32 unicast_vlan114_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan114_macaddr_msb"}}} {0x260 unicast_vlan115_macaddr_lsb W 0x0 "Data signal of unicast_vlan115_macaddr_lsb" {{0 32 unicast_vlan115_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan115_macaddr_lsb"}}} {0x268 unicast_vlan115_macaddr_msb W 0x0 "Data signal of unicast_vlan115_macaddr_msb" {{0 32 unicast_vlan115_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan115_macaddr_msb"}}} {0x270 unicast_vlan116_macaddr_lsb W 0x0 "Data signal of unicast_vlan116_macaddr_lsb" {{0 32 unicast_vlan116_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan116_macaddr_lsb"}}} {0x278 unicast_vlan116_macaddr_msb W 0x0 "Data signal of unicast_vlan116_macaddr_msb" {{0 32 unicast_vlan116_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan116_macaddr_msb"}}} {0x280 unicast_vlan117_macaddr_lsb W 0x0 "Data signal of unicast_vlan117_macaddr_lsb" {{0 32 unicast_vlan117_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan117_macaddr_lsb"}}} {0x288 unicast_vlan117_macaddr_msb W 0x0 "Data signal of unicast_vlan117_macaddr_msb" {{0 32 unicast_vlan117_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan117_macaddr_msb"}}} {0x290 unicast_vlan118_macaddr_lsb W 0x0 "Data signal of unicast_vlan118_macaddr_lsb" {{0 32 unicast_vlan118_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan118_macaddr_lsb"}}} {0x298 unicast_vlan118_macaddr_msb W 0x0 "Data signal of unicast_vlan118_macaddr_msb" {{0 32 unicast_vlan118_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan118_macaddr_msb"}}} {0x2a0 unicast_vlan119_macaddr_lsb W 0x0 "Data signal of unicast_vlan119_macaddr_lsb" {{0 32 unicast_vlan119_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan119_macaddr_lsb"}}} {0x2a8 unicast_vlan119_macaddr_msb W 0x0 "Data signal of unicast_vlan119_macaddr_msb" {{0 32 unicast_vlan119_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan119_macaddr_msb"}}} {0x2b0 unicast_vlan120_macaddr_lsb W 0x0 "Data signal of unicast_vlan120_macaddr_lsb" {{0 32 unicast_vlan120_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan120_macaddr_lsb"}}} {0x2b8 unicast_vlan120_macaddr_msb W 0x0 "Data signal of unicast_vlan120_macaddr_msb" {{0 32 unicast_vlan120_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan120_macaddr_msb"}}} {0x2c0 unicast_vlan121_macaddr_lsb W 0x0 "Data signal of unicast_vlan121_macaddr_lsb" {{0 32 unicast_vlan121_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan121_macaddr_lsb"}}} {0x2c8 unicast_vlan121_macaddr_msb W 0x0 "Data signal of unicast_vlan121_macaddr_msb" {{0 32 unicast_vlan121_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan121_macaddr_msb"}}} {0x2d0 unicast_vlan122_macaddr_lsb W 0x0 "Data signal of unicast_vlan122_macaddr_lsb" {{0 32 unicast_vlan122_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan122_macaddr_lsb"}}} {0x2d8 unicast_vlan122_macaddr_msb W 0x0 "Data signal of unicast_vlan122_macaddr_msb" {{0 32 unicast_vlan122_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan122_macaddr_msb"}}} {0x2e0 unicast_vlan123_macaddr_lsb W 0x0 "Data signal of unicast_vlan123_macaddr_lsb" {{0 32 unicast_vlan123_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan123_macaddr_lsb"}}} {0x2e8 unicast_vlan123_macaddr_msb W 0x0 "Data signal of unicast_vlan123_macaddr_msb" {{0 32 unicast_vlan123_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan123_macaddr_msb"}}} {0x2f0 unicast_vlan124_macaddr_lsb W 0x0 "Data signal of unicast_vlan124_macaddr_lsb" {{0 32 unicast_vlan124_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan124_macaddr_lsb"}}} {0x2f8 unicast_vlan124_macaddr_msb W 0x0 "Data signal of unicast_vlan124_macaddr_msb" {{0 32 unicast_vlan124_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan124_macaddr_msb"}}} {0x300 unicast_vlan125_macaddr_lsb W 0x0 "Data signal of unicast_vlan125_macaddr_lsb" {{0 32 unicast_vlan125_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan125_macaddr_lsb"}}} {0x308 unicast_vlan125_macaddr_msb W 0x0 "Data signal of unicast_vlan125_macaddr_msb" {{0 32 unicast_vlan125_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan125_macaddr_msb"}}} {0x310 unicast_vlan126_macaddr_lsb W 0x0 "Data signal of unicast_vlan126_macaddr_lsb" {{0 32 unicast_vlan126_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan126_macaddr_lsb"}}} {0x318 unicast_vlan126_macaddr_msb W 0x0 "Data signal of unicast_vlan126_macaddr_msb" {{0 32 unicast_vlan126_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan126_macaddr_msb"}}} {0x320 unicast_vlan127_macaddr_lsb W 0x0 "Data signal of unicast_vlan127_macaddr_lsb" {{0 32 unicast_vlan127_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan127_macaddr_lsb"}}} {0x328 unicast_vlan127_macaddr_msb W 0x0 "Data signal of unicast_vlan127_macaddr_msb" {{0 32 unicast_vlan127_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan127_macaddr_msb"}}} {0x330 unicast_vlan128_macaddr_lsb W 0x0 "Data signal of unicast_vlan128_macaddr_lsb" {{0 32 unicast_vlan128_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan128_macaddr_lsb"}}} {0x338 unicast_vlan128_macaddr_msb W 0x0 "Data signal of unicast_vlan128_macaddr_msb" {{0 32 unicast_vlan128_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan128_macaddr_msb"}}} {0x340 unicast_vlan129_macaddr_lsb W 0x0 "Data signal of unicast_vlan129_macaddr_lsb" {{0 32 unicast_vlan129_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan129_macaddr_lsb"}}} {0x348 unicast_vlan129_macaddr_msb W 0x0 "Data signal of unicast_vlan129_macaddr_msb" {{0 32 unicast_vlan129_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan129_macaddr_msb"}}} {0x350 log_all_mask W 0x0 "Data signal of log_all_mask" {{0 32 log_all_mask W 0 "Bit 31 to 0 of log_all_mask"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_axilites m_axi_fifo_axi_full m_axi_mac_fifo m_axi_ps"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_fifo_axi_full {
        ...
        data_width "32"
        port_prefix "m_axi_fifo_axi_full"
        param_prefix "C_M_AXI_FIFO_AXI_FULL"
    ...
    m_axi_mac_fifo {
        ...
        data_width "32"
        port_prefix "m_axi_mac_fifo"
        param_prefix "C_M_AXI_MAC_FIFO"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_axilites"
    ...
    m_axi_ps {
        ...
        preferredUsageValue "MEMORY"
        handshake ""
        busParams "NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 64 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_WRITE HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "ps"
        ctype {
            AWLEN {
                Type "integer unsigned"
        ...
        data_width "32"
        port_prefix "m_axi_ps"
        param_prefix "C_M_AXI_PS"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_axilites"
