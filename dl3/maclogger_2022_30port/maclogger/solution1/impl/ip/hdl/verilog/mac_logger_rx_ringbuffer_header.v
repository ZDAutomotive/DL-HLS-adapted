...
wire  signed [61:0] trunc_ln28_fu_92_p4;
reg   [61:0] trunc_ln28_reg_149;
wire  signed [61:0] trunc_ln32_fu_113_p4;
reg   [61:0] trunc_ln32_reg_164;
...
wire   [31:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_m_axi_ps_WDATA;
wire   [3:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_m_axi_ps_WSTRB;
...
wire   [2:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_log_header_address0;
...
wire   [31:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_log_header_d0;
...
wire   [31:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_m_axi_ps_WDATA;
wire   [3:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_m_axi_ps_WSTRB;
...
wire   [2:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_tap_header_address0;
...
wire   [31:0] grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_tap_header_d0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state18) & (grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state18) & (grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_ap_done == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln28_reg_149 <= {{log_ddr[63:2]}};
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        trunc_ln32_reg_164 <= {{tap_ddr[63:2]}};
    end
end
...
assign trunc_ln28_fu_92_p4 = {{log_ddr[63:2]}};

assign trunc_ln32_fu_113_p4 = {{tap_ddr[63:2]}};
