...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set baudoutn_0 [ create_bd_port -dir O baudoutn_0 ]
  set rxdi_0 [ create_bd_port -dir I rxdi_0 ]
  set sleep_0 [ create_bd_port -dir O sleep_0 ]
  set sout_0 [ create_bd_port -dir O sout_0 ]
  set txdo_0 [ create_bd_port -dir O txdo_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_gpio_eth/S_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins CHIPDLIN_1/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M02_AXI] [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net CHIPDLIN_0_irq [get_bd_pins CHIPDLIN_1/irq] [get_bd_pins ila_1/probe0] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net CHIPDLIN_0_sleep [get_bd_ports sleep_0] [get_bd_pins CHIPDLIN_1/sleep] [get_bd_pins ila_1/probe9]
  connect_bd_net -net CHIPDLIN_1_txdo [get_bd_ports txdo_0] [get_bd_pins CHIPDLIN_1/txdo]
  connect_bd_net -net axi_uart16550_0_baudoutn [get_bd_ports baudoutn_0] [get_bd_pins axi_uart16550_0/baudoutn]
  connect_bd_net -net axi_uart16550_0_ddis [get_bd_pins axi_uart16550_0/ddis] [get_bd_pins ila_1/probe1]
  connect_bd_net -net axi_uart16550_0_dtrn [get_bd_pins axi_uart16550_0/dtrn] [get_bd_pins ila_1/probe2]
  connect_bd_net -net axi_uart16550_0_ip2intc_irpt [get_bd_pins axi_uart16550_0/ip2intc_irpt] [get_bd_pins ila_1/probe8]
  connect_bd_net -net axi_uart16550_0_out1n [get_bd_pins axi_uart16550_0/out1n] [get_bd_pins ila_1/probe3]
  connect_bd_net -net axi_uart16550_0_out2n [get_bd_pins axi_uart16550_0/out2n] [get_bd_pins ila_1/probe4]
  connect_bd_net -net axi_uart16550_0_rtsn [get_bd_pins axi_uart16550_0/rtsn] [get_bd_pins ila_1/probe5]
  connect_bd_net -net axi_uart16550_0_rxrdyn [get_bd_pins axi_uart16550_0/rxrdyn] [get_bd_pins ila_1/probe6]
  connect_bd_net -net axi_uart16550_0_sout [get_bd_ports sout_0] [get_bd_pins axi_uart16550_0/sout]
  connect_bd_net -net axi_uart16550_0_txrdyn [get_bd_pins axi_uart16550_0/txrdyn] [get_bd_pins ila_1/probe7]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins CHIPDLIN_1/s00_axi_aclk] [get_bd_pins axi_gpio_eth/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins CHIPDLIN_1/s00_axi_aresetn] [get_bd_pins axi_gpio_eth/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net rxdi_1_1 [get_bd_ports rxdi_0] [get_bd_pins CHIPDLIN_1/rxdi] [get_bd_pins ila_1/probe10]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_uart16550_0/freeze] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_uart16550_0/ctsn] [get_bd_pins axi_uart16550_0/dcdn] [get_bd_pins axi_uart16550_0/dsrn] [get_bd_pins axi_uart16550_0/rin] [get_bd_pins axi_uart16550_0/sin] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs CHIPDLIN_1/S00_AXI/S00_AXI_reg] SEG_CHIPDLIN_1_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_eth/S_AXI/Reg] SEG_axi_gpio_eth_Reg
