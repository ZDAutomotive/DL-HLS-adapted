...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFBFU ,0x00000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFBFU, 0x00000000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B02600U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B02600U);
/*##################################################################### */
...
unsigned long psu_peripherals_init_data(void)
{
    ...
    */
	PSU_Mask_Write(CRF_APB_RST_FPD_TOP_OFFSET, 0x000E007EU, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(2,3,2,3,3,0,1,1);
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD410014, 0x00000077U ,0x00000022U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG1_OFFSET, 0x00000077U, 0x00000022U);
/*##################################################################### */
