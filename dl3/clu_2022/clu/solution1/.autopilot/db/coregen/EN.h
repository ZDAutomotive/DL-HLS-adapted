...
#define EN_BITS_CAN_PTR_DATA       64
#define EN_ADDR_UART_PTR_DATA      0x1c
#define EN_BITS_UART_PTR_DATA      64
#define EN_ADDR_LIN_PTR_DATA       0x28
#define EN_BITS_LIN_PTR_DATA       64
#define EN_ADDR_RECEIVED_CAN_DATA  0x34
#define EN_BITS_RECEIVED_CAN_DATA  32
#define EN_ADDR_RECEIVED_CAN_CTRL  0x38
#define EN_ADDR_RECEIVED_UART_DATA 0x44
#define EN_BITS_RECEIVED_UART_DATA 32
#define EN_ADDR_RECEIVED_UART_CTRL 0x48
#define EN_ADDR_RECEIVED_LIN_DATA  0x54
#define EN_BITS_RECEIVED_LIN_DATA  32
#define EN_ADDR_RECEIVED_LIN_CTRL  0x58
#define EN_ADDR_CAN_EN_DATA        0x64
#define EN_BITS_CAN_EN_DATA        32
#define EN_ADDR_UART_EN_DATA       0x6c
#define EN_BITS_UART_EN_DATA       8
#define EN_ADDR_LIN_EN_DATA        0x74
#define EN_BITS_LIN_EN_DATA        32
#define EN_ADDR_CAN_DDR_DATA       0x7c
#define EN_BITS_CAN_DDR_DATA       64
#define EN_ADDR_UART_DDR_DATA      0x88
#define EN_BITS_UART_DDR_DATA      64
#define EN_ADDR_LIN_DDR_DATA       0x94
#define EN_BITS_LIN_DDR_DATA       64
