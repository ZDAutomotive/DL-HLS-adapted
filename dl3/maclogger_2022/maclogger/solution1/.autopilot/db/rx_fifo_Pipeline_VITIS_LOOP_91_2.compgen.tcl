...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename tmp_buf \
    op interface \
    ports { tmp_buf_address0 { O 2 vector } tmp_buf_ce0 { O 1 bit } tmp_buf_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'tmp_buf'"
}
}
