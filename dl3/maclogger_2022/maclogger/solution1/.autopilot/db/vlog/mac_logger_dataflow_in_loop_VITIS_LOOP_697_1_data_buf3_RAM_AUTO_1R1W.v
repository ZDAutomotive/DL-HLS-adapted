...
`timescale 1ns/1ps
module mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_data_buf3_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 32,
    AddressRange = 512,
    AddressWidth = 9,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_data_buf3_RAM_AUTO_1R1W_memcore mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_data_buf3_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
