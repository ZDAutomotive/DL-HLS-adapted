...
# 32 "mac_logger_test.cpp"
 ...
 tapddr[6] = 0;
 ts = 0x010212345678;
 VITIS_LOOP_87_1: for(i=0; i < 0x1002/4; i++){
   fifo[i] = i;
 }
 ...
 VITIS_LOOP_94_2: for(i=0; i < sizeof(fifo_axi_full); i++){
   fifo_axi_full[i] = i;
 }
...
# 113 "mac_logger_test.cpp"
 VITIS_LOOP_113_3: for(i = 0; i < 2; i++) {
   ts+= 0x10;
   if((i % 2)) {
   fifo[0x0000001c/4] = 1;
   fifo[0x00000024/4] = 1522;

   fifo_axi_full[0x00001000/4] = 0;
 ...
 VITIS_LOOP_187_4: for(int i = 0; i < 11; i++) {
 ...
 VITIS_LOOP_195_5: for(int j = 0; j < 30; j++) {
   printf("index: %d ", j);
   VITIS_LOOP_197_6: for(i=0; i < 30; i++){
  printf(" %x ", logddr[(2048*j + 7*4 + i*4)/4]);
   }
   printf(" \r\n");
 }
 printf("tap****************\r\n");
 VITIS_LOOP_203_7: for(int j = 0; j < 30; j++) {
   printf("index: %d ", j);
   VITIS_LOOP_205_8: for(i=0; i < 30; i++){
