...
set solution_dir "D:/maclogger_2022/maclogger/solution1"
set debug_dir "D:/maclogger_2022/maclogger/solution1/.debug"
...
mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_log_header_RAM_AUTO_1R1W_memcore
mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_log_header_RAM_AUTO_1R1W
mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_data_buf3_RAM_AUTO_1R1W_memcore
...
set Interfaces {
    s_axi_axilites {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 fifo_1 W 0x0 "Data signal of fifo" {{0 32 fifo W 0 "Bit 31 to 0 of fifo"}}} {0x14 fifo_2 W 0x0 "Data signal of fifo" {{0 32 fifo W 0 "Bit 63 to 32 of fifo"}}} {0x1c ddr_1 W 0x0 "Data signal of ddr" {{0 32 ddr W 0 "Bit 31 to 0 of ddr"}}} {0x20 ddr_2 W 0x0 "Data signal of ddr" {{0 32 ddr W 0 "Bit 63 to 32 of ddr"}}} {0x28 status W 0x0 "Data signal of status" {{0 32 status W 0 "Bit 31 to 0 of status"}}} {0x30 writeStatus W 0x0 "Data signal of writeStatus" {{0 16 writeStatus W 0 "Bit 15 to 0 of writeStatus"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 logger_vlan_enable_mask W 0x0 "Data signal of logger_vlan_enable_mask" {{0 32 logger_vlan_enable_mask W 0 "Bit 31 to 0 of logger_vlan_enable_mask"}}} {0x40 vlan100_received R 0x0 "Data signal of vlan100_received" {{0 32 vlan100_received R 0 "Bit 31 to 0 of vlan100_received"}}} {0x44 vlan100_received_ctrl R 0x0 "Control signal of vlan100_received" {{0 1 vlan100_received_ap_vld R 0 "Control signal vlan100_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 vlan101_received R 0x0 "Data signal of vlan101_received" {{0 32 vlan101_received R 0 "Bit 31 to 0 of vlan101_received"}}} {0x4c vlan101_received_ctrl R 0x0 "Control signal of vlan101_received" {{0 1 vlan101_received_ap_vld R 0 "Control signal vlan101_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 vlan102_received R 0x0 "Data signal of vlan102_received" {{0 32 vlan102_received R 0 "Bit 31 to 0 of vlan102_received"}}} {0x54 vlan102_received_ctrl R 0x0 "Control signal of vlan102_received" {{0 1 vlan102_received_ap_vld R 0 "Control signal vlan102_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 vlan103_received R 0x0 "Data signal of vlan103_received" {{0 32 vlan103_received R 0 "Bit 31 to 0 of vlan103_received"}}} {0x5c vlan103_received_ctrl R 0x0 "Control signal of vlan103_received" {{0 1 vlan103_received_ap_vld R 0 "Control signal vlan103_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 vlan104_received R 0x0 "Data signal of vlan104_received" {{0 32 vlan104_received R 0 "Bit 31 to 0 of vlan104_received"}}} {0x64 vlan104_received_ctrl R 0x0 "Control signal of vlan104_received" {{0 1 vlan104_received_ap_vld R 0 "Control signal vlan104_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 vlan105_received R 0x0 "Data signal of vlan105_received" {{0 32 vlan105_received R 0 "Bit 31 to 0 of vlan105_received"}}} {0x6c vlan105_received_ctrl R 0x0 "Control signal of vlan105_received" {{0 1 vlan105_received_ap_vld R 0 "Control signal vlan105_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 vlan106_received R 0x0 "Data signal of vlan106_received" {{0 32 vlan106_received R 0 "Bit 31 to 0 of vlan106_received"}}} {0x74 vlan106_received_ctrl R 0x0 "Control signal of vlan106_received" {{0 1 vlan106_received_ap_vld R 0 "Control signal vlan106_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 vlan107_received R 0x0 "Data signal of vlan107_received" {{0 32 vlan107_received R 0 "Bit 31 to 0 of vlan107_received"}}} {0x7c vlan107_received_ctrl R 0x0 "Control signal of vlan107_received" {{0 1 vlan107_received_ap_vld R 0 "Control signal vlan107_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 vlan108_received R 0x0 "Data signal of vlan108_received" {{0 32 vlan108_received R 0 "Bit 31 to 0 of vlan108_received"}}} {0x84 vlan108_received_ctrl R 0x0 "Control signal of vlan108_received" {{0 1 vlan108_received_ap_vld R 0 "Control signal vlan108_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 vlan109_received R 0x0 "Data signal of vlan109_received" {{0 32 vlan109_received R 0 "Bit 31 to 0 of vlan109_received"}}} {0x8c vlan109_received_ctrl R 0x0 "Control signal of vlan109_received" {{0 1 vlan109_received_ap_vld R 0 "Control signal vlan109_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 droped R 0x0 "Data signal of droped" {{0 32 droped R 0 "Bit 31 to 0 of droped"}}} {0x94 droped_ctrl R 0x0 "Control signal of droped" {{0 1 droped_ap_vld R 0 "Control signal droped_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 multicast_recv_enable W 0x0 "Data signal of multicast_recv_enable" {{0 32 multicast_recv_enable W 0 "Bit 31 to 0 of multicast_recv_enable"}}} {0xa0 unicast_filter_enable W 0x0 "Data signal of unicast_filter_enable" {{0 32 unicast_filter_enable W 0 "Bit 31 to 0 of unicast_filter_enable"}}} {0xa8 unicast_vlan100_macaddr_lsb W 0x0 "Data signal of unicast_vlan100_macaddr_lsb" {{0 32 unicast_vlan100_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan100_macaddr_lsb"}}} {0xb0 unicast_vlan100_macaddr_msb W 0x0 "Data signal of unicast_vlan100_macaddr_msb" {{0 32 unicast_vlan100_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan100_macaddr_msb"}}} {0xb8 unicast_vlan101_macaddr_lsb W 0x0 "Data signal of unicast_vlan101_macaddr_lsb" {{0 32 unicast_vlan101_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan101_macaddr_lsb"}}} {0xc0 unicast_vlan101_macaddr_msb W 0x0 "Data signal of unicast_vlan101_macaddr_msb" {{0 32 unicast_vlan101_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan101_macaddr_msb"}}} {0xc8 unicast_vlan102_macaddr_lsb W 0x0 "Data signal of unicast_vlan102_macaddr_lsb" {{0 32 unicast_vlan102_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan102_macaddr_lsb"}}} {0xd0 unicast_vlan102_macaddr_msb W 0x0 "Data signal of unicast_vlan102_macaddr_msb" {{0 32 unicast_vlan102_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan102_macaddr_msb"}}} {0xd8 unicast_vlan103_macaddr_lsb W 0x0 "Data signal of unicast_vlan103_macaddr_lsb" {{0 32 unicast_vlan103_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan103_macaddr_lsb"}}} {0xe0 unicast_vlan103_macaddr_msb W 0x0 "Data signal of unicast_vlan103_macaddr_msb" {{0 32 unicast_vlan103_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan103_macaddr_msb"}}} {0xe8 unicast_vlan104_macaddr_lsb W 0x0 "Data signal of unicast_vlan104_macaddr_lsb" {{0 32 unicast_vlan104_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan104_macaddr_lsb"}}} {0xf0 unicast_vlan104_macaddr_msb W 0x0 "Data signal of unicast_vlan104_macaddr_msb" {{0 32 unicast_vlan104_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan104_macaddr_msb"}}} {0xf8 unicast_vlan105_macaddr_lsb W 0x0 "Data signal of unicast_vlan105_macaddr_lsb" {{0 32 unicast_vlan105_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan105_macaddr_lsb"}}} {0x100 unicast_vlan105_macaddr_msb W 0x0 "Data signal of unicast_vlan105_macaddr_msb" {{0 32 unicast_vlan105_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan105_macaddr_msb"}}} {0x108 unicast_vlan106_macaddr_lsb W 0x0 "Data signal of unicast_vlan106_macaddr_lsb" {{0 32 unicast_vlan106_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan106_macaddr_lsb"}}} {0x110 unicast_vlan106_macaddr_msb W 0x0 "Data signal of unicast_vlan106_macaddr_msb" {{0 32 unicast_vlan106_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan106_macaddr_msb"}}} {0x118 unicast_vlan107_macaddr_lsb W 0x0 "Data signal of unicast_vlan107_macaddr_lsb" {{0 32 unicast_vlan107_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan107_macaddr_lsb"}}} {0x120 unicast_vlan107_macaddr_msb W 0x0 "Data signal of unicast_vlan107_macaddr_msb" {{0 32 unicast_vlan107_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan107_macaddr_msb"}}} {0x128 unicast_vlan108_macaddr_lsb W 0x0 "Data signal of unicast_vlan108_macaddr_lsb" {{0 32 unicast_vlan108_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan108_macaddr_lsb"}}} {0x130 unicast_vlan108_macaddr_msb W 0x0 "Data signal of unicast_vlan108_macaddr_msb" {{0 32 unicast_vlan108_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan108_macaddr_msb"}}} {0x138 unicast_vlan109_macaddr_lsb W 0x0 "Data signal of unicast_vlan109_macaddr_lsb" {{0 32 unicast_vlan109_macaddr_lsb W 0 "Bit 31 to 0 of unicast_vlan109_macaddr_lsb"}}} {0x140 unicast_vlan109_macaddr_msb W 0x0 "Data signal of unicast_vlan109_macaddr_msb" {{0 32 unicast_vlan109_macaddr_msb W 0 "Bit 31 to 0 of unicast_vlan109_macaddr_msb"}}} {0x148 log_all_mask W 0x0 "Data signal of log_all_mask" {{0 32 log_all_mask W 0 "Bit 31 to 0 of log_all_mask"}}} {0x150 driver_1 W 0x0 "Data signal of driver" {{0 32 driver W 0 "Bit 31 to 0 of driver"}}} {0x154 driver_2 W 0x0 "Data signal of driver" {{0 32 driver W 0 "Bit 63 to 32 of driver"}}} {0x160 fifo_axi_full_offset_1 W 0x0 "Data signal of fifo_axi_full_offset" {{0 32 fifo_axi_full_offset W 0 "Bit 31 to 0 of fifo_axi_full_offset"}}} {0x164 fifo_axi_full_offset_2 W 0x0 "Data signal of fifo_axi_full_offset" {{0 32 fifo_axi_full_offset W 0 "Bit 63 to 32 of fifo_axi_full_offset"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
