...
wire   [8:0] data_buf_addr_19_reg_757;
...
reg   [5:0] trunc_ln_reg_845;
wire    ap_CS_fsm_state22;
wire  signed [1:0] add_fu_693_p3;
reg   [1:0] add_reg_850;
reg   [4:0] tmp_20_reg_856;
...
wire   [0:0] icmp_ln103_fu_736_p2;
reg   [0:0] icmp_ln103_reg_876;
...
wire   [7:0] tmp_13_fu_359_p4;
wire   [7:0] tmp_14_fu_369_p4;
wire   [7:0] tmp_15_fu_379_p4;
...
wire   [63:0] empty_92_fu_459_p2;
wire   [0:0] icmp_ln55_fu_504_p2;
wire   [8:0] zext_ln55_fu_509_p1;
wire   [15:0] empty_93_fu_522_p1;
wire   [3:0] tmp_18_fu_542_p4;
wire   [7:0] tmp_17_fu_532_p4;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state22)) begin
        ...
        tmp_20_reg_856 <= {{add_ln97_2_fu_677_p2[8:4]}};
        trunc_ln_reg_845 <= {{add_ln97_fu_671_p2[9:4]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln53_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10))) begin
        ...
        trunc_ln58_reg_782 <= {{empty_92_fu_459_p2[63:2]}};
    end
end
...
always @ (*) begin
    ...
    end else if (((icmp_ln103_reg_876 == 1'd0) & (icmp_ln53_reg_772 == 1'd0) & (1'b1 == ap_CS_fsm_state32))) begin
        data_buf_address0 = grp_rx_fifo_Pipeline_4_fu_292_data_buf_address0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state19)) begin
        ...
        data_buf_address1 = data_buf_addr_19_reg_757;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state31) | ((icmp_ln103_reg_876 == 1'd0) & (icmp_ln53_reg_772 == 1'd0) & (1'b1 == ap_CS_fsm_state32)))) begin
        m_axi_fifo_axi_full_ARADDR = grp_rx_fifo_Pipeline_4_fu_292_m_axi_fifo_axi_full_ARADDR;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state31) | ((icmp_ln103_reg_876 == 1'd0) & (icmp_ln53_reg_772 == 1'd0) & (1'b1 == ap_CS_fsm_state32)))) begin
        m_axi_fifo_axi_full_ARBURST = grp_rx_fifo_Pipeline_4_fu_292_m_axi_fifo_axi_full_ARBURST;
    end else if (((1'b1 == ap_CS_fsm_state23) | (1'b1 == ap_CS_fsm_state22))) begin
        m_axi_fifo_axi_full_ARBURST = grp_rx_fifo_Pipeline_rx_macfifo_data_fu_281_m_axi_fifo_axi_full_ARBURST;
    end else if (((1'b1 == ap_CS_fsm_state11) | ((icmp_ln53_fu_329_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state23 : begin
            if (((grp_rx_fifo_Pipeline_rx_macfifo_data_fu_281_ap_done == 1'b1) & (icmp_ln103_fu_736_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state23))) begin
                ap_NS_fsm = ap_ST_fsm_state32;
            end else if (((grp_rx_fifo_Pipeline_rx_macfifo_data_fu_281_ap_done == 1'b1) & (icmp_ln103_fu_736_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state23))) begin
...
always @ (*) begin
    ap_predicate_op146_call_state32 = ((icmp_ln103_reg_876 == 1'd0) & (icmp_ln53_reg_772 == 1'd0));
end

assign data_buf_addr_19_reg_757 = 64'd1;

assign data_buf_addr_reg_752 = 64'd0;

assign empty_92_fu_459_p2 = (fifo_axi_full1 + 64'd4096);

assign empty_93_fu_522_p1 = tmp_buf_q0[15:0];
...
assign icmp_ln103_fu_736_p2 = ((M_reg_833 == 4'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln80_fu_526_p2 = ((empty_93_fu_522_p1 == 16'd34952) ? 1'b1 : 1'b0);
...
assign or_ln1_fu_595_p4 = {{{trunc_ln84_fu_591_p1}, {tmp_19_fu_581_p4}}, {16'd0}};

assign or_ln2_fu_620_p4 = {{{trunc_ln88_fu_617_p1}, {trunc_ln54_1_reg_795}}, {8'd0}};

assign or_ln3_fu_727_p4 = {{{tmp_20_reg_856}, {1'd0}}, {sext_ln100_fu_724_p1}};

assign or_ln66_2_fu_399_p5 = {{{{tmp_13_fu_359_p4}, {tmp_14_fu_369_p4}}, {tmp_15_fu_379_p4}}, {tmp_16_fu_389_p4}};
...
assign or_ln_fu_552_p4 = {{{tmp_18_fu_542_p4}, {tmp_17_fu_532_p4}}, {8'd0}};
...
assign sext_ln73_fu_712_p1 = $signed(trunc_ln58_reg_782);

assign sext_ln84_fu_572_p1 = $signed(add_ln83_fu_566_p2);

assign tmp_13_fu_359_p4 = {{timestamp[39:32]}};

assign tmp_14_fu_369_p4 = {{timestamp[47:40]}};

assign tmp_15_fu_379_p4 = {{timestamp[55:48]}};

assign tmp_16_fu_389_p4 = {{timestamp[63:56]}};

assign tmp_17_fu_532_p4 = {{tmp_buf_q0[31:24]}};

assign tmp_18_fu_542_p4 = {{tmp_buf_q0[19:16]}};

assign tmp_19_fu_581_p4 = {{add_ln84_fu_576_p2[15:8]}};
