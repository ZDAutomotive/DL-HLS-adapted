...
attribute shreg_extract : string;
    ...
    signal data_buf_addr_19_reg_757 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal trunc_ln58_reg_782 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    signal trunc_ln_reg_845 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal empty_92_fu_459_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln55_fu_504_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln55_fu_509_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal empty_93_fu_522_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state22)) then
                ...
                trunc_ln_reg_845 <= add_ln97_fu_671_p2(9 downto 4);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln53_fu_329_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state10))) then
                ...
                trunc_ln58_reg_782 <= empty_92_fu_459_p2(63 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    data_buf_addr_19_reg_757 <= ap_const_lv64_1(9 - 1 downto 0);
    ...
    data_buf_address1_assign_proc : process(ap_CS_fsm_state9, data_buf_addr_19_reg_757, ap_CS_fsm_state10, ap_CS_fsm_state19)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state19)) then 
    ...
    empty_92_fu_459_p2 <= std_logic_vector(unsigned(fifo_axi_full1) + unsigned(ap_const_lv64_1000));
    empty_93_fu_522_p1 <= tmp_buf_q0(16 - 1 downto 0);
    ...
    icmp_ln80_fu_526_p2 <= "1" when (empty_93_fu_522_p1 = ap_const_lv16_8888) else "0";
    ...
    select_ln91_fu_655_p3 <= 
        ...
        sext_ln73_fu_712_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln58_reg_782),64));
