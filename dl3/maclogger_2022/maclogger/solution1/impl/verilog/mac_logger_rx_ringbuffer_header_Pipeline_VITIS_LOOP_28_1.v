...
module mac_logger_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [2:0] log_header_address0;
output   log_header_ce0;
output   log_header_we0;
output  [31:0] log_header_d0;
...
wire   [63:0] zext_ln28_fu_113_p1;
reg   [2:0] i_fu_50;
wire   [2:0] add_ln28_fu_96_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln28_fu_90_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln28_reg_134 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ps_addr_read_reg_138 <= m_axi_ps_RDATA;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln28_fu_90_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln28_reg_134 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln28_reg_134 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln28_reg_134 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln28_fu_96_p2 = (ap_sig_allocacmp_i_5 + 3'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln28_reg_134 == 1'd0) & (m_axi_ps_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln28_reg_134 == 1'd0) & (m_axi_ps_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln28_reg_134 == 1'd0) & (m_axi_ps_RVALID == 1'b0));
end
...
assign icmp_ln28_fu_90_p2 = ((ap_sig_allocacmp_i_5 == 3'd7) ? 1'b1 : 1'b0);

assign log_header_address0 = zext_ln28_fu_113_p1;

assign log_header_d0 = ps_addr_read_reg_138;
...
assign zext_ln28_fu_113_p1 = i_5_reg_129_pp0_iter1_reg;

endmodule //mac_logger_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1
