...
module mac_logger_dataflow_in_loop_VITIS_LOOP_697_1 (
        ap_clk,
        ap_rst,
        m_axi_ps_AWVALID,
        m_axi_ps_AWREADY,
...
mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_log_header_RAM_AUTO_1R1W #(
    .DataWidth( 32 ),
    .AddressRange( 7 ),
    .AddressWidth( 3 ))
log_header_U(
...
mac_logger_dataflow_in_loop_VITIS_LOOP_697_1_data_buf3_RAM_AUTO_1R1W #(
    .DataWidth( 32 ),
    .AddressRange( 512 ),
    .AddressWidth( 9 ))
data_buf3_U(
...
assign ap_idle = (tx_ddr_U0_ap_idle & rx_ringbuffer_header_U0_ap_idle & rx_fifo_U0_ap_idle & (data_buf3_t_empty_n ^ 1'b1) & (tap_header_t_empty_n ^ 1'b1) & (log_header_t_empty_n ^ 1'b1) & (driver_c_channel_empty_n ^ 1'b1) & (ddr_c_channel_empty_n ^ 1'b1) & entry_proc_U0_ap_idle);
...
endmodule //mac_logger_dataflow_in_loop_VITIS_LOOP_697_1
