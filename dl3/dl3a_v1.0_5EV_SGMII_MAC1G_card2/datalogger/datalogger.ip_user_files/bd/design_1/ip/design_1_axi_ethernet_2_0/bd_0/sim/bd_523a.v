...
//--------------------------------------------------------------------------------
//Command: generate_target bd_523a.bd
//Design : bd_523a
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_523a,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_523a,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_axi_ethernet_2_0.hwdef" *) 
module bd_523a
   (axi_rxd_arstn,
    axi_rxs_arstn,
    axi_txc_arstn,
  ...
  output gtpowergood;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.GTREF_CLK_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.GTREF_CLK_OUT, CLK_DOMAIN bd_523a_pcs_pma_0_gtrefclk_out, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) output gtref_clk_out;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXUSERCLK2_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXUSERCLK2_OUT, CLK_DOMAIN bd_523a_pcs_pma_0_rxuserclk2_out, FREQ_HZ 62500000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) output rxuserclk2_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXUSERCLK_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXUSERCLK_OUT, CLK_DOMAIN bd_523a_pcs_pma_0_rxuserclk_out, FREQ_HZ 62500000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) output rxuserclk_out;
  ...
  input signal_detect;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.USERCLK2_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.USERCLK2_OUT, CLK_DOMAIN bd_523a_pcs_pma_0_userclk2_out, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) output userclk2_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.USERCLK_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.USERCLK_OUT, CLK_DOMAIN bd_523a_pcs_pma_0_userclk_out, FREQ_HZ 62500000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) output userclk_out;
  ...
  bd_523a_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(s_axi_lite_resetn_1),
        .Res(util_vector_logic_0_Res));
  bd_523a_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  bd_523a_xlconstant_config_val_0 xlconstant_config_val
       (.dout(xlconstant_config_val_dout));
  bd_523a_xlconstant_config_vec_0 xlconstant_config_vec
       (.dout(xlconstant_config_vec_dout));
  bd_523a_xlconstant_phyadd_0 xlconstant_phyadd
