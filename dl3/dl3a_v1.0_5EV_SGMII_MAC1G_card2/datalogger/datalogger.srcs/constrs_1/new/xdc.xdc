...
#CAN0
set_property PACKAGE_PIN C11 [get_ports card2_can_tx_0]
set_property PACKAGE_PIN B10 [get_ports card2_can_rx_0]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_0]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_0]

#CAN1
set_property PACKAGE_PIN G11 [get_ports card2_can_tx_1]
set_property PACKAGE_PIN F10 [get_ports card2_can_rx_1]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_1]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_1]

#CAN2
set_property PACKAGE_PIN B11 [get_ports card2_can_tx_2]
set_property PACKAGE_PIN A10 [get_ports card2_can_rx_2]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_2]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_2]

#CAN3
set_property PACKAGE_PIN D12 [get_ports card2_can_tx_3]
set_property PACKAGE_PIN C12 [get_ports card2_can_rx_3]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_3]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_3]

#CAN4
set_property PACKAGE_PIN H12 [get_ports card2_can_tx_4]
set_property PACKAGE_PIN J12 [get_ports card2_can_rx_4]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_4]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_4]

#CAN5
set_property PACKAGE_PIN A12 [get_ports card2_can_tx_5]
set_property PACKAGE_PIN A11 [get_ports card2_can_rx_5]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_5]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_5]

#CAN6
set_property PACKAGE_PIN K14 [get_ports card2_can_tx_6]
set_property PACKAGE_PIN J14 [get_ports card2_can_rx_6]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_6]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_6]

#CAN7
set_property PACKAGE_PIN F11 [get_ports card2_can_tx_7]
set_property PACKAGE_PIN F12 [get_ports card2_can_rx_7]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_7]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_7]

#CAN8
set_property PACKAGE_PIN H13 [get_ports card2_can_tx_8]
set_property PACKAGE_PIN H14 [get_ports card2_can_rx_8]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_8]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_8]

#CAN9
set_property PACKAGE_PIN  E13 [get_ports card2_can_tx_9]
set_property PACKAGE_PIN E14 [get_ports card2_can_rx_9]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_9]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_9]

#CAN10
set_property PACKAGE_PIN F13 [get_ports card2_can_tx_10]
set_property PACKAGE_PIN G13 [get_ports card2_can_rx_10]

set_property IOSTANDARD LVCMOS33 [get_ports card2_can_tx_10]
set_property IOSTANDARD LVCMOS33 [get_ports card2_can_rx_10]

#CAN11
set_property PACKAGE_PIN AA8 [get_ports card2_can_tx_11]
set_property PACKAGE_PIN Y9 [get_ports card2_can_rx_11]
...
#set_property PACKAGE_PIN D5 [get_ports card2_gpio_resv1_1V8]
#set_property PACKAGE_PIN E8 [get_ports card2_gpio_resv2_1V8]
