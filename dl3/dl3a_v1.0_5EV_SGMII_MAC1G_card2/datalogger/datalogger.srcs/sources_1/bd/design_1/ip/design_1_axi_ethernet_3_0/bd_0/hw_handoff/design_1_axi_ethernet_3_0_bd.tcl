...
################################################################
# This is a generated script based on design: bd_926b
#
...
proc create_root_design { parentCell } {
  ...
  set gtref_clk [ create_bd_port -dir I -type clk -freq_hz 125000000 gtref_clk ]
  ...
  set ref_clk [ create_bd_port -dir I -type clk -freq_hz 50000000 ref_clk ]
  set rxoutclk [ create_bd_port -dir O -type clk rxoutclk ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] $rxoutclk
  set rxuserclk [ create_bd_port -dir I -type clk -freq_hz 62500000 rxuserclk ]
  set rxuserclk2 [ create_bd_port -dir I -type clk -freq_hz 62500000 rxuserclk2 ]
  ...
  set userclk [ create_bd_port -dir I -type clk -freq_hz 62500000 userclk ]
  set userclk2 [ create_bd_port -dir I -type clk -freq_hz 125000000 userclk2 ]
  ...
  set pcs_pma [ create_bd_cell -type ip -vlnv xilinx.com:ip:gig_ethernet_pcs_pma:16.2 pcs_pma ]
  set_property -dict [ list \
  ...
  connect_bd_net -net pcs_pma_gtpowergood [get_bd_ports gtpowergood] [get_bd_pins pcs_pma/gtpowergood]
