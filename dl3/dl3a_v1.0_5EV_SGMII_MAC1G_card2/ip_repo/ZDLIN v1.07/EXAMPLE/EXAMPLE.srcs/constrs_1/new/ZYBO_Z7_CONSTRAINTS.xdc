...
#LED USED FOR SLEEP SINGAL NOW!!!
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { led[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
#Digilent Zybo Z7_20 developement board specific constraints

#System clock configuration

#set_property IOSTANDARD LVCMOS33 [get_ports sys_clock]

#set_property PACKAGE_PIN K17 [get_ports sysclock]
...
#JE_1 txdo_0
#JE_4 rxdi_0
#LD3 sleep_0 - LED diode
set_property PACKAGE_PIN V12 [get_ports txdo_0]
set_property IOSTANDARD LVCMOS33 [get_ports txdo_0]
set_property IOSTANDARD LVCMOS33 [get_ports rxdi_0]
set_property PACKAGE_PIN H15 [get_ports rxdi_0]
set_property PACKAGE_PIN D18 [get_ports sleep_0]
set_property IOSTANDARD LVCMOS33 [get_ports sleep_0]

#AXI_UART550 specific pins
#JD_1
set_property PACKAGE_PIN T14 [get_ports baudoutn_0]
set_property IOSTANDARD LVCMOS33 [get_ports baudoutn_0]
#JD_4
set_property PACKAGE_PIN R14 [get_ports sout_0]
set_property IOSTANDARD LVCMOS33 [get_ports sout_0]

set_property PACKAGE_PIN U17 [get_ports {leds_4bits_tri_io[3]}]
