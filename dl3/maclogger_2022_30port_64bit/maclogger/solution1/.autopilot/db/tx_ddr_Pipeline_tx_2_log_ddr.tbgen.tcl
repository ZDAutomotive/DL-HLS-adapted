set moduleName tx_ddr_Pipeline_tx_2_log_ddr
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {tx_ddr_Pipeline_tx_2_log_ddr}
set C_modelType { void 0 }
set C_modelArgList {
	{ ps int 64 regular {axi_master 1}  }
	{ sext_ln965 int 61 regular  }
	{ N int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ps", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ddr","offset": { "type": "dynamic","port_name": "ddr","bundle": "axilites"},"direction": "READWRITE"},{"cName": "driver","offset": { "type": "dynamic","port_name": "driver","bundle": "axilites"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln965", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln965 sc_in sc_lv 61 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln965", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln965", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6", "Max" : "423"}
	, {"Name" : "Interval", "Min" : "6", "Max" : "423"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln965 { ap_none {  { sext_ln965 in_data 0 61 } } }
