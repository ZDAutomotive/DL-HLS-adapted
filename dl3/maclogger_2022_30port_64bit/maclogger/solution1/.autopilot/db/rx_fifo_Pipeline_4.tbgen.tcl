set moduleName rx_fifo_Pipeline_4
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "fifo_axi_full", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "fifo_axi_full_offset","offset": { "type": "dynamic","port_name": "fifo_axi_full_offset"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "or_ln3", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ or_ln3 sc_in sc_lv 9 signal 2 } 
	{ data_buf_address0 sc_out sc_lv 9 signal 3 } 
	{ data_buf_ce0 sc_out sc_logic 1 signal 3 } 
	{ data_buf_we0 sc_out sc_logic 1 signal 3 } 
	{ data_buf_d0 sc_out sc_lv 32 signal 3 } 
	{ M sc_in sc_lv 4 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "or_ln3", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "or_ln3", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	or_ln3 { ap_none {  { or_ln3 in_data 0 9 } } }
