set moduleName rx_fifo_Pipeline_VITIS_LOOP_71_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {rx_fifo_Pipeline_VITIS_LOOP_71_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ fifo_axi_full int 32 regular {axi_master 0}  }
	{ sext_ln73 int 62 regular  }
	{ tmp_buf int 32 regular {array 4 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fifo_axi_full", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "fifo_axi_full_offset","offset": { "type": "dynamic","port_name": "fifo_axi_full_offset"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "tmp_buf", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ tmp_buf_address0 sc_out sc_lv 2 signal 2 } 
	{ tmp_buf_ce0 sc_out sc_logic 1 signal 2 } 
	{ tmp_buf_we0 sc_out sc_logic 1 signal 2 } 
	{ tmp_buf_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_buf_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tmp_buf", "role": "we0" }} , 
 	{ "name": "tmp_buf_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "tmp_buf", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	tmp_buf { ap_memory {  { tmp_buf_address0 mem_address 1 2 }  { tmp_buf_ce0 mem_ce 1 1 }  { tmp_buf_we0 mem_we 1 1 }  { tmp_buf_d0 mem_din 1 32 } } }
}
