...
# 32 "mac_logger_test.cpp"
 ...
 logddr[0] = 0x000000007e7e7e7e;
 logddr[1] = 0x6400000000000000;
 logddr[2] = 0x0000000000080000;
 logddr[3] = 0x0000000000000000;

 tapddr[0] = 0x000000007e7e7e7e;
 tapddr[1] = 0x6400000000000000;
 tapddr[2] = 0x0000000000080000;
 tapddr[3] = 0x0000000000000000;

 ts = 0x886612345678;


 VITIS_LOOP_144_1: for(i=0; i < 0x1002/4; i++){
   fifo[i] = 0x66008888;
 }
 ...
 VITIS_LOOP_152_2: for(i=0; i < sizeof(fifo_axi_full); i++){
 ...
 fifo[0x0000001c/4] = 1;
 fifo[0x00000024/4] = 1522;


 fifo_axi_full[0x00001000/4] = 0x66008888;
# 190 "mac_logger_test.cpp"
   mac_logger(fifo,
  ...
  VITIS_LOOP_304_3: for(i=0; i < 514; i++){
   printf("ddr%llx\n",logddr[i]);
