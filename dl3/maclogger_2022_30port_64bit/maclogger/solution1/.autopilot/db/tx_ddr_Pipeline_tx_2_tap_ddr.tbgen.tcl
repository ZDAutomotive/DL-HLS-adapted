set moduleName tx_ddr_Pipeline_tx_2_tap_ddr
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {tx_ddr_Pipeline_tx_2_tap_ddr}
set C_modelType { void 0 }
set C_modelArgList {
	{ ps int 64 regular {axi_master 1}  }
	{ sext_ln1025 int 61 regular  }
	{ N_1 int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ps", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ddr","offset": { "type": "dynamic","port_name": "ddr","bundle": "axilites"},"direction": "READWRITE"},{"cName": "driver","offset": { "type": "dynamic","port_name": "driver","bundle": "axilites"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln1025", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "N_1", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln1025 sc_in sc_lv 61 signal 1 } 
	{ N_1 sc_in sc_lv 14 signal 2 } 
	{ data_buf_address0 sc_out sc_lv 9 signal 3 } 
	{ data_buf_ce0 sc_out sc_logic 1 signal 3 } 
	{ data_buf_q0 sc_in sc_lv 32 signal 3 } 
	{ data_buf_address1 sc_out sc_lv 9 signal 3 } 
	{ data_buf_ce1 sc_out sc_logic 1 signal 3 } 
	{ data_buf_q1 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1025", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln1025", "role": "default" }} , 
 	{ "name": "N_1", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "N_1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6", "Max" : "443"}
	, {"Name" : "Interval", "Min" : "6", "Max" : "443"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln1025 { ap_none {  { sext_ln1025 in_data 0 61 } } }
	N_1 { ap_none {  { N_1 in_data 0 14 } } }
	data_buf { ap_memory {  { data_buf_address0 mem_address 1 9 }  { data_buf_ce0 mem_ce 1 1 }  { data_buf_q0 mem_dout 0 32 }  { data_buf_address1 MemPortADDR2 1 9 }  { data_buf_ce1 MemPortCE2 1 1 }  { data_buf_q1 MemPortDOUT2 0 32 } } }
}
