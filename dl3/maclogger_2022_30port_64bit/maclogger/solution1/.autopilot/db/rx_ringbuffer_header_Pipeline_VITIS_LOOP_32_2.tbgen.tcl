...
set C_modelArgMapList {[ 
	{ "Name" : "ps", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "ddr","offset": { "type": "dynamic","port_name": "ddr","bundle": "axilites"},"direction": "READWRITE"},{"cName": "driver","offset": { "type": "dynamic","port_name": "driver","bundle": "axilites"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln32", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln32 sc_in sc_lv 61 signal 1 } 
	{ tap_header_address0 sc_out sc_lv 2 signal 2 } 
	{ tap_header_ce0 sc_out sc_logic 1 signal 2 } 
	{ tap_header_we0 sc_out sc_logic 1 signal 2 } 
	{ tap_header_d0 sc_out sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln32", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln32", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln32 { ap_none {  { sext_ln32 in_data 0 61 } } }
