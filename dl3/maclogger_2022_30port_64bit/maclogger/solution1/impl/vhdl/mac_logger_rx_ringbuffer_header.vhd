...
attribute shreg_extract : string;
    ...
    signal trunc_ln28_fu_92_p4 : STD_LOGIC_VECTOR (60 downto 0);
    signal trunc_ln28_reg_149 : STD_LOGIC_VECTOR (60 downto 0);
    signal trunc_ln32_fu_113_p4 : STD_LOGIC_VECTOR (60 downto 0);
    signal trunc_ln32_reg_164 : STD_LOGIC_VECTOR (60 downto 0);
    ...
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_m_axi_ps_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_m_axi_ps_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_log_header_address0 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_log_header_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_m_axi_ps_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_m_axi_ps_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_tap_header_address0 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_tap_header_d0 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln28_reg_149 <= log_ddr(63 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then
                trunc_ln32_reg_164 <= tap_ddr(63 downto 3);
            end if;
        end if;
    end process;
    ...
    begin
        if ((((m_axi_ps_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state10)) or (not(((m_axi_ps_ARREADY = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
            m_axi_ps_ARLEN <= ap_const_lv32_4;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state18) or (ap_const_logic_1 = ap_CS_fsm_state17))) then 
            m_axi_ps_ARLEN <= grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_m_axi_ps_ARLEN;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state9) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
            m_axi_ps_ARLEN <= grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_28_1_fu_74_m_axi_ps_ARLEN;
    ...
    tap_header_d0 <= grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_tap_header_d0;
    tap_header_we0 <= grp_rx_ringbuffer_header_Pipeline_VITIS_LOOP_32_2_fu_83_tap_header_we0;
    trunc_ln28_fu_92_p4 <= log_ddr(63 downto 3);
    trunc_ln32_fu_113_p4 <= tap_ddr(63 downto 3);
end behav;
