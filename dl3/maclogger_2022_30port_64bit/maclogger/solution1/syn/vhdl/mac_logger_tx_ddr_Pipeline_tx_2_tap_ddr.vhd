...
entity mac_logger_tx_ddr_Pipeline_tx_2_tap_ddr is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln1025 : IN STD_LOGIC_VECTOR (60 downto 0);
    N_1 : IN STD_LOGIC_VECTOR (13 downto 0);
...
architecture behav of mac_logger_tx_ddr_Pipeline_tx_2_tap_ddr is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1025_fu_127_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln1025_reg_196 : STD_LOGIC_VECTOR (0 downto 0);
    signal data_buf_load_reg_215 : STD_LOGIC_VECTOR (31 downto 0);
    signal data_buf_load_1_reg_220 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal zext_ln1028_fu_157_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln1028_1_fu_162_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_fu_66 : STD_LOGIC_VECTOR (13 downto 0);
    signal add_ln1025_fu_133_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_1 : STD_LOGIC_VECTOR (13 downto 0);
    signal trunc_ln1028_fu_139_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal shl_ln2_fu_143_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal or_ln1028_fu_151_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln1025_fu_127_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_66 <= add_ln1025_fu_133_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln1025_reg_196 <= icmp_ln1025_fu_127_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1025_reg_196 = ap_const_lv1_0))) then
                data_buf_load_1_reg_220 <= data_buf_q0;
    ...
    add_ln1025_fu_133_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv14_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1025_fu_127_p2)
    begin
        if (((icmp_ln1025_fu_127_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln1025_reg_196)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1025_reg_196 = ap_const_lv1_1))) then 
    ...
    data_buf_address0 <= zext_ln1028_1_fu_162_p1(9 - 1 downto 0);
    data_buf_address1 <= zext_ln1028_fu_157_p1(9 - 1 downto 0);
    ...
    icmp_ln1025_fu_127_p2 <= "1" when (ap_sig_allocacmp_i_1 = N_1) else "0";
    ...
    m_axi_ps_WDATA <= (data_buf_load_reg_215 & data_buf_load_1_reg_220);
    ...
    or_ln1028_fu_151_p2 <= (shl_ln2_fu_143_p3 or ap_const_lv9_1);
    ...
    shl_ln2_fu_143_p3 <= (trunc_ln1028_fu_139_p1 & ap_const_lv1_0);
    trunc_ln1028_fu_139_p1 <= ap_sig_allocacmp_i_1(8 - 1 downto 0);
    zext_ln1028_1_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln2_fu_143_p3),64));
    zext_ln1028_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(or_ln1028_fu_151_p2),64));
end behav;
