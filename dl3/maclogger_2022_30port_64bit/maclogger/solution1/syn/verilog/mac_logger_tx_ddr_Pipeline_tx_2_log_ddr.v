...
module mac_logger_tx_ddr_Pipeline_tx_2_log_ddr (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln965_reg_196;
reg   [31:0] data_buf_load_reg_215;
reg   [31:0] data_buf_load_2_reg_220;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln968_fu_157_p1;
wire   [63:0] zext_ln968_1_fu_162_p1;
wire    ap_block_pp0_stage0_01001;
reg   [13:0] i_1_fu_66;
wire   [13:0] add_ln965_fu_133_p2;
wire    ap_loop_init;
reg   [13:0] ap_sig_allocacmp_i;
wire   [7:0] trunc_ln968_fu_139_p1;
wire   [8:0] shl_ln1_fu_143_p3;
wire   [8:0] or_ln968_fu_151_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln965_fu_127_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln965_reg_196 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln965_fu_127_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln965_reg_196 == 1'd1))) begin
...
assign add_ln965_fu_133_p2 = (ap_sig_allocacmp_i + 14'd1);
...
assign data_buf_address0 = zext_ln968_1_fu_162_p1;

assign data_buf_address1 = zext_ln968_fu_157_p1;

assign icmp_ln965_fu_127_p2 = ((ap_sig_allocacmp_i == N) ? 1'b1 : 1'b0);
...
assign m_axi_ps_WDATA = {{data_buf_load_reg_215}, {data_buf_load_2_reg_220}};
...
assign or_ln968_fu_151_p2 = (shl_ln1_fu_143_p3 | 9'd1);

assign shl_ln1_fu_143_p3 = {{trunc_ln968_fu_139_p1}, {1'd0}};

assign trunc_ln968_fu_139_p1 = ap_sig_allocacmp_i[7:0];

assign zext_ln968_1_fu_162_p1 = shl_ln1_fu_143_p3;

assign zext_ln968_fu_157_p1 = or_ln968_fu_151_p2;

endmodule //mac_logger_tx_ddr_Pipeline_tx_2_log_ddr
