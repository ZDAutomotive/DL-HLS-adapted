...
clu_urem_32ns_32ns_32_36_seq_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
urem_32ns_32ns_32_36_seq_1_U43(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (m_axi_ps_ddr_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        loop_index4_fu_102 <= empty_60_fu_323_p2;
    end
end
...
assign empty_60_fu_323_p2 = (loop_index4_fu_102 + 5'd1);
