...
wire   [4:0] empty_46_fu_360_p2;
reg   [4:0] loop_index_fu_122;
wire   [4:0] empty_49_fu_507_p2;
reg   [2:0] loop_index_i_fu_126;
wire   [2:0] empty_53_fu_578_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (m_axi_ps_ddr_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        loop_index4_fu_114 <= empty_46_fu_360_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln113_fu_421_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state49))) begin
        ...
        loop_index_fu_122 <= empty_49_fu_507_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond55_fu_501_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state51))) begin
        ...
        loop_index_i_fu_126 <= empty_53_fu_578_p2;
    end
end
...
assign empty_46_fu_360_p2 = (loop_index4_fu_114 + 5'd1);

assign empty_49_fu_507_p2 = (loop_index_fu_122 + 5'd1);

assign empty_53_fu_578_p2 = (loop_index_i_fu_126 + 3'd1);
