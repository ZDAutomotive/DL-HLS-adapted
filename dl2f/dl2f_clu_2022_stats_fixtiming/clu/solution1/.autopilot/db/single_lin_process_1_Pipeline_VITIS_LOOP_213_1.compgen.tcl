...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename lin_frame \
    op interface \
    ports { lin_frame_address0 { O 5 vector } lin_frame_ce0 { O 1 bit } lin_frame_we0 { O 1 bit } lin_frame_d0 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lin_frame'"
}
}
...
eval "cg_default_interface_gen_dc { \
    id 7 \
    name PL_Data_1_load_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_PL_Data_1_load_out \
    op interface \
    ports { PL_Data_1_load_out { O 4 vector } PL_Data_1_load_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 8 \
    name zext_ln213_1_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln213_1_out \
    op interface \
    ports { zext_ln213_1_out { O 4 vector } zext_ln213_1_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_PL_Data_1 \
    op interface \
    ports { PL_Data_1 { I 4 vector } } \
} "
}
