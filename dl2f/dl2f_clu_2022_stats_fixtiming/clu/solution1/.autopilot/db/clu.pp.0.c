...
#pragma pack(pop)
# 10 "D:/Vitis_HLS/2022.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 2 3
...
void update_write_index(volatile unsigned char *ddr, unsigned int write_index) {
 ...
 memcpy(ddr + 24, write_index_array, 4);


}

__attribute__((sdx_kernel("clu", 0))) void clu (volatile int *can_ptr, volatile int *uart_ptr, volatile int *lin_ptr,
  volatile unsigned int *can_0_received,
  volatile unsigned int *can_1_received,
  volatile unsigned int *can_2_received,
  volatile unsigned int *can_3_received,
  ...
  long long timestamp) {
#line 20 "D:/HLS/dl2f/dl2f_clu_2022_stats_fixtiming/clu/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=clu
# 43 "clu.c"

#line 6 "D:/HLS/dl2f/dl2f_clu_2022_stats_fixtiming/clu/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=clu
# 43 "clu.c"
