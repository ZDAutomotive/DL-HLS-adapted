...
module clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_238_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln238_fu_184_p2;
wire   [31:0] add_ln241_fu_190_p2;
reg   [31:0] add_ln241_reg_402;
reg   [29:0] trunc_ln_reg_409;
...
reg   [7:0] trunc_ln2_reg_420;
reg   [7:0] trunc_ln3_reg_425;
reg   [7:0] trunc_ln4_reg_430;
wire   [7:0] trunc_ln245_fu_315_p1;
reg   [7:0] trunc_ln245_reg_435;
wire   [6:0] trunc_ln242_fu_322_p1;
reg   [6:0] trunc_ln242_reg_440;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [31:0] zext_ln242_fu_332_p1;
wire    ap_block_pp0_stage1;
wire   [31:0] zext_ln243_fu_343_p1;
wire   [31:0] zext_ln244_fu_364_p1;
wire   [31:0] zext_ln245_fu_374_p1;
wire  signed [31:0] sext_ln240_fu_275_p1;
reg   [31:0] Len_fu_84;
wire   [31:0] Len_3_fu_196_p2;
wire    ap_loop_init;
reg   [31:0] ap_sig_allocacmp_Len_2;
reg   [63:0] canIndex_fu_88;
wire   [63:0] add_ln246_fu_348_p2;
wire   [31:0] zext_ln27_cast_fu_167_p1;
wire   [31:0] zext_ln223_cast_fu_163_p1;
wire   [31:0] sub_ln241_fu_214_p2;
wire   [29:0] trunc_ln241_1_fu_219_p4;
wire   [0:0] tmp_fu_207_p3;
wire   [29:0] sub_ln241_1_fu_229_p2;
wire   [29:0] tmp_6_fu_235_p4;
wire   [29:0] select_ln241_fu_244_p3;
wire   [31:0] shl_ln2_fu_252_p3;
wire   [31:0] add_ln240_fu_260_p2;
wire   [6:0] add_ln242_fu_326_p2;
wire   [6:0] add_ln243_fu_337_p2;
wire   [6:0] add_ln244_fu_359_p2;
wire   [6:0] add_ln245_fu_369_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln238_fu_184_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln238_fu_184_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        trunc_ln2_reg_420 <= {{m_axi_can_addr_RDATA[31:24]}};
        trunc_ln3_reg_425 <= {{m_axi_can_addr_RDATA[23:16]}};
        trunc_ln4_reg_430 <= {{m_axi_can_addr_RDATA[15:8]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln238_reg_398 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        trunc_ln_reg_409 <= {{add_ln240_fu_260_p2[31:2]}};
    end
end

always @ (*) begin
    if (((icmp_ln238_reg_398 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (1'b0 == ap_block_pp0_stage2_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln238_reg_398 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (1'b0 == ap_block_pp0_stage2))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter3 == 1'b1)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage2) & (1'b0 == ap_block_pp0_stage2))) begin
            can_frame_address0 = zext_ln245_fu_374_p1;
        end else if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1))) begin
            can_frame_address0 = zext_ln243_fu_343_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter3 == 1'b1)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage2) & (1'b0 == ap_block_pp0_stage2))) begin
            can_frame_address1 = zext_ln244_fu_364_p1;
        end else if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1))) begin
            can_frame_address1 = zext_ln242_fu_332_p1;
        end else begin
...
always @ (*) begin
    if (((icmp_ln238_reg_398 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (1'b0 == ap_block_pp0_stage2_11001))) begin
...
assign Len_3_fu_196_p2 = (ap_sig_allocacmp_Len_2 + 32'd4);

assign add_ln240_fu_260_p2 = (shl_ln2_fu_252_p3 + canbase);

assign add_ln241_fu_190_p2 = (ap_sig_allocacmp_Len_2 + zext_ln223_cast_fu_163_p1);

assign add_ln242_fu_326_p2 = (trunc_ln242_fu_322_p1 + 7'd12);

assign add_ln243_fu_337_p2 = (trunc_ln242_fu_322_p1 + 7'd13);

assign add_ln244_fu_359_p2 = (trunc_ln242_reg_440 + 7'd14);

assign add_ln245_fu_369_p2 = (trunc_ln242_reg_440 + 7'd15);

assign add_ln246_fu_348_p2 = (canIndex_fu_88 + 64'd4);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_can_addr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_can_addr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage0_iter3 = (m_axi_can_addr_RVALID == 1'b0);
end
...
always @ (*) begin
    ap_block_state3_io = ((icmp_ln238_reg_398 == 1'd1) & (m_axi_can_addr_ARREADY == 1'b0));
end
...
assign icmp_ln238_fu_184_p2 = ((ap_sig_allocacmp_Len_2 < zext_ln27_cast_fu_167_p1) ? 1'b1 : 1'b0);

assign m_axi_can_addr_ARADDR = sext_ln240_fu_275_p1;
...
assign select_ln241_fu_244_p3 = ((tmp_fu_207_p3[0:0] == 1'b1) ? sub_ln241_1_fu_229_p2 : tmp_6_fu_235_p4);

assign sext_ln240_fu_275_p1 = $signed(trunc_ln_reg_409);

assign shl_ln2_fu_252_p3 = {{select_ln241_fu_244_p3}, {2'd0}};

assign sub_ln241_1_fu_229_p2 = (30'd0 - trunc_ln241_1_fu_219_p4);

assign sub_ln241_fu_214_p2 = (32'd0 - add_ln241_reg_402);

assign tmp_6_fu_235_p4 = {{add_ln241_reg_402[31:2]}};

assign tmp_fu_207_p3 = add_ln241_reg_402[32'd31];

assign trunc_ln241_1_fu_219_p4 = {{sub_ln241_fu_214_p2[31:2]}};

assign trunc_ln242_fu_322_p1 = canIndex_fu_88[6:0];

assign trunc_ln245_fu_315_p1 = m_axi_can_addr_RDATA[7:0];

assign zext_ln223_cast_fu_163_p1 = zext_ln223;

assign zext_ln242_fu_332_p1 = add_ln242_fu_326_p2;

assign zext_ln243_fu_343_p1 = add_ln243_fu_337_p2;

assign zext_ln244_fu_364_p1 = add_ln244_fu_359_p2;

assign zext_ln245_fu_374_p1 = add_ln245_fu_369_p2;

assign zext_ln27_cast_fu_167_p1 = zext_ln27;

endmodule //clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_238_2
