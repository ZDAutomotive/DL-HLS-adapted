...
set IPName      "clu"
set Version     "1.0"
set DisplayName "DF_2L"
set Revision    "2112874631"
...
set xo_kernel_name "clu"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/HLS/dl2f/dl2f_clu_2022_stats_fixtiming/clu/solution1"
set debug_dir "D:/HLS/dl2f/dl2f_clu_2022_stats_fixtiming/clu/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {clu_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_EN {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_EN"
        param_prefix "C_S_AXI_EN"
        addr_bits "8"
        port_width "AWADDR 8 WDATA 32 WSTRB 4 ARADDR 8 RDATA 32"
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 can_ptr W 0x0 "Data signal of can_ptr" {{0 32 can_ptr W 0 "Bit 31 to 0 of can_ptr"}}} {0x18 uart_ptr W 0x0 "Data signal of uart_ptr" {{0 32 uart_ptr W 0 "Bit 31 to 0 of uart_ptr"}}} {0x20 lin_ptr W 0x0 "Data signal of lin_ptr" {{0 32 lin_ptr W 0 "Bit 31 to 0 of lin_ptr"}}} {0x28 received_can R 0x0 "Data signal of received_can" {{0 32 received_can R 0 "Bit 31 to 0 of received_can"}}} {0x2c received_can_ctrl R 0x0 "Control signal of received_can" {{0 1 received_can_ap_vld R 0 "Control signal received_can_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 received_uart W 0x0 "Data signal of received_uart" {{0 32 received_uart W 0 "Bit 31 to 0 of received_uart"}}} {0x38 received_lin R 0x0 "Data signal of received_lin" {{0 32 received_lin R 0 "Bit 31 to 0 of received_lin"}}} {0x3c received_lin_ctrl R 0x0 "Control signal of received_lin" {{0 1 received_lin_ap_vld R 0 "Control signal received_lin_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 can_en W 0x0 "Data signal of can_en" {{0 32 can_en W 0 "Bit 31 to 0 of can_en"}}} {0x48 uart_en W 0x0 "Data signal of uart_en" {{0 8 uart_en W 0 "Bit 7 to 0 of uart_en"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 lin_en W 0x0 "Data signal of lin_en" {{0 32 lin_en W 0 "Bit 31 to 0 of lin_en"}}} {0x58 can_ddr W 0x0 "Data signal of can_ddr" {{0 32 can_ddr W 0 "Bit 31 to 0 of can_ddr"}}} {0x60 uart_ddr W 0x0 "Data signal of uart_ddr" {{0 32 uart_ddr W 0 "Bit 31 to 0 of uart_ddr"}}} {0x68 lin_ddr W 0x0 "Data signal of lin_ddr" {{0 32 lin_ddr W 0 "Bit 31 to 0 of lin_ddr"}}} {0x70 can_0_received R 0x0 "Data signal of can_0_received" {{0 32 can_0_received R 0 "Bit 31 to 0 of can_0_received"}}} {0x74 can_0_received_ctrl R 0x0 "Control signal of can_0_received" {{0 1 can_0_received_ap_vld R 0 "Control signal can_0_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 can_1_received R 0x0 "Data signal of can_1_received" {{0 32 can_1_received R 0 "Bit 31 to 0 of can_1_received"}}} {0x7c can_1_received_ctrl R 0x0 "Control signal of can_1_received" {{0 1 can_1_received_ap_vld R 0 "Control signal can_1_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 can_2_received R 0x0 "Data signal of can_2_received" {{0 32 can_2_received R 0 "Bit 31 to 0 of can_2_received"}}} {0x84 can_2_received_ctrl R 0x0 "Control signal of can_2_received" {{0 1 can_2_received_ap_vld R 0 "Control signal can_2_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 can_3_received R 0x0 "Data signal of can_3_received" {{0 32 can_3_received R 0 "Bit 31 to 0 of can_3_received"}}} {0x8c can_3_received_ctrl R 0x0 "Control signal of can_3_received" {{0 1 can_3_received_ap_vld R 0 "Control signal can_3_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 can_dropped R 0x0 "Data signal of can_dropped" {{0 32 can_dropped R 0 "Bit 31 to 0 of can_dropped"}}} {0x94 can_dropped_ctrl R 0x0 "Control signal of can_dropped" {{0 1 can_dropped_ap_vld R 0 "Control signal can_dropped_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 lin_0_received R 0x0 "Data signal of lin_0_received" {{0 32 lin_0_received R 0 "Bit 31 to 0 of lin_0_received"}}} {0x9c lin_0_received_ctrl R 0x0 "Control signal of lin_0_received" {{0 1 lin_0_received_ap_vld R 0 "Control signal lin_0_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 lin_1_received R 0x0 "Data signal of lin_1_received" {{0 32 lin_1_received R 0 "Bit 31 to 0 of lin_1_received"}}} {0xa4 lin_1_received_ctrl R 0x0 "Control signal of lin_1_received" {{0 1 lin_1_received_ap_vld R 0 "Control signal lin_1_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 lin_2_received R 0x0 "Data signal of lin_2_received" {{0 32 lin_2_received R 0 "Bit 31 to 0 of lin_2_received"}}} {0xac lin_2_received_ctrl R 0x0 "Control signal of lin_2_received" {{0 1 lin_2_received_ap_vld R 0 "Control signal lin_2_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 lin_3_received R 0x0 "Data signal of lin_3_received" {{0 32 lin_3_received R 0 "Bit 31 to 0 of lin_3_received"}}} {0xb4 lin_3_received_ctrl R 0x0 "Control signal of lin_3_received" {{0 1 lin_3_received_ap_vld R 0 "Control signal lin_3_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb8 lin_4_received R 0x0 "Data signal of lin_4_received" {{0 32 lin_4_received R 0 "Bit 31 to 0 of lin_4_received"}}} {0xbc lin_4_received_ctrl R 0x0 "Control signal of lin_4_received" {{0 1 lin_4_received_ap_vld R 0 "Control signal lin_4_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 lin_5_received R 0x0 "Data signal of lin_5_received" {{0 32 lin_5_received R 0 "Bit 31 to 0 of lin_5_received"}}} {0xc4 lin_5_received_ctrl R 0x0 "Control signal of lin_5_received" {{0 1 lin_5_received_ap_vld R 0 "Control signal lin_5_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc8 lin_6_received R 0x0 "Data signal of lin_6_received" {{0 32 lin_6_received R 0 "Bit 31 to 0 of lin_6_received"}}} {0xcc lin_6_received_ctrl R 0x0 "Control signal of lin_6_received" {{0 1 lin_6_received_ap_vld R 0 "Control signal lin_6_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xd0 lin_7_received R 0x0 "Data signal of lin_7_received" {{0 32 lin_7_received R 0 "Bit 31 to 0 of lin_7_received"}}} {0xd4 lin_7_received_ctrl R 0x0 "Control signal of lin_7_received" {{0 1 lin_7_received_ap_vld R 0 "Control signal lin_7_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xd8 lin_8_received R 0x0 "Data signal of lin_8_received" {{0 32 lin_8_received R 0 "Bit 31 to 0 of lin_8_received"}}} {0xdc lin_8_received_ctrl R 0x0 "Control signal of lin_8_received" {{0 1 lin_8_received_ap_vld R 0 "Control signal lin_8_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xe0 lin_9_received R 0x0 "Data signal of lin_9_received" {{0 32 lin_9_received R 0 "Bit 31 to 0 of lin_9_received"}}} {0xe4 lin_9_received_ctrl R 0x0 "Control signal of lin_9_received" {{0 1 lin_9_received_ap_vld R 0 "Control signal lin_9_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xe8 lin_dropped R 0x0 "Data signal of lin_dropped" {{0 32 lin_dropped R 0 "Bit 31 to 0 of lin_dropped"}}} {0xec lin_dropped_ctrl R 0x0 "Control signal of lin_dropped" {{0 1 lin_dropped_ap_vld R 0 "Control signal lin_dropped_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_EN m_axi_can_addr m_axi_uart_addr m_axi_lin_addr m_axi_ps_ddr"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_can_addr {
        ...
        data_width "32"
        port_prefix "m_axi_can_addr"
        param_prefix "C_M_AXI_CAN_ADDR"
    ...
    m_axi_uart_addr {
        ...
        data_width "32"
        port_prefix "m_axi_uart_addr"
        param_prefix "C_M_AXI_UART_ADDR"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_EN"
    ...
    m_axi_lin_addr {
        ...
        data_width "32"
        port_prefix "m_axi_lin_addr"
        param_prefix "C_M_AXI_LIN_ADDR"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_EN"
    ...
    m_axi_ps_ddr {
        ...
        data_width "32"
        port_prefix "m_axi_ps_ddr"
        param_prefix "C_M_AXI_PS_DDR"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_EN"
