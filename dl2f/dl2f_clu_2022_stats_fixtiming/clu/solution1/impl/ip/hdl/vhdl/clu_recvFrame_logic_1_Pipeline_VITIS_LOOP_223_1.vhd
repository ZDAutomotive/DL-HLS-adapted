...
attribute shreg_extract : string;
    ...
    signal trunc_ln231_fu_281_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln231_reg_385 : STD_LOGIC_VECTOR (7 downto 0);
    signal canIndex_load_reg_390 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage1_subdone : BOOLEAN;
    signal zext_ln228_fu_294_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln229_fu_305_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln230_fu_326_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln231_fu_336_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln226_fu_241_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln232_fu_310_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal trunc_ln227_fu_198_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal shl_ln3_fu_202_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln226_fu_210_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln226_1_fu_214_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln223_cast_fu_169_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln226_fu_220_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln228_fu_288_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln229_fu_299_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln230_fu_321_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln231_fu_331_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    canIndex_fu_94 <= add_ln232_fu_310_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001))) then
                trunc_ln231_reg_385 <= trunc_ln231_fu_281_p1;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln223_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                trunc_ln_reg_359 <= add_ln226_fu_220_p2(31 downto 2);
            end if;
        end if;
    end process;
    ...
    add_ln226_1_fu_214_p2 <= std_logic_vector(unsigned(zext_ln226_fu_210_p1) + unsigned(canbase));
    add_ln226_fu_220_p2 <= std_logic_vector(unsigned(add_ln226_1_fu_214_p2) + unsigned(zext_ln223_cast_fu_169_p1));
    add_ln228_fu_288_p2 <= std_logic_vector(unsigned(canIndex_fu_94) + unsigned(ap_const_lv7_C));
    add_ln229_fu_299_p2 <= std_logic_vector(unsigned(canIndex_fu_94) + unsigned(ap_const_lv7_D));
    add_ln230_fu_321_p2 <= std_logic_vector(unsigned(canIndex_load_reg_390) + unsigned(ap_const_lv7_E));
    add_ln231_fu_331_p2 <= std_logic_vector(unsigned(canIndex_load_reg_390) + unsigned(ap_const_lv7_F));
    add_ln232_fu_310_p2 <= std_logic_vector(unsigned(canIndex_fu_94) + unsigned(ap_const_lv7_4));
    ...
    ap_condition_exit_pp0_iter0_stage2_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_subdone, icmp_ln223_reg_355)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (icmp_ln223_reg_355 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage2_subdone))) then 
    ...
    ap_condition_exit_pp0_iter2_stage1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage1, icmp_ln223_reg_355_pp0_iter2_reg, ap_block_pp0_stage1_subdone)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln223_reg_355_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone))) then 
    ...
    can_addr_blk_n_AR_assign_proc : process(ap_enable_reg_pp0_iter0, m_axi_can_addr_ARREADY, icmp_ln223_reg_355, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln223_reg_355 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
    ...
    can_frame_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage0, zext_ln229_fu_305_p1, zext_ln231_fu_336_p1)
    begin
        if ((ap_enable_reg_pp0_iter3 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address0 <= zext_ln231_fu_336_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_address0 <= zext_ln229_fu_305_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_address1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, zext_ln228_fu_294_p1, ap_block_pp0_stage0, zext_ln230_fu_326_p1)
    begin
        if ((ap_enable_reg_pp0_iter3 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address1 <= zext_ln230_fu_326_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_address1 <= zext_ln228_fu_294_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_d0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, trunc_ln6_reg_375, trunc_ln231_reg_385, ap_block_pp0_stage0)
    begin
        if ((ap_enable_reg_pp0_iter3 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_d0 <= trunc_ln231_reg_385;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    m_axi_can_addr_ARADDR <= sext_ln226_fu_241_p1;
    ...
    m_axi_can_addr_ARVALID_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln223_reg_355, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln223_reg_355 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then 
    ...
    m_axi_can_addr_WVALID <= ap_const_logic_0;
        sext_ln226_fu_241_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_359),32));

    shl_ln3_fu_202_p3 <= (trunc_ln227_fu_198_p1 & ap_const_lv2_0);
    trunc_ln227_fu_198_p1 <= ap_sig_allocacmp_DwIndex_1(4 - 1 downto 0);
    trunc_ln231_fu_281_p1 <= m_axi_can_addr_RDATA(8 - 1 downto 0);
    zext_ln223_cast_fu_169_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln223),32));
    zext_ln226_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln3_fu_202_p3),32));
    zext_ln228_fu_294_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln228_fu_288_p2),32));
    zext_ln229_fu_305_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln229_fu_299_p2),32));
    zext_ln230_fu_326_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln230_fu_321_p2),32));
    zext_ln231_fu_336_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln231_fu_331_p2),32));
end behav;
