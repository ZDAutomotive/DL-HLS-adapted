...
entity clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_238_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_238_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln238_reg_398 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln238_fu_184_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln241_fu_190_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln241_reg_402 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal trunc_ln245_fu_315_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln245_reg_435 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln242_fu_322_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal trunc_ln242_reg_440 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal zext_ln242_fu_332_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal zext_ln243_fu_343_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln244_fu_364_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln245_fu_374_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln240_fu_275_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln246_fu_348_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal sub_ln241_fu_214_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln241_1_fu_219_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_fu_207_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln241_1_fu_229_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_6_fu_235_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal select_ln241_fu_244_p3 : STD_LOGIC_VECTOR (29 downto 0);
    signal shl_ln2_fu_252_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln240_fu_260_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln242_fu_326_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln243_fu_337_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln244_fu_359_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln245_fu_369_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln238_fu_184_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                ...
                canIndex_fu_88 <= add_ln246_fu_348_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln238_fu_184_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln241_reg_402 <= add_ln241_fu_190_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln238_reg_398 <= icmp_ln238_fu_184_p2;
                trunc_ln245_reg_435 <= trunc_ln245_fu_315_p1;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                trunc_ln242_reg_440 <= trunc_ln242_fu_322_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln238_reg_398 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                trunc_ln_reg_409 <= add_ln240_fu_260_p2(31 downto 2);
            end if;
        end if;
    end process;
    ...
    add_ln240_fu_260_p2 <= std_logic_vector(unsigned(shl_ln2_fu_252_p3) + unsigned(canbase));
    add_ln241_fu_190_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_Len_2) + unsigned(zext_ln223_cast_fu_163_p1));
    add_ln242_fu_326_p2 <= std_logic_vector(unsigned(trunc_ln242_fu_322_p1) + unsigned(ap_const_lv7_C));
    add_ln243_fu_337_p2 <= std_logic_vector(unsigned(trunc_ln242_fu_322_p1) + unsigned(ap_const_lv7_D));
    add_ln244_fu_359_p2 <= std_logic_vector(unsigned(trunc_ln242_reg_440) + unsigned(ap_const_lv7_E));
    add_ln245_fu_369_p2 <= std_logic_vector(unsigned(trunc_ln242_reg_440) + unsigned(ap_const_lv7_F));
    add_ln246_fu_348_p2 <= std_logic_vector(unsigned(canIndex_fu_88) + unsigned(ap_const_lv64_4));
    ...
    ap_block_state3_io_assign_proc : process(m_axi_can_addr_ARREADY, icmp_ln238_reg_398)
    begin
                ap_block_state3_io <= ((icmp_ln238_reg_398 = ap_const_lv1_1) and (m_axi_can_addr_ARREADY = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage2_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln238_reg_398, ap_block_pp0_stage2_subdone)
    begin
        if (((icmp_ln238_reg_398 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2_subdone))) then 
    ...
    can_addr_blk_n_AR_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, m_axi_can_addr_ARREADY, icmp_ln238_reg_398, ap_block_pp0_stage2)
    begin
        if (((icmp_ln238_reg_398 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2))) then 
    ...
    can_frame_address0_assign_proc : process(ap_enable_reg_pp0_iter3, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, zext_ln243_fu_343_p1, zext_ln245_fu_374_p1)
    begin
        if ((ap_enable_reg_pp0_iter3 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2))) then 
                can_frame_address0 <= zext_ln245_fu_374_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address0 <= zext_ln243_fu_343_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_address1_assign_proc : process(ap_enable_reg_pp0_iter3, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2, ap_CS_fsm_pp0_stage1, zext_ln242_fu_332_p1, ap_block_pp0_stage1, zext_ln244_fu_364_p1)
    begin
        if ((ap_enable_reg_pp0_iter3 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2))) then 
                can_frame_address1 <= zext_ln244_fu_364_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address1 <= zext_ln242_fu_332_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_d0_assign_proc : process(ap_enable_reg_pp0_iter3, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2, ap_CS_fsm_pp0_stage1, trunc_ln3_reg_425, trunc_ln245_reg_435, ap_block_pp0_stage1)
    begin
        if ((ap_enable_reg_pp0_iter3 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2))) then 
                can_frame_d0 <= trunc_ln245_reg_435;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
    ...
    icmp_ln238_fu_184_p2 <= "1" when (unsigned(ap_sig_allocacmp_Len_2) < unsigned(zext_ln27_cast_fu_167_p1)) else "0";
    m_axi_can_addr_ARADDR <= sext_ln240_fu_275_p1;
    ...
    m_axi_can_addr_ARVALID_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln238_reg_398, ap_block_pp0_stage2_11001)
    begin
        if (((icmp_ln238_reg_398 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001))) then 
    ...
    select_ln241_fu_244_p3 <= 
        sub_ln241_1_fu_229_p2 when (tmp_fu_207_p3(0) = '1') else 
        tmp_6_fu_235_p4;
        sext_ln240_fu_275_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_409),32));

    shl_ln2_fu_252_p3 <= (select_ln241_fu_244_p3 & ap_const_lv2_0);
    sub_ln241_1_fu_229_p2 <= std_logic_vector(unsigned(ap_const_lv30_0) - unsigned(trunc_ln241_1_fu_219_p4));
    sub_ln241_fu_214_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(add_ln241_reg_402));
    tmp_6_fu_235_p4 <= add_ln241_reg_402(31 downto 2);
    tmp_fu_207_p3 <= add_ln241_reg_402(31 downto 31);
    trunc_ln241_1_fu_219_p4 <= sub_ln241_fu_214_p2(31 downto 2);
    trunc_ln242_fu_322_p1 <= canIndex_fu_88(7 - 1 downto 0);
    trunc_ln245_fu_315_p1 <= m_axi_can_addr_RDATA(8 - 1 downto 0);
    zext_ln223_cast_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln223),32));
    zext_ln242_fu_332_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln242_fu_326_p2),32));
    zext_ln243_fu_343_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln243_fu_337_p2),32));
    zext_ln244_fu_364_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln244_fu_359_p2),32));
    zext_ln245_fu_374_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln245_fu_369_p2),32));
