...
wire   [31:0] add_ln17_fu_420_p2;
reg   [31:0] add_ln17_reg_653;
...
wire   [7:0] add_ln120_2_fu_485_p2;
reg   [7:0] add_ln120_2_reg_684;
...
clu_urem_32ns_32ns_32_36_seq_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
urem_32ns_32ns_32_36_seq_1_U54(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (m_axi_ps_ddr_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        loop_index4_fu_102 <= empty_77_fu_323_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state66)) begin
        add_ln120_2_reg_684 <= add_ln120_2_fu_485_p2;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state67)) begin
        m_axi_ps_ddr_WDATA = add_ln120_2_reg_684;
    end else if (((1'b1 == ap_CS_fsm_state60) | (1'b1 == ap_CS_fsm_state59))) begin
        m_axi_ps_ddr_WDATA = grp_write_ddr_1_Pipeline_2_fu_281_m_axi_ps_ddr_WDATA;
    end else if (((1'b1 == ap_CS_fsm_state53) | (1'b1 == ap_CS_fsm_state52))) begin
        m_axi_ps_ddr_WDATA = grp_write_ddr_1_Pipeline_1_fu_272_m_axi_ps_ddr_WDATA;
...
assign add_ln120_2_fu_485_p2 = (trunc_ln119_fu_469_p1 + 8'd1);
...
assign add_ln17_fu_420_p2 = (ddr_header + 32'd24);
...
assign empty_77_fu_323_p2 = (loop_index4_fu_102 + 5'd1);
