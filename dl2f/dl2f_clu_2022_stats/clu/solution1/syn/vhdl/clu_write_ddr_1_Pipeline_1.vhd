...
attribute shreg_extract : string;
    ...
    signal exitcond55_fu_91_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal data_load_reg_134 : STD_LOGIC_VECTOR (7 downto 0);
    signal loop_index_cast_fu_103_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal loop_index_fu_46 : STD_LOGIC_VECTOR (6 downto 0);
    signal empty_75_fu_97_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond55_fu_91_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index_fu_46 <= empty_75_fu_97_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index_fu_46 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond55_fu_91_p2)
    begin
        if (((exitcond55_fu_91_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    data_address0 <= loop_index_cast_fu_103_p1(7 - 1 downto 0);
    ...
    empty_75_fu_97_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_load) + unsigned(ap_const_lv7_1));
    exitcond55_fu_91_p2 <= "1" when (ap_sig_allocacmp_loop_index_load = ap_const_lv7_5C) else "0";
    loop_index_cast_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_loop_index_load),32));
    ...
    m_axi_ps_ddr_WDATA <= data_load_reg_134;
