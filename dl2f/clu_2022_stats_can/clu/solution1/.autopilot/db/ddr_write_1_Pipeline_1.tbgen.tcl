set moduleName ddr_write_1_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ddr_write.1_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ ps_ddr int 8 regular {axi_master 1}  }
	{ add_ln154_1 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ps_ddr", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "can_ddr","offset": { "type": "dynamic","port_name": "can_ddr","bundle": "EN"},"direction": "READWRITE"},{"cName": "uart_ddr","offset": { "type": "dynamic","port_name": "uart_ddr","bundle": "EN"},"direction": "READWRITE"},{"cName": "lin_ddr","offset": { "type": "dynamic","port_name": "lin_ddr","bundle": "EN"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "add_ln154_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln154_1 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln154_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add_ln154_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln154_1 { ap_none {  { add_ln154_1 in_data 0 32 } } }
