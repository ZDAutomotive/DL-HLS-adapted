...
set C_modelArgList {
	...
	{ can_4_received int 32 regular {pointer 1 volatile }  }
	{ can_5_received int 32 regular {pointer 1 volatile }  }
	{ can_6_received int 32 regular {pointer 1 volatile }  }
	{ can_7_received int 32 regular {pointer 1 volatile }  }
	{ can_8_received int 32 regular {pointer 1 volatile }  }
	{ can_9_received int 32 regular {pointer 1 volatile }  }
	{ can_10_received int 32 regular {pointer 1 volatile }  }
	{ can_11_received int 32 regular {pointer 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "clu_addr", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "can_ptr","offset": { "type": "dynamic","port_name": "can_ptr","bundle": "EN"},"direction": "READWRITE"},{"cName": "uart_ptr","offset": { "type": "dynamic","port_name": "uart_ptr","bundle": "EN"},"direction": "READONLY"},{"cName": "lin_ptr","offset": { "type": "dynamic","port_name": "lin_ptr","bundle": "EN"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "can_4_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "can_5_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "can_6_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "can_7_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "can_8_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "can_9_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "can_10_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "can_11_received", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ can_4_received sc_out sc_lv 32 signal 11 } 
	{ can_4_received_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ can_5_received sc_out sc_lv 32 signal 12 } 
	{ can_5_received_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ can_6_received sc_out sc_lv 32 signal 13 } 
	{ can_6_received_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ can_7_received sc_out sc_lv 32 signal 14 } 
	{ can_7_received_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ can_8_received sc_out sc_lv 32 signal 15 } 
	{ can_8_received_ap_vld sc_out sc_logic 1 outvld 15 } 
	{ can_9_received sc_out sc_lv 32 signal 16 } 
	{ can_9_received_ap_vld sc_out sc_logic 1 outvld 16 } 
	{ can_10_received sc_out sc_lv 32 signal 17 } 
	{ can_10_received_ap_vld sc_out sc_logic 1 outvld 17 } 
	{ can_11_received sc_out sc_lv 32 signal 18 } 
	{ can_11_received_ap_vld sc_out sc_logic 1 outvld 18 } 
	{ received_can sc_out sc_lv 32 signal 19 } 
	{ received_can_ap_vld sc_out sc_logic 1 outvld 19 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "can_4_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_4_received", "role": "default" }} , 
 	{ "name": "can_4_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_4_received", "role": "ap_vld" }} , 
 	{ "name": "can_5_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_5_received", "role": "default" }} , 
 	{ "name": "can_5_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_5_received", "role": "ap_vld" }} , 
 	{ "name": "can_6_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_6_received", "role": "default" }} , 
 	{ "name": "can_6_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_6_received", "role": "ap_vld" }} , 
 	{ "name": "can_7_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_7_received", "role": "default" }} , 
 	{ "name": "can_7_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_7_received", "role": "ap_vld" }} , 
 	{ "name": "can_8_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_8_received", "role": "default" }} , 
 	{ "name": "can_8_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_8_received", "role": "ap_vld" }} , 
 	{ "name": "can_9_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_9_received", "role": "default" }} , 
 	{ "name": "can_9_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_9_received", "role": "ap_vld" }} , 
 	{ "name": "can_10_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_10_received", "role": "default" }} , 
 	{ "name": "can_10_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_10_received", "role": "ap_vld" }} , 
 	{ "name": "can_11_received", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "can_11_received", "role": "default" }} , 
 	{ "name": "can_11_received_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "can_11_received", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "6", "8"],
		...
		"Port" : [
			{"Name" : "clu_addr", "Type" : "MAXI", "Direction" : "IO",
				...
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_recvFrame_logic_1_Pipeline_VITIS_LOOP_261_2_fu_648", "Port" : "clu_addr", "Inst_start_state" : "14", "Inst_end_state" : "15"},
					{"ID" : "6", "SubInstance" : "grp_recvFrame_logic_1_Pipeline_VITIS_LOOP_247_1_fu_658", "Port" : "clu_addr", "Inst_start_state" : "16", "Inst_end_state" : "15"}]},
			{"Name" : "canbase", "Type" : "None", "Direction" : "I"},
			{"Name" : "ps_ddr", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_write_ddr_1_fu_668", "Port" : "ps_ddr", "Inst_start_state" : "17", "Inst_end_state" : "18"}]},
			...
			{"Name" : "dropped_can_counter", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_write_ddr_1_fu_668", "Port" : "dropped_can_counter", "Inst_start_state" : "17", "Inst_end_state" : "18"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.can_frame_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_recvFrame_logic_1_Pipeline_1_fu_642", "Parent" : "0", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_recvFrame_logic_1_Pipeline_1_fu_642.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_recvFrame_logic_1_Pipeline_VITIS_LOOP_261_2_fu_648", "Parent" : "0", "Child" : ["5"],
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_recvFrame_logic_1_Pipeline_VITIS_LOOP_261_2_fu_648.flow_control_loop_pipe_sequential_init_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_recvFrame_logic_1_Pipeline_VITIS_LOOP_247_1_fu_658", "Parent" : "0", "Child" : ["7"],
	...
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_recvFrame_logic_1_Pipeline_VITIS_LOOP_247_1_fu_658.flow_control_loop_pipe_sequential_init_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668", "Parent" : "0", "Child" : ["9", "10", "12", "15", "16"],
		"CDFG" : "write_ddr_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.ringbuffer_header_bytes_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.grp_write_ddr_1_Pipeline_1_fu_272", "Parent" : "8", "Child" : ["11"],
	...
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.grp_write_ddr_1_Pipeline_1_fu_272.flow_control_loop_pipe_sequential_init_U", "Parent" : "10"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.grp_write_ddr_1_Pipeline_2_fu_281", "Parent" : "8", "Child" : ["13", "14"],
	...
	{"ID" : "13", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.grp_write_ddr_1_Pipeline_2_fu_281.mux_42_8_1_1_U74", "Parent" : "12"},
	{"ID" : "14", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.grp_write_ddr_1_Pipeline_2_fu_281.flow_control_loop_pipe_sequential_init_U", "Parent" : "12"},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.urem_32ns_32ns_32_36_seq_1_U81", "Parent" : "8"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_ddr_1_fu_668.mul_32s_8ns_32_1_1_U82", "Parent" : "8"}]}
...
set Spec2ImplPortList { 
	...
	can_4_received { ap_vld {  { can_4_received out_data 1 32 }  { can_4_received_ap_vld out_vld 1 1 } } }
	can_5_received { ap_vld {  { can_5_received out_data 1 32 }  { can_5_received_ap_vld out_vld 1 1 } } }
	can_6_received { ap_vld {  { can_6_received out_data 1 32 }  { can_6_received_ap_vld out_vld 1 1 } } }
	can_7_received { ap_vld {  { can_7_received out_data 1 32 }  { can_7_received_ap_vld out_vld 1 1 } } }
	can_8_received { ap_vld {  { can_8_received out_data 1 32 }  { can_8_received_ap_vld out_vld 1 1 } } }
	can_9_received { ap_vld {  { can_9_received out_data 1 32 }  { can_9_received_ap_vld out_vld 1 1 } } }
	can_10_received { ap_vld {  { can_10_received out_data 1 32 }  { can_10_received_ap_vld out_vld 1 1 } } }
	can_11_received { ap_vld {  { can_11_received out_data 1 32 }  { can_11_received_ap_vld out_vld 1 1 } } }
