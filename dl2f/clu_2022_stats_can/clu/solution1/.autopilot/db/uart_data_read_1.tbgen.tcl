...
set C_modelArgMapList {[ 
	{ "Name" : "ps_ddr", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "can_ddr","offset": { "type": "dynamic","port_name": "can_ddr","bundle": "EN"},"direction": "READWRITE"},{"cName": "uart_ddr","offset": { "type": "dynamic","port_name": "uart_ddr","bundle": "EN"},"direction": "READWRITE"},{"cName": "lin_ddr","offset": { "type": "dynamic","port_name": "lin_ddr","bundle": "EN"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "uartbase", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_clu_addr_ARADDR sc_out sc_lv 32 signal 2 } 
	...
	{ uartbase sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "uartbase", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "uartbase", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "16"],
		...
		"Port" : [
			{"Name" : "ps_ddr", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_ddr_write_1_fu_381", "Port" : "ps_ddr", "Inst_start_state" : "28", "Inst_end_state" : "29"}]},
			...
			{"Name" : "PL_Ctrl_fifo_index", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_ddr_write_1_fu_381", "Port" : "PL_Ctrl_fifo_index", "Inst_start_state" : "28", "Inst_end_state" : "29"}]},
			{"Name" : "PL_Ctrl_first_time", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_ddr_write_1_fu_381", "Port" : "PL_Ctrl_first_time", "Inst_start_state" : "28", "Inst_end_state" : "29"}]},
			{"Name" : "PL_Ctrl_first_timestamp", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_ddr_write_1_fu_381", "Port" : "PL_Ctrl_first_timestamp", "Inst_start_state" : "28", "Inst_end_state" : "29"}]},
			{"Name" : "uart_fifo", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_ddr_write_1_fu_381", "Port" : "uart_fifo", "Inst_start_state" : "28", "Inst_end_state" : "29"}]},
			{"Name" : "PL_Header_pkt_len_bytes", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_ddr_write_1_fu_381", "Port" : "PL_Header_pkt_len_bytes", "Inst_start_state" : "28", "Inst_end_state" : "29"}]},
			{"Name" : "internal_uart_counter", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "dropped_uart_counter", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_ddr_write_1_fu_381", "Port" : "dropped_uart_counter", "Inst_start_state" : "28", "Inst_end_state" : "29"}]}]},
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381", "Parent" : "0", "Child" : ["7", "8", "10", "13", "14", "15"],
		"CDFG" : "ddr_write_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "ps_ddr", "Type" : "MAXI", "Direction" : "IO",
				...
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_ddr_write_1_Pipeline_1_fu_354", "Port" : "ps_ddr", "Inst_start_state" : "52", "Inst_end_state" : "53"},
					{"ID" : "10", "SubInstance" : "grp_ddr_write_1_Pipeline_2_fu_364", "Port" : "ps_ddr", "Inst_start_state" : "59", "Inst_end_state" : "60"}]},
			{"Name" : "ddr_header", "Type" : "None", "Direction" : "I"},
			{"Name" : "device_id", "Type" : "None", "Direction" : "I"},
			{"Name" : "dropped_uart_counter", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "uart_fifo", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_ddr_write_1_Pipeline_1_fu_354", "Port" : "uart_fifo", "Inst_start_state" : "52", "Inst_end_state" : "53"}]},
	...
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.ringbuffer_header_bytes_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.grp_ddr_write_1_Pipeline_1_fu_354", "Parent" : "6", "Child" : ["9"],
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.grp_ddr_write_1_Pipeline_1_fu_354.flow_control_loop_pipe_sequential_init_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.grp_ddr_write_1_Pipeline_2_fu_364", "Parent" : "6", "Child" : ["11", "12"],
	...
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.grp_ddr_write_1_Pipeline_2_fu_364.mux_42_8_1_1_U5", "Parent" : "10"},
	{"ID" : "12", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.grp_ddr_write_1_Pipeline_2_fu_364.flow_control_loop_pipe_sequential_init_U", "Parent" : "10"},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.urem_32ns_32ns_32_36_seq_1_U13", "Parent" : "6"},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.mul_32s_9ns_32_1_1_U14", "Parent" : "6"},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_fu_381.mul_3ns_9ns_11_1_1_U15", "Parent" : "6"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "387"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "387"}
]}
...
set Spec2ImplPortList { 
	...
	uartbase { ap_none {  { uartbase in_data 0 32 } } }
