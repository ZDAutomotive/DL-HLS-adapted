...
using hls::sim::Byte;
extern "C" void clu(Byte<4>*, Byte<1>*, int, int, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, int, long long);
extern "C" void apatb_clu_hw(volatile void * __xlx_apatb_param_can_ptr, volatile void * __xlx_apatb_param_uart_ptr, volatile void * __xlx_apatb_param_lin_ptr, volatile void * __xlx_apatb_param_can_0_received, volatile void * __xlx_apatb_param_can_1_received, volatile void * __xlx_apatb_param_can_2_received, volatile void * __xlx_apatb_param_can_3_received, volatile void * __xlx_apatb_param_can_4_received, volatile void * __xlx_apatb_param_can_5_received, volatile void * __xlx_apatb_param_can_6_received, volatile void * __xlx_apatb_param_can_7_received, volatile void * __xlx_apatb_param_can_8_received, volatile void * __xlx_apatb_param_can_9_received, volatile void * __xlx_apatb_param_can_10_received, volatile void * __xlx_apatb_param_can_11_received, volatile void * __xlx_apatb_param_droped, volatile void * __xlx_apatb_param_received_can, volatile void * __xlx_apatb_param_received_uart, volatile void * __xlx_apatb_param_received_lin, volatile void * __xlx_apatb_param_can_en, volatile void * __xlx_apatb_param_uart_en, volatile void * __xlx_apatb_param_lin_en, volatile void * __xlx_apatb_param_can_ddr, volatile void * __xlx_apatb_param_uart_ddr, volatile void * __xlx_apatb_param_lin_ddr, long long __xlx_apatb_param_timestamp) {
using hls::sim::createStream;
  // Collect __xlx_can_ptr_uart_ptr_lin_ptr__tmp_vec
std::vector<Byte<4>> __xlx_can_ptr_uart_ptr_lin_ptr__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_can_ptr_uart_ptr_lin_ptr__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_can_ptr)[i]);
}
  int __xlx_size_param_can_ptr = 1;
  int __xlx_offset_param_can_ptr = 0;
  int __xlx_offset_byte_param_can_ptr = 0*4;
for (size_t i = 0; i < 1; ++i){
__xlx_can_ptr_uart_ptr_lin_ptr__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_uart_ptr)[i]);
}
  int __xlx_size_param_uart_ptr = 1;
  int __xlx_offset_param_uart_ptr = 1;
  int __xlx_offset_byte_param_uart_ptr = 1*4;
for (size_t i = 0; i < 1; ++i){
__xlx_can_ptr_uart_ptr_lin_ptr__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_lin_ptr)[i]);
}
  int __xlx_size_param_lin_ptr = 1;
  int __xlx_offset_param_lin_ptr = 2;
  int __xlx_offset_byte_param_lin_ptr = 2*4;
