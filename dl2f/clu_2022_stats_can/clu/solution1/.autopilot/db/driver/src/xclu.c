...
u32 XClu_Get_can_10_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_10_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_10_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_10_RECEIVED_CTRL);
    return Data & 0x1;
}
...
u32 XClu_Get_can_11_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_11_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_11_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_11_RECEIVED_CTRL);
    return Data & 0x1;
}
...
u32 XClu_Get_can_4_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_4_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_4_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_4_RECEIVED_CTRL);
    return Data & 0x1;
}
...
u32 XClu_Get_can_5_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_5_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_5_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_5_RECEIVED_CTRL);
    return Data & 0x1;
}
...
u32 XClu_Get_can_6_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_6_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_6_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_6_RECEIVED_CTRL);
    return Data & 0x1;
}
...
u32 XClu_Get_can_7_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_7_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_7_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_7_RECEIVED_CTRL);
    return Data & 0x1;
}
...
u32 XClu_Get_can_8_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_8_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_8_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_8_RECEIVED_CTRL);
    return Data & 0x1;
}
...
u32 XClu_Get_can_9_received(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_9_RECEIVED_DATA);
    return Data;
}
...
u32 XClu_Get_can_9_received_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_9_RECEIVED_CTRL);
    return Data & 0x1;
}
...
void XClu_Set_droped(XClu *InstancePtr, u32 Data) {
    ...
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_DROPED_DATA, Data);
}
...
u32 XClu_Get_droped(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_DROPED_DATA);
    return Data;
}
