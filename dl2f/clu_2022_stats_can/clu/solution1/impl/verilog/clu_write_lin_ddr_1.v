...
wire   [7:0] add_ln115_1_fu_623_p2;
reg   [7:0] add_ln115_1_reg_831;
...
wire   [31:0] add_ln120_1_fu_471_p2;
wire   [31:0] add_ln115_fu_487_p2;
wire   [31:0] add_ln17_fu_523_p2;
reg    ap_block_state65;
wire   [15:0] add_ln114_fu_611_p2;
reg   [4:0] loop_index4_fu_114;
wire   [4:0] empty_53_fu_360_p2;
reg   [4:0] loop_index_fu_122;
wire   [4:0] empty_56_fu_507_p2;
reg   [2:0] loop_index_i_fu_126;
wire   [2:0] empty_60_fu_578_p2;
wire   [31:0] writeLinIndex_fu_387_p5;
wire   [31:0] grp_fu_403_p0;
wire   [31:0] grp_fu_403_p1;
wire   [31:0] readLinIndex_fu_409_p5;
wire   [2:0] trunc_ln120_fu_427_p1;
wire   [5:0] trunc_ln120_1_fu_443_p1;
wire   [31:0] shl_ln_fu_430_p6;
wire   [31:0] shl_ln120_1_fu_446_p6;
wire   [31:0] sub_ln120_fu_459_p2;
wire   [31:0] add_ln120_fu_465_p2;
wire   [1:0] tmp_6_fu_588_p5;
wire   [7:0] trunc_ln114_fu_607_p1;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (m_axi_ps_ddr_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        loop_index4_fu_114 <= empty_53_fu_360_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln113_fu_421_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state49))) begin
        loop_index_fu_122 <= 5'd0;
    end else if (((exitcond55_fu_501_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state51))) begin
        loop_index_fu_122 <= empty_56_fu_507_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond55_fu_501_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state51))) begin
        ...
        loop_index_i_fu_126 <= empty_60_fu_578_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln113_fu_421_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state49))) begin
...
always @ (*) begin
    if (((icmp_ln113_reg_754 == 1'd0) & (m_axi_ps_ddr_BVALID == 1'b0))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((icmp_ln113_reg_754 == 1'd0) & (m_axi_ps_ddr_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state65)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((icmp_ln113_reg_754 == 1'd0) & (m_axi_ps_ddr_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state65))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((~((icmp_ln113_reg_754 == 1'd0) & (m_axi_ps_ddr_BVALID == 1'b0)) & (icmp_ln113_reg_754 == 1'd0) & (1'b1 == ap_CS_fsm_state65)) | ((1'b1 == ap_CS_fsm_state58) & (m_axi_ps_ddr_BVALID == 1'b1)) | ((1'b1 == ap_CS_fsm_state72) & (m_axi_ps_ddr_BVALID == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state58) | (1'b1 == ap_CS_fsm_state72) | ((icmp_ln113_reg_754 == 1'd0) & (1'b1 == ap_CS_fsm_state65)))) begin
...
assign add_ln114_fu_611_p2 = (dropped_lin_counter + 16'd1);

assign add_ln115_1_fu_623_p2 = (trunc_ln114_fu_607_p1 + 8'd1);

assign add_ln115_fu_487_p2 = (ddr_header + 32'd4);

assign add_ln120_1_fu_471_p2 = (add_ln120_fu_465_p2 + ddr_header);

assign add_ln120_fu_465_p2 = (sub_ln120_fu_459_p2 + 32'd28);
...
always @ (*) begin
    ap_block_state65 = ((icmp_ln113_reg_754 == 1'd0) & (m_axi_ps_ddr_BVALID == 1'b0));
end

assign data_address0 = loop_index_cast_fu_513_p1;

assign empty_53_fu_360_p2 = (loop_index4_fu_114 + 5'd1);

assign empty_56_fu_507_p2 = (loop_index_fu_122 + 5'd1);

assign empty_60_fu_578_p2 = (loop_index_i_fu_126 + 3'd1);
...
assign icmp_ln113_fu_421_p2 = ((grp_fu_403_p2 == readLinIndex_fu_409_p5) ? 1'b1 : 1'b0);
...
assign shl_ln120_1_fu_446_p6 = {{{{{trunc_ln120_1_fu_443_p1}, {ringbuffer_header_bytes_load_9_reg_699}}, {reg_321}}, {reg_326}}, {2'd0}};

assign shl_ln_fu_430_p6 = {{{{{trunc_ln120_fu_427_p1}, {ringbuffer_header_bytes_load_9_reg_699}}, {reg_321}}, {reg_326}}, {5'd0}};

assign sub_ln120_fu_459_p2 = (shl_ln_fu_430_p6 - shl_ln120_1_fu_446_p6);

assign tmp_6_fu_588_p5 = loop_index_i_fu_126[1:0];

assign trunc_ln114_fu_607_p1 = dropped_lin_counter[7:0];

assign trunc_ln120_1_fu_443_p1 = ringbuffer_header_bytes_load_8_reg_692[5:0];

assign trunc_ln120_fu_427_p1 = ringbuffer_header_bytes_load_8_reg_692[2:0];
