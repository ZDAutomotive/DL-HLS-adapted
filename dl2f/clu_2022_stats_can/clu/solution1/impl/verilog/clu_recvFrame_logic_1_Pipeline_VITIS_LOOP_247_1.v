...
module clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_247_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [4:0] add_ln247_1;
input  [31:0] canbase;
input  [14:0] zext_ln261;
...
wire   [0:0] icmp_ln247_fu_186_p2;
reg   [0:0] icmp_ln247_reg_355_pp0_iter1_reg;
reg   [0:0] icmp_ln247_reg_355_pp0_iter2_reg;
reg   [0:0] icmp_ln247_reg_355_pp0_iter3_reg;
reg   [29:0] trunc_ln_reg_359;
reg    ap_block_pp0_stage1_11001;
reg   [7:0] trunc_ln20_reg_370;
reg   [7:0] trunc_ln21_reg_375;
reg   [7:0] trunc_ln22_reg_380;
wire   [7:0] trunc_ln254_fu_281_p1;
reg   [7:0] trunc_ln254_reg_385;
reg   [6:0] canIndex_load_reg_390;
reg    ap_enable_reg_pp0_iter0_reg;
reg    ap_block_pp0_stage0_subdone;
wire   [31:0] zext_ln251_fu_294_p1;
wire   [31:0] zext_ln252_fu_305_p1;
wire   [31:0] zext_ln253_fu_326_p1;
wire   [31:0] zext_ln254_fu_336_p1;
wire  signed [31:0] sext_ln249_fu_241_p1;
reg   [4:0] DwIndex_fu_90;
wire   [4:0] DwIndex_2_fu_192_p2;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_DwIndex_1;
reg   [6:0] canIndex_fu_94;
wire   [6:0] add_ln255_fu_310_p2;
wire   [3:0] trunc_ln250_fu_198_p1;
wire   [5:0] shl_ln3_fu_202_p3;
wire   [31:0] zext_ln249_fu_210_p1;
wire   [31:0] add_ln249_1_fu_214_p2;
wire   [31:0] zext_ln261_cast_fu_169_p1;
wire   [31:0] add_ln249_fu_220_p2;
wire   [6:0] add_ln251_fu_288_p2;
wire   [6:0] add_ln252_fu_299_p2;
wire   [6:0] add_ln253_fu_321_p2;
wire   [6:0] add_ln254_fu_331_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln247_fu_186_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        trunc_ln20_reg_370 <= {{m_axi_clu_addr_RDATA[31:24]}};
        trunc_ln21_reg_375 <= {{m_axi_clu_addr_RDATA[23:16]}};
        trunc_ln22_reg_380 <= {{m_axi_clu_addr_RDATA[15:8]}};
        trunc_ln254_reg_385 <= trunc_ln254_fu_281_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln247_fu_186_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        trunc_ln_reg_359 <= {{add_ln249_fu_220_p2[31:2]}};
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_subdone) & (icmp_ln247_reg_355 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln247_reg_355_pp0_iter3_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        can_frame_address1 = zext_ln253_fu_326_p1;
    end else if (((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1))) begin
        can_frame_address1 = zext_ln251_fu_294_p1;
    end else begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1) & (icmp_ln247_reg_355 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln247_reg_355 == 1'd0))) begin
...
assign add_ln249_1_fu_214_p2 = (zext_ln249_fu_210_p1 + canbase);

assign add_ln249_fu_220_p2 = (add_ln249_1_fu_214_p2 + zext_ln261_cast_fu_169_p1);

assign add_ln251_fu_288_p2 = (canIndex_fu_94 + 7'd12);

assign add_ln252_fu_299_p2 = (canIndex_fu_94 + 7'd13);

assign add_ln253_fu_321_p2 = (canIndex_load_reg_390 + 7'd14);

assign add_ln254_fu_331_p2 = (canIndex_load_reg_390 + 7'd15);

assign add_ln255_fu_310_p2 = (canIndex_fu_94 + 7'd4);
...
always @ (*) begin
    ap_block_state2_io = ((m_axi_clu_addr_ARREADY == 1'b0) & (icmp_ln247_reg_355 == 1'd0));
end
...
assign icmp_ln247_fu_186_p2 = ((ap_sig_allocacmp_DwIndex_1 == add_ln247_1) ? 1'b1 : 1'b0);

assign m_axi_clu_addr_ARADDR = sext_ln249_fu_241_p1;
...
assign sext_ln249_fu_241_p1 = $signed(trunc_ln_reg_359);

assign shl_ln3_fu_202_p3 = {{trunc_ln250_fu_198_p1}, {2'd0}};

assign trunc_ln250_fu_198_p1 = ap_sig_allocacmp_DwIndex_1[3:0];

assign trunc_ln254_fu_281_p1 = m_axi_clu_addr_RDATA[7:0];

assign zext_ln249_fu_210_p1 = shl_ln3_fu_202_p3;

assign zext_ln251_fu_294_p1 = add_ln251_fu_288_p2;

assign zext_ln252_fu_305_p1 = add_ln252_fu_299_p2;

assign zext_ln253_fu_326_p1 = add_ln253_fu_321_p2;

assign zext_ln254_fu_336_p1 = add_ln254_fu_331_p2;

assign zext_ln261_cast_fu_169_p1 = zext_ln261;

endmodule //clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_247_1
