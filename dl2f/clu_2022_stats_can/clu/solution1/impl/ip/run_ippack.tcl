...
set solution_dir "D:/clu_2022_stats/clu/solution1"
set debug_dir "D:/clu_2022_stats/clu/solution1/.debug"
...
set Interfaces {
    s_axi_EN {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 can_ptr W 0x0 "Data signal of can_ptr" {{0 32 can_ptr W 0 "Bit 31 to 0 of can_ptr"}}} {0x18 uart_ptr W 0x0 "Data signal of uart_ptr" {{0 32 uart_ptr W 0 "Bit 31 to 0 of uart_ptr"}}} {0x20 lin_ptr W 0x0 "Data signal of lin_ptr" {{0 32 lin_ptr W 0 "Bit 31 to 0 of lin_ptr"}}} {0x28 can_10_received R 0x0 "Data signal of can_10_received" {{0 32 can_10_received R 0 "Bit 31 to 0 of can_10_received"}}} {0x2c can_10_received_ctrl R 0x0 "Control signal of can_10_received" {{0 1 can_10_received_ap_vld R 0 "Control signal can_10_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 can_11_received R 0x0 "Data signal of can_11_received" {{0 32 can_11_received R 0 "Bit 31 to 0 of can_11_received"}}} {0x3c can_11_received_ctrl R 0x0 "Control signal of can_11_received" {{0 1 can_11_received_ap_vld R 0 "Control signal can_11_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 received_can R 0x0 "Data signal of received_can" {{0 32 received_can R 0 "Bit 31 to 0 of received_can"}}} {0x4c received_can_ctrl R 0x0 "Control signal of received_can" {{0 1 received_can_ap_vld R 0 "Control signal received_can_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 can_0_received R 0x0 "Data signal of can_0_received" {{0 32 can_0_received R 0 "Bit 31 to 0 of can_0_received"}}} {0x5c can_0_received_ctrl R 0x0 "Control signal of can_0_received" {{0 1 can_0_received_ap_vld R 0 "Control signal can_0_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 can_1_received R 0x0 "Data signal of can_1_received" {{0 32 can_1_received R 0 "Bit 31 to 0 of can_1_received"}}} {0x64 can_1_received_ctrl R 0x0 "Control signal of can_1_received" {{0 1 can_1_received_ap_vld R 0 "Control signal can_1_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 can_2_received R 0x0 "Data signal of can_2_received" {{0 32 can_2_received R 0 "Bit 31 to 0 of can_2_received"}}} {0x6c can_2_received_ctrl R 0x0 "Control signal of can_2_received" {{0 1 can_2_received_ap_vld R 0 "Control signal can_2_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 can_3_received R 0x0 "Data signal of can_3_received" {{0 32 can_3_received R 0 "Bit 31 to 0 of can_3_received"}}} {0x74 can_3_received_ctrl R 0x0 "Control signal of can_3_received" {{0 1 can_3_received_ap_vld R 0 "Control signal can_3_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 can_4_received R 0x0 "Data signal of can_4_received" {{0 32 can_4_received R 0 "Bit 31 to 0 of can_4_received"}}} {0x7c can_4_received_ctrl R 0x0 "Control signal of can_4_received" {{0 1 can_4_received_ap_vld R 0 "Control signal can_4_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 can_5_received R 0x0 "Data signal of can_5_received" {{0 32 can_5_received R 0 "Bit 31 to 0 of can_5_received"}}} {0x84 can_5_received_ctrl R 0x0 "Control signal of can_5_received" {{0 1 can_5_received_ap_vld R 0 "Control signal can_5_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 can_6_received R 0x0 "Data signal of can_6_received" {{0 32 can_6_received R 0 "Bit 31 to 0 of can_6_received"}}} {0x8c can_6_received_ctrl R 0x0 "Control signal of can_6_received" {{0 1 can_6_received_ap_vld R 0 "Control signal can_6_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 can_7_received R 0x0 "Data signal of can_7_received" {{0 32 can_7_received R 0 "Bit 31 to 0 of can_7_received"}}} {0x94 can_7_received_ctrl R 0x0 "Control signal of can_7_received" {{0 1 can_7_received_ap_vld R 0 "Control signal can_7_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 can_8_received R 0x0 "Data signal of can_8_received" {{0 32 can_8_received R 0 "Bit 31 to 0 of can_8_received"}}} {0x9c can_8_received_ctrl R 0x0 "Control signal of can_8_received" {{0 1 can_8_received_ap_vld R 0 "Control signal can_8_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 can_9_received R 0x0 "Data signal of can_9_received" {{0 32 can_9_received R 0 "Bit 31 to 0 of can_9_received"}}} {0xa4 can_9_received_ctrl R 0x0 "Control signal of can_9_received" {{0 1 can_9_received_ap_vld R 0 "Control signal can_9_received_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 droped W 0x0 "Data signal of droped" {{0 32 droped W 0 "Bit 31 to 0 of droped"}}} {0x30 received_uart R 0x0 "Data signal of received_uart" {{0 32 received_uart R 0 "Bit 31 to 0 of received_uart"}}} {0x34 received_uart_ctrl R 0x0 "Control signal of received_uart" {{0 1 received_uart_ap_vld R 0 "Control signal received_uart_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 received_lin R 0x0 "Data signal of received_lin" {{0 32 received_lin R 0 "Bit 31 to 0 of received_lin"}}} {0x44 received_lin_ctrl R 0x0 "Control signal of received_lin" {{0 1 received_lin_ap_vld R 0 "Control signal received_lin_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 can_en W 0x0 "Data signal of can_en" {{0 32 can_en W 0 "Bit 31 to 0 of can_en"}}} {0xb0 uart_en W 0x0 "Data signal of uart_en" {{0 8 uart_en W 0 "Bit 7 to 0 of uart_en"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xb8 lin_en W 0x0 "Data signal of lin_en" {{0 32 lin_en W 0 "Bit 31 to 0 of lin_en"}}} {0xc0 can_ddr W 0x0 "Data signal of can_ddr" {{0 32 can_ddr W 0 "Bit 31 to 0 of can_ddr"}}} {0xc8 uart_ddr W 0x0 "Data signal of uart_ddr" {{0 32 uart_ddr W 0 "Bit 31 to 0 of uart_ddr"}}} {0xd0 lin_ddr W 0x0 "Data signal of lin_ddr" {{0 32 lin_ddr W 0 "Bit 31 to 0 of lin_ddr"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_EN m_axi_clu_addr m_axi_ps_ddr"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_clu_addr {
        ...
        data_width "32"
        port_prefix "m_axi_clu_addr"
        param_prefix "C_M_AXI_CLU_ADDR"
