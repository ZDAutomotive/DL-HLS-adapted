...
always @ (*) begin
    ap_block_state2_io = ((m_axi_clu_addr_ARREADY == 1'b0) & (icmp_ln176_reg_166 == 1'd0));
end
...
assign m_axi_clu_addr_ARADDR = sext_ln81_2_cast_reg_161;
...
assign reg_data_fu_138_p1 = m_axi_clu_addr_RDATA[7:0];
