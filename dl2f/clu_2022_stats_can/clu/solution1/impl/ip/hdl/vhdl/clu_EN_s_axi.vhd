...
port (
    ...
    can_10_received       :in   STD_LOGIC_VECTOR(31 downto 0);
    can_10_received_ap_vld :in   STD_LOGIC;
    can_11_received       :in   STD_LOGIC_VECTOR(31 downto 0);
    can_11_received_ap_vld :in   STD_LOGIC;
    ...
    can_4_received        :in   STD_LOGIC_VECTOR(31 downto 0);
    can_4_received_ap_vld :in   STD_LOGIC;
    can_5_received        :in   STD_LOGIC_VECTOR(31 downto 0);
    can_5_received_ap_vld :in   STD_LOGIC;
    can_6_received        :in   STD_LOGIC_VECTOR(31 downto 0);
    can_6_received_ap_vld :in   STD_LOGIC;
    can_7_received        :in   STD_LOGIC_VECTOR(31 downto 0);
    can_7_received_ap_vld :in   STD_LOGIC;
    can_8_received        :in   STD_LOGIC_VECTOR(31 downto 0);
    can_8_received_ap_vld :in   STD_LOGIC;
    can_9_received        :in   STD_LOGIC_VECTOR(31 downto 0);
    can_9_received_ap_vld :in   STD_LOGIC;
    droped                :out  STD_LOGIC_VECTOR(31 downto 0);
    ap_start              :out  STD_LOGIC;
    ap_done               :in   STD_LOGIC;
    ap_ready              :in   STD_LOGIC;
    ap_idle               :in   STD_LOGIC;
    received_uart         :in   STD_LOGIC_VECTOR(31 downto 0);
    received_uart_ap_vld  :in   STD_LOGIC;
...
architecture behave of clu_EN_s_axi is
    ...
    constant ADDR_CAN_10_RECEIVED_DATA_0 : INTEGER := 16#28#;
    constant ADDR_CAN_10_RECEIVED_CTRL   : INTEGER := 16#2c#;
    constant ADDR_RECEIVED_UART_DATA_0   : INTEGER := 16#30#;
    constant ADDR_RECEIVED_UART_CTRL     : INTEGER := 16#34#;
    constant ADDR_CAN_11_RECEIVED_DATA_0 : INTEGER := 16#38#;
    constant ADDR_CAN_11_RECEIVED_CTRL   : INTEGER := 16#3c#;
    constant ADDR_RECEIVED_LIN_DATA_0    : INTEGER := 16#40#;
    constant ADDR_RECEIVED_LIN_CTRL      : INTEGER := 16#44#;
    constant ADDR_RECEIVED_CAN_DATA_0    : INTEGER := 16#48#;
    constant ADDR_RECEIVED_CAN_CTRL      : INTEGER := 16#4c#;
    constant ADDR_CAN_EN_DATA_0          : INTEGER := 16#50#;
    constant ADDR_CAN_EN_CTRL            : INTEGER := 16#54#;
    constant ADDR_CAN_0_RECEIVED_DATA_0  : INTEGER := 16#58#;
    constant ADDR_CAN_0_RECEIVED_CTRL    : INTEGER := 16#5c#;
    constant ADDR_CAN_1_RECEIVED_DATA_0  : INTEGER := 16#60#;
    constant ADDR_CAN_1_RECEIVED_CTRL    : INTEGER := 16#64#;
    constant ADDR_CAN_2_RECEIVED_DATA_0  : INTEGER := 16#68#;
    constant ADDR_CAN_2_RECEIVED_CTRL    : INTEGER := 16#6c#;
    constant ADDR_CAN_3_RECEIVED_DATA_0  : INTEGER := 16#70#;
    constant ADDR_CAN_3_RECEIVED_CTRL    : INTEGER := 16#74#;
    constant ADDR_CAN_4_RECEIVED_DATA_0  : INTEGER := 16#78#;
    constant ADDR_CAN_4_RECEIVED_CTRL    : INTEGER := 16#7c#;
    constant ADDR_CAN_5_RECEIVED_DATA_0  : INTEGER := 16#80#;
    constant ADDR_CAN_5_RECEIVED_CTRL    : INTEGER := 16#84#;
    constant ADDR_CAN_6_RECEIVED_DATA_0  : INTEGER := 16#88#;
    constant ADDR_CAN_6_RECEIVED_CTRL    : INTEGER := 16#8c#;
    constant ADDR_CAN_7_RECEIVED_DATA_0  : INTEGER := 16#90#;
    constant ADDR_CAN_7_RECEIVED_CTRL    : INTEGER := 16#94#;
    constant ADDR_CAN_8_RECEIVED_DATA_0  : INTEGER := 16#98#;
    constant ADDR_CAN_8_RECEIVED_CTRL    : INTEGER := 16#9c#;
    constant ADDR_CAN_9_RECEIVED_DATA_0  : INTEGER := 16#a0#;
    constant ADDR_CAN_9_RECEIVED_CTRL    : INTEGER := 16#a4#;
    constant ADDR_DROPED_DATA_0          : INTEGER := 16#a8#;
    constant ADDR_DROPED_CTRL            : INTEGER := 16#ac#;
    constant ADDR_UART_EN_DATA_0         : INTEGER := 16#b0#;
    constant ADDR_UART_EN_CTRL           : INTEGER := 16#b4#;
    constant ADDR_LIN_EN_DATA_0          : INTEGER := 16#b8#;
    constant ADDR_LIN_EN_CTRL            : INTEGER := 16#bc#;
    constant ADDR_CAN_DDR_DATA_0         : INTEGER := 16#c0#;
    constant ADDR_CAN_DDR_CTRL           : INTEGER := 16#c4#;
    constant ADDR_UART_DDR_DATA_0        : INTEGER := 16#c8#;
    constant ADDR_UART_DDR_CTRL          : INTEGER := 16#cc#;
    constant ADDR_LIN_DDR_DATA_0         : INTEGER := 16#d0#;
    constant ADDR_LIN_DDR_CTRL           : INTEGER := 16#d4#;
    ...
    signal int_can_10_received_ap_vld : STD_LOGIC;
    signal int_can_10_received : UNSIGNED(31 downto 0) := (others => '0');
    signal int_received_uart_ap_vld : STD_LOGIC;
    signal int_received_uart   : UNSIGNED(31 downto 0) := (others => '0');
    signal int_can_11_received_ap_vld : STD_LOGIC;
    signal int_can_11_received : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_can_4_received_ap_vld : STD_LOGIC;
    signal int_can_4_received  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_can_5_received_ap_vld : STD_LOGIC;
    signal int_can_5_received  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_can_6_received_ap_vld : STD_LOGIC;
    signal int_can_6_received  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_can_7_received_ap_vld : STD_LOGIC;
    signal int_can_7_received  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_can_8_received_ap_vld : STD_LOGIC;
    signal int_can_8_received  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_can_9_received_ap_vld : STD_LOGIC;
    signal int_can_9_received  : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_CAN_10_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_10_received(31 downto 0), 32);
                    when ADDR_CAN_10_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_10_received_ap_vld;
                    when ADDR_RECEIVED_UART_DATA_0 =>
                        rdata_data <= RESIZE(int_received_uart(31 downto 0), 32);
                    when ADDR_RECEIVED_UART_CTRL =>
                        rdata_data(0) <= int_received_uart_ap_vld;
                    when ADDR_CAN_11_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_11_received(31 downto 0), 32);
                    when ADDR_CAN_11_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_11_received_ap_vld;
                    ...
                    when ADDR_CAN_4_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_4_received(31 downto 0), 32);
                    when ADDR_CAN_4_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_4_received_ap_vld;
                    when ADDR_CAN_5_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_5_received(31 downto 0), 32);
                    when ADDR_CAN_5_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_5_received_ap_vld;
                    when ADDR_CAN_6_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_6_received(31 downto 0), 32);
                    when ADDR_CAN_6_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_6_received_ap_vld;
                    when ADDR_CAN_7_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_7_received(31 downto 0), 32);
                    when ADDR_CAN_7_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_7_received_ap_vld;
                    when ADDR_CAN_8_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_8_received(31 downto 0), 32);
                    when ADDR_CAN_8_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_8_received_ap_vld;
                    when ADDR_CAN_9_RECEIVED_DATA_0 =>
                        rdata_data <= RESIZE(int_can_9_received(31 downto 0), 32);
                    when ADDR_CAN_9_RECEIVED_CTRL =>
                        rdata_data(0) <= int_can_9_received_ap_vld;
...
-- ----------------------- Register logic ----------------
    ...
    droped               <= STD_LOGIC_VECTOR(int_droped);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_10_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_10_received_ap_vld = '1') then
                    int_can_10_received <= UNSIGNED(can_10_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_10_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_10_received_ap_vld = '1') then
                    int_can_10_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_10_RECEIVED_CTRL) then
                    int_can_10_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_received_uart <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (received_uart_ap_vld = '1') then
                    int_received_uart <= UNSIGNED(received_uart);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_received_uart_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (received_uart_ap_vld = '1') then
                    int_received_uart_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_RECEIVED_UART_CTRL) then
                    int_received_uart_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_11_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_11_received_ap_vld = '1') then
                    int_can_11_received <= UNSIGNED(can_11_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_11_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_11_received_ap_vld = '1') then
                    int_can_11_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_11_RECEIVED_CTRL) then
                    int_can_11_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_4_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_4_received_ap_vld = '1') then
                    int_can_4_received <= UNSIGNED(can_4_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_4_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_4_received_ap_vld = '1') then
                    int_can_4_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_4_RECEIVED_CTRL) then
                    int_can_4_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_5_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_5_received_ap_vld = '1') then
                    int_can_5_received <= UNSIGNED(can_5_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_5_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_5_received_ap_vld = '1') then
                    int_can_5_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_5_RECEIVED_CTRL) then
                    int_can_5_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_6_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_6_received_ap_vld = '1') then
                    int_can_6_received <= UNSIGNED(can_6_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_6_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_6_received_ap_vld = '1') then
                    int_can_6_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_6_RECEIVED_CTRL) then
                    int_can_6_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_7_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_7_received_ap_vld = '1') then
                    int_can_7_received <= UNSIGNED(can_7_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_7_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_7_received_ap_vld = '1') then
                    int_can_7_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_7_RECEIVED_CTRL) then
                    int_can_7_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_8_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_8_received_ap_vld = '1') then
                    int_can_8_received <= UNSIGNED(can_8_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_8_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_8_received_ap_vld = '1') then
                    int_can_8_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_8_RECEIVED_CTRL) then
                    int_can_8_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_9_received <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (can_9_received_ap_vld = '1') then
                    int_can_9_received <= UNSIGNED(can_9_received);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_can_9_received_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (can_9_received_ap_vld = '1') then
                    int_can_9_received_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CAN_9_RECEIVED_CTRL) then
                    int_can_9_received_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DROPED_DATA_0) then
                    int_droped(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_droped(31 downto 0));
                end if;
            end if;
        end if;
    end process;
