...
begin
    ...
    ap_block_state2_io_assign_proc : process(m_axi_clu_addr_ARREADY, icmp_ln176_reg_166)
    begin
                ap_block_state2_io <= ((m_axi_clu_addr_ARREADY = ap_const_logic_0) and (icmp_ln176_reg_166 = ap_const_lv1_0));
    end process;
    ...
    clu_addr_blk_n_AR_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_clu_addr_ARREADY, icmp_ln176_reg_166, ap_block_pp0_stage0)
    begin
    ...
    m_axi_clu_addr_ARADDR <= sext_ln81_2_cast_reg_161;
    ...
    m_axi_clu_addr_ARVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln176_reg_166, ap_block_pp0_stage0_11001)
    begin
    ...
    reg_data_fu_138_p1 <= m_axi_clu_addr_RDATA(8 - 1 downto 0);
