...
entity clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_247_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_247_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln247_reg_355 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln247_fu_186_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln247_reg_355_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln247_reg_355_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln247_reg_355_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln_reg_359 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal trunc_ln20_reg_370 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln21_reg_375 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln22_reg_380 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln254_fu_281_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln254_reg_385 : STD_LOGIC_VECTOR (7 downto 0);
    signal canIndex_load_reg_390 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal zext_ln251_fu_294_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln252_fu_305_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln253_fu_326_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln254_fu_336_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln249_fu_241_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln255_fu_310_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal trunc_ln250_fu_198_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal shl_ln3_fu_202_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln249_fu_210_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln249_1_fu_214_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln261_cast_fu_169_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln249_fu_220_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln251_fu_288_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln252_fu_299_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln253_fu_321_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln254_fu_331_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln247_fu_186_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                ...
                canIndex_fu_94 <= add_ln255_fu_310_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln247_reg_355 <= icmp_ln247_fu_186_p2;
                icmp_ln247_reg_355_pp0_iter1_reg <= icmp_ln247_reg_355;
                icmp_ln247_reg_355_pp0_iter2_reg <= icmp_ln247_reg_355_pp0_iter1_reg;
                icmp_ln247_reg_355_pp0_iter3_reg <= icmp_ln247_reg_355_pp0_iter2_reg;
                trunc_ln20_reg_370 <= m_axi_clu_addr_RDATA(31 downto 24);
                trunc_ln21_reg_375 <= m_axi_clu_addr_RDATA(23 downto 16);
                trunc_ln22_reg_380 <= m_axi_clu_addr_RDATA(15 downto 8);
                trunc_ln254_reg_385 <= trunc_ln254_fu_281_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln247_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                trunc_ln_reg_359 <= add_ln249_fu_220_p2(31 downto 2);
            end if;
        end if;
    end process;
    ...
    add_ln249_1_fu_214_p2 <= std_logic_vector(unsigned(zext_ln249_fu_210_p1) + unsigned(canbase));
    add_ln249_fu_220_p2 <= std_logic_vector(unsigned(add_ln249_1_fu_214_p2) + unsigned(zext_ln261_cast_fu_169_p1));
    add_ln251_fu_288_p2 <= std_logic_vector(unsigned(canIndex_fu_94) + unsigned(ap_const_lv7_C));
    add_ln252_fu_299_p2 <= std_logic_vector(unsigned(canIndex_fu_94) + unsigned(ap_const_lv7_D));
    add_ln253_fu_321_p2 <= std_logic_vector(unsigned(canIndex_load_reg_390) + unsigned(ap_const_lv7_E));
    add_ln254_fu_331_p2 <= std_logic_vector(unsigned(canIndex_load_reg_390) + unsigned(ap_const_lv7_F));
    add_ln255_fu_310_p2 <= std_logic_vector(unsigned(canIndex_fu_94) + unsigned(ap_const_lv7_4));
    ...
    ap_block_state2_io_assign_proc : process(m_axi_clu_addr_ARREADY, icmp_ln247_reg_355)
    begin
                ap_block_state2_io <= ((m_axi_clu_addr_ARREADY = ap_const_logic_0) and (icmp_ln247_reg_355 = ap_const_lv1_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, icmp_ln247_reg_355, ap_block_pp0_stage1_subdone)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (icmp_ln247_reg_355 = ap_const_lv1_1))) then 
    ...
    ap_condition_exit_pp0_iter4_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter4, icmp_ln247_reg_355_pp0_iter3_reg, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_enable_reg_pp0_iter4 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln247_reg_355_pp0_iter3_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    can_frame_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter4, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage0, zext_ln252_fu_305_p1, zext_ln254_fu_336_p1)
    begin
        if (((ap_enable_reg_pp0_iter5 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            can_frame_address0 <= zext_ln254_fu_336_p1(7 - 1 downto 0);
            ...
            can_frame_address0 <= zext_ln252_fu_305_p1(7 - 1 downto 0);
        else 
    ...
    can_frame_address1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter4, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage0, zext_ln251_fu_294_p1, zext_ln253_fu_326_p1)
    begin
        if (((ap_enable_reg_pp0_iter5 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            can_frame_address1 <= zext_ln253_fu_326_p1(7 - 1 downto 0);
        elsif (((ap_enable_reg_pp0_iter4 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
            can_frame_address1 <= zext_ln251_fu_294_p1(7 - 1 downto 0);
        else 
    ...
    can_frame_d0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter4, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage0, trunc_ln21_reg_375, trunc_ln254_reg_385)
    begin
        if (((ap_enable_reg_pp0_iter5 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            can_frame_d0 <= trunc_ln254_reg_385;
        elsif (((ap_enable_reg_pp0_iter4 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
            can_frame_d0 <= trunc_ln21_reg_375;
        else 
    ...
    can_frame_d1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter4, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage0, trunc_ln20_reg_370, trunc_ln22_reg_380)
    begin
        if (((ap_enable_reg_pp0_iter5 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            can_frame_d1 <= trunc_ln22_reg_380;
        elsif (((ap_enable_reg_pp0_iter4 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
            can_frame_d1 <= trunc_ln20_reg_370;
        else 
    ...
    clu_addr_blk_n_AR_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, m_axi_clu_addr_ARREADY, icmp_ln247_reg_355, ap_block_pp0_stage1)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (icmp_ln247_reg_355 = ap_const_lv1_0))) then 
    ...
    icmp_ln247_fu_186_p2 <= "1" when (ap_sig_allocacmp_DwIndex_1 = add_ln247_1) else "0";
    m_axi_clu_addr_ARADDR <= sext_ln249_fu_241_p1;
    ...
    m_axi_clu_addr_ARVALID_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, icmp_ln247_reg_355, ap_block_pp0_stage1_11001)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (icmp_ln247_reg_355 = ap_const_lv1_0))) then 
    ...
    m_axi_clu_addr_WVALID <= ap_const_logic_0;
        sext_ln249_fu_241_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_359),32));

    shl_ln3_fu_202_p3 <= (trunc_ln250_fu_198_p1 & ap_const_lv2_0);
    trunc_ln250_fu_198_p1 <= ap_sig_allocacmp_DwIndex_1(4 - 1 downto 0);
    trunc_ln254_fu_281_p1 <= m_axi_clu_addr_RDATA(8 - 1 downto 0);
    zext_ln249_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln3_fu_202_p3),32));
    zext_ln251_fu_294_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln251_fu_288_p2),32));
    zext_ln252_fu_305_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln252_fu_299_p2),32));
    zext_ln253_fu_326_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln253_fu_321_p2),32));
    zext_ln254_fu_336_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln254_fu_331_p2),32));
    zext_ln261_cast_fu_169_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln261),32));
end behav;
