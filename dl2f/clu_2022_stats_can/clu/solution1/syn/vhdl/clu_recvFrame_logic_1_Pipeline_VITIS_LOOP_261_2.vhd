...
entity clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_261_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_261_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln261_reg_402 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln261_fu_184_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln263_fu_190_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln263_reg_406 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln_reg_413 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal trunc_ln17_reg_424 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln18_reg_429 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln19_reg_434 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln267_fu_314_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln267_reg_439 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln264_fu_321_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal trunc_ln264_reg_444 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal zext_ln264_fu_331_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln265_fu_342_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln266_fu_363_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln267_fu_373_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln262_fu_274_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln268_fu_347_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln27_cast_fu_167_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln261_cast_fu_163_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sub_ln263_fu_203_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln263_1_fu_208_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_fu_196_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln263_1_fu_218_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_7_fu_224_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal select_ln263_fu_233_p3 : STD_LOGIC_VECTOR (29 downto 0);
    signal shl_ln2_fu_241_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln262_fu_249_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln264_fu_325_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln265_fu_336_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln266_fu_358_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln267_fu_368_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln261_reg_402 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    canIndex_fu_88 <= add_ln268_fu_347_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                icmp_ln261_reg_402 <= icmp_ln261_fu_184_p2;
                trunc_ln264_reg_444 <= trunc_ln264_fu_321_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln261_fu_184_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln263_reg_406 <= add_ln263_fu_190_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                ...
                trunc_ln17_reg_424 <= m_axi_clu_addr_RDATA(31 downto 24);
                trunc_ln18_reg_429 <= m_axi_clu_addr_RDATA(23 downto 16);
                trunc_ln19_reg_434 <= m_axi_clu_addr_RDATA(15 downto 8);
                trunc_ln267_reg_439 <= trunc_ln267_fu_314_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln261_reg_402 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                trunc_ln_reg_413 <= add_ln262_fu_249_p2(31 downto 2);
            end if;
        end if;
    end process;
    ...
    add_ln262_fu_249_p2 <= std_logic_vector(unsigned(shl_ln2_fu_241_p3) + unsigned(canbase));
    add_ln263_fu_190_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_Len_2) + unsigned(zext_ln261_cast_fu_163_p1));
    add_ln264_fu_325_p2 <= std_logic_vector(unsigned(trunc_ln264_fu_321_p1) + unsigned(ap_const_lv7_C));
    add_ln265_fu_336_p2 <= std_logic_vector(unsigned(trunc_ln264_fu_321_p1) + unsigned(ap_const_lv7_D));
    add_ln266_fu_358_p2 <= std_logic_vector(unsigned(trunc_ln264_reg_444) + unsigned(ap_const_lv7_E));
    add_ln267_fu_368_p2 <= std_logic_vector(unsigned(trunc_ln264_reg_444) + unsigned(ap_const_lv7_F));
    add_ln268_fu_347_p2 <= std_logic_vector(unsigned(canIndex_fu_88) + unsigned(ap_const_lv64_4));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
    ap_CS_fsm_pp0_stage1 <= ap_CS_fsm(1);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_clu_addr_ARREADY)
    begin
                ap_block_pp0_stage0_11001 <= ((m_axi_clu_addr_ARREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_clu_addr_ARREADY)
    begin
                ap_block_pp0_stage0_subdone <= ((m_axi_clu_addr_ARREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_pp0_stage1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage1_11001_assign_proc : process(ap_enable_reg_pp0_iter4, m_axi_clu_addr_RVALID)
    begin
                ap_block_pp0_stage1_11001 <= ((m_axi_clu_addr_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage1_subdone_assign_proc : process(ap_enable_reg_pp0_iter4, m_axi_clu_addr_RVALID)
    begin
                ap_block_pp0_stage1_subdone <= ((m_axi_clu_addr_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1));
    end process;


    ap_block_state10_pp0_stage1_iter4_assign_proc : process(m_axi_clu_addr_RVALID)
    begin
                ap_block_state10_pp0_stage1_iter4 <= (m_axi_clu_addr_RVALID = ap_const_logic_0);
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, icmp_ln261_reg_402)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln261_reg_402 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone))) then 
    ...
    can_frame_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0, ap_block_pp0_stage1, zext_ln265_fu_342_p1, zext_ln267_fu_373_p1)
    begin
        if ((ap_enable_reg_pp0_iter5 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address0 <= zext_ln267_fu_373_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_address0 <= zext_ln265_fu_342_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_address1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0, ap_block_pp0_stage1, zext_ln264_fu_331_p1, zext_ln266_fu_363_p1)
    begin
        if ((ap_enable_reg_pp0_iter5 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address1 <= zext_ln266_fu_363_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_address1 <= zext_ln264_fu_331_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_d0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0, ap_block_pp0_stage1, trunc_ln18_reg_429, trunc_ln267_reg_439)
    begin
        if ((ap_enable_reg_pp0_iter5 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_d0 <= trunc_ln267_reg_439;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_d0 <= trunc_ln18_reg_429;
            else 
    ...
    can_frame_d1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0, ap_block_pp0_stage1, trunc_ln17_reg_424, trunc_ln19_reg_434)
    begin
        if ((ap_enable_reg_pp0_iter5 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_d1 <= trunc_ln19_reg_434;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_d1 <= trunc_ln17_reg_424;
            else 
    ...
    clu_addr_blk_n_AR_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_clu_addr_ARREADY, ap_block_pp0_stage0)
    begin
    ...
    clu_addr_blk_n_R_assign_proc : process(ap_enable_reg_pp0_iter4, ap_CS_fsm_pp0_stage1, m_axi_clu_addr_RVALID, ap_block_pp0_stage1)
    begin
    ...
    icmp_ln261_fu_184_p2 <= "1" when (unsigned(ap_sig_allocacmp_Len_2) < unsigned(zext_ln27_cast_fu_167_p1)) else "0";
    m_axi_clu_addr_ARADDR <= sext_ln262_fu_274_p1;
    ...
    m_axi_clu_addr_ARVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_clu_addr_RREADY_assign_proc : process(ap_enable_reg_pp0_iter4, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
    ...
    select_ln263_fu_233_p3 <= 
        sub_ln263_1_fu_218_p2 when (tmp_fu_196_p3(0) = '1') else 
        tmp_7_fu_224_p4;
        sext_ln262_fu_274_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_413),32));

    shl_ln2_fu_241_p3 <= (select_ln263_fu_233_p3 & ap_const_lv2_0);
    sub_ln263_1_fu_218_p2 <= std_logic_vector(unsigned(ap_const_lv30_0) - unsigned(trunc_ln263_1_fu_208_p4));
    sub_ln263_fu_203_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(add_ln263_reg_406));
    tmp_7_fu_224_p4 <= add_ln263_reg_406(31 downto 2);
    tmp_fu_196_p3 <= add_ln263_reg_406(31 downto 31);
    trunc_ln263_1_fu_208_p4 <= sub_ln263_fu_203_p2(31 downto 2);
    trunc_ln264_fu_321_p1 <= canIndex_fu_88(7 - 1 downto 0);
    trunc_ln267_fu_314_p1 <= m_axi_clu_addr_RDATA(8 - 1 downto 0);
    zext_ln261_cast_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln261),32));
    zext_ln264_fu_331_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln264_fu_325_p2),32));
    zext_ln265_fu_342_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln265_fu_336_p2),32));
    zext_ln266_fu_363_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln266_fu_358_p2),32));
    zext_ln267_fu_373_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln267_fu_368_p2),32));
