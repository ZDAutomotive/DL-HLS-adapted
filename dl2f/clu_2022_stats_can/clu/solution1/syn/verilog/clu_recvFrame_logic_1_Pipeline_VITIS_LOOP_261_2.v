...
module clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_261_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln261_fu_184_p2;
wire   [31:0] add_ln263_fu_190_p2;
reg   [31:0] add_ln263_reg_406;
reg   [29:0] trunc_ln_reg_413;
reg    ap_block_pp0_stage1_11001;
reg   [7:0] trunc_ln17_reg_424;
reg   [7:0] trunc_ln18_reg_429;
reg   [7:0] trunc_ln19_reg_434;
wire   [7:0] trunc_ln267_fu_314_p1;
reg   [7:0] trunc_ln267_reg_439;
wire   [6:0] trunc_ln264_fu_321_p1;
reg   [6:0] trunc_ln264_reg_444;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [31:0] zext_ln264_fu_331_p1;
wire   [31:0] zext_ln265_fu_342_p1;
wire   [31:0] zext_ln266_fu_363_p1;
wire   [31:0] zext_ln267_fu_373_p1;
wire  signed [31:0] sext_ln262_fu_274_p1;
reg   [31:0] Len_fu_84;
wire   [31:0] Len_3_fu_264_p2;
wire    ap_loop_init;
reg   [31:0] ap_sig_allocacmp_Len_2;
reg   [63:0] canIndex_fu_88;
wire   [63:0] add_ln268_fu_347_p2;
wire   [31:0] zext_ln27_cast_fu_167_p1;
wire   [31:0] zext_ln261_cast_fu_163_p1;
wire   [31:0] sub_ln263_fu_203_p2;
wire   [29:0] trunc_ln263_1_fu_208_p4;
wire   [0:0] tmp_fu_196_p3;
wire   [29:0] sub_ln263_1_fu_218_p2;
wire   [29:0] tmp_7_fu_224_p4;
wire   [29:0] select_ln263_fu_233_p3;
wire   [31:0] shl_ln2_fu_241_p3;
wire   [31:0] add_ln262_fu_249_p2;
wire   [6:0] add_ln264_fu_325_p2;
wire   [6:0] add_ln265_fu_336_p2;
wire   [6:0] add_ln266_fu_358_p2;
wire   [6:0] add_ln267_fu_368_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        Len_fu_84 <= 32'd0;
    end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln261_reg_402 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln261_fu_184_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        ...
        trunc_ln17_reg_424 <= {{m_axi_clu_addr_RDATA[31:24]}};
        trunc_ln18_reg_429 <= {{m_axi_clu_addr_RDATA[23:16]}};
        trunc_ln19_reg_434 <= {{m_axi_clu_addr_RDATA[15:8]}};
        trunc_ln267_reg_439 <= trunc_ln267_fu_314_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln261_reg_402 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        trunc_ln_reg_413 <= {{add_ln262_fu_249_p2[31:2]}};
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln261_reg_402 == 1'd0) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter5 == 1'b1)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1))) begin
            can_frame_address0 = zext_ln267_fu_373_p1;
        end else if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
            can_frame_address0 = zext_ln265_fu_342_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter5 == 1'b1)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1))) begin
            can_frame_address1 = zext_ln266_fu_363_p1;
        end else if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
            can_frame_address1 = zext_ln264_fu_331_p1;
        end else begin
...
assign add_ln262_fu_249_p2 = (shl_ln2_fu_241_p3 + canbase);

assign add_ln263_fu_190_p2 = (ap_sig_allocacmp_Len_2 + zext_ln261_cast_fu_163_p1);

assign add_ln264_fu_325_p2 = (trunc_ln264_fu_321_p1 + 7'd12);

assign add_ln265_fu_336_p2 = (trunc_ln264_fu_321_p1 + 7'd13);

assign add_ln266_fu_358_p2 = (trunc_ln264_reg_444 + 7'd14);

assign add_ln267_fu_368_p2 = (trunc_ln264_reg_444 + 7'd15);

assign add_ln268_fu_347_p2 = (canIndex_fu_88 + 64'd4);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_clu_addr_ARREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_clu_addr_ARREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((m_axi_clu_addr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter4 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((m_axi_clu_addr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter4 == 1'b1));
end

always @ (*) begin
    ap_block_state10_pp0_stage1_iter4 = (m_axi_clu_addr_RVALID == 1'b0);
end
...
assign icmp_ln261_fu_184_p2 = ((ap_sig_allocacmp_Len_2 < zext_ln27_cast_fu_167_p1) ? 1'b1 : 1'b0);

assign m_axi_clu_addr_ARADDR = sext_ln262_fu_274_p1;
...
assign select_ln263_fu_233_p3 = ((tmp_fu_196_p3[0:0] == 1'b1) ? sub_ln263_1_fu_218_p2 : tmp_7_fu_224_p4);

assign sext_ln262_fu_274_p1 = $signed(trunc_ln_reg_413);

assign shl_ln2_fu_241_p3 = {{select_ln263_fu_233_p3}, {2'd0}};

assign sub_ln263_1_fu_218_p2 = (30'd0 - trunc_ln263_1_fu_208_p4);

assign sub_ln263_fu_203_p2 = (32'd0 - add_ln263_reg_406);

assign tmp_7_fu_224_p4 = {{add_ln263_reg_406[31:2]}};

assign tmp_fu_196_p3 = add_ln263_reg_406[32'd31];

assign trunc_ln263_1_fu_208_p4 = {{sub_ln263_fu_203_p2[31:2]}};

assign trunc_ln264_fu_321_p1 = canIndex_fu_88[6:0];

assign trunc_ln267_fu_314_p1 = m_axi_clu_addr_RDATA[7:0];

assign zext_ln261_cast_fu_163_p1 = zext_ln261;

assign zext_ln264_fu_331_p1 = add_ln264_fu_325_p2;

assign zext_ln265_fu_342_p1 = add_ln265_fu_336_p2;

assign zext_ln266_fu_363_p1 = add_ln266_fu_358_p2;

assign zext_ln267_fu_373_p1 = add_ln267_fu_368_p2;

assign zext_ln27_cast_fu_167_p1 = zext_ln27;

endmodule //clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_261_2
