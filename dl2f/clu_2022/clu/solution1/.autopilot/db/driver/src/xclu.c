...
void XClu_Set_can_ptr(XClu *InstancePtr, u64 Data) {
    ...
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_PTR_DATA, (u32)(Data));
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_PTR_DATA + 4, (u32)(Data >> 32));
}
...
u64 XClu_Get_can_ptr(XClu *InstancePtr) {
    ...
    Data += (u64)XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_PTR_DATA + 4) << 32;
    return Data;
}
...
void XClu_Set_uart_ptr(XClu *InstancePtr, u64 Data) {
    ...
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_UART_PTR_DATA, (u32)(Data));
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_UART_PTR_DATA + 4, (u32)(Data >> 32));
}
...
u64 XClu_Get_uart_ptr(XClu *InstancePtr) {
    ...
    Data += (u64)XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_UART_PTR_DATA + 4) << 32;
    return Data;
}
...
void XClu_Set_lin_ptr(XClu *InstancePtr, u64 Data) {
    ...
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_LIN_PTR_DATA, (u32)(Data));
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_LIN_PTR_DATA + 4, (u32)(Data >> 32));
}
...
u64 XClu_Get_lin_ptr(XClu *InstancePtr) {
    ...
    Data += (u64)XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_LIN_PTR_DATA + 4) << 32;
    return Data;
}
...
u32 XClu_Get_received_uart_vld(XClu *InstancePtr) {
    ...
    Data = XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_RECEIVED_UART_CTRL);
    return Data & 0x1;
}
...
void XClu_Set_can_ddr(XClu *InstancePtr, u64 Data) {
    ...
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_DDR_DATA, (u32)(Data));
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_DDR_DATA + 4, (u32)(Data >> 32));
}
...
u64 XClu_Get_can_ddr(XClu *InstancePtr) {
    ...
    Data += (u64)XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_CAN_DDR_DATA + 4) << 32;
    return Data;
}
...
void XClu_Set_uart_ddr(XClu *InstancePtr, u64 Data) {
    ...
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_UART_DDR_DATA, (u32)(Data));
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_UART_DDR_DATA + 4, (u32)(Data >> 32));
}
...
u64 XClu_Get_uart_ddr(XClu *InstancePtr) {
    ...
    Data += (u64)XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_UART_DDR_DATA + 4) << 32;
    return Data;
}
...
void XClu_Set_lin_ddr(XClu *InstancePtr, u64 Data) {
    ...
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_LIN_DDR_DATA, (u32)(Data));
    XClu_WriteReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_LIN_DDR_DATA + 4, (u32)(Data >> 32));
}
...
u64 XClu_Get_lin_ddr(XClu *InstancePtr) {
    ...
    Data += (u64)XClu_ReadReg(InstancePtr->En_BaseAddress, XCLU_EN_ADDR_LIN_DDR_DATA + 4) << 32;
    return Data;
}
