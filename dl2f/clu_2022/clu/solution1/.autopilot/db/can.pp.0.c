...
int recvFrame_logic (volatile int *canbase,
 ...
 can_frame[12 + 5] = (orFrameID) & 0x01;
  ...
  if (CanEDL & 0x08000000) {
   ...
   VITIS_LOOP_205_1: for (int Len = 0;Len < Dlc;Len += 4) {
  ...
  DwIndex++;
   ...
   VITIS_LOOP_219_2: for (int Len = 0;Len < Dlc;Len += 4) {
  int data = *(canbase + (0x2108 +(readIndex*72)
               + Len) / 4);
  can_frame[12 + canIndex] = (data & 0xFF000000) >> 24;
  can_frame[12 + canIndex + 1] = (data & 0x00FF0000) >> 16;
...
void can (volatile int *canbase,
 ...
 VITIS_LOOP_275_1: for (int jj = 0; jj < 12; jj++) CanFd_Recv_Sequential(canbase, ddr, enable, jj, timestamp, received_can);
}
