set moduleName recvFrame_logic_1_Pipeline_VITIS_LOOP_206_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {recvFrame_logic.1_Pipeline_VITIS_LOOP_206_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln206_1 int 5 regular  }
	{ canbase int 32 regular  }
	{ zext_ln206 int 15 regular  }
	{ can_addr int 32 regular {axi_master 0}  }
	{ can_frame int 8 regular {array 92 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln206_1", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "canbase", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln206", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln206_1 sc_in sc_lv 5 signal 0 } 
	{ canbase sc_in sc_lv 32 signal 1 } 
	{ zext_ln206 sc_in sc_lv 15 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln206_1", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "add_ln206_1", "role": "default" }} , 
 	{ "name": "canbase", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "canbase", "role": "default" }} , 
 	{ "name": "zext_ln206", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln206", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "12", "Max" : "57"}
	, {"Name" : "Interval", "Min" : "12", "Max" : "57"}
]}
...
set Spec2ImplPortList { 
	add_ln206_1 { ap_none {  { add_ln206_1 in_data 0 5 } } }
	canbase { ap_none {  { canbase in_data 0 32 } } }
	zext_ln206 { ap_none {  { zext_ln206 in_data 0 15 } } }
