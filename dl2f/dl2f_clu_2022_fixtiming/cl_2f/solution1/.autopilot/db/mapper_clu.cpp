...
using hls::sim::Byte;
extern "C" void clu(Byte<4>*, Byte<4>*, Byte<4>*, Byte<1>*, int, int, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, int, long long);
