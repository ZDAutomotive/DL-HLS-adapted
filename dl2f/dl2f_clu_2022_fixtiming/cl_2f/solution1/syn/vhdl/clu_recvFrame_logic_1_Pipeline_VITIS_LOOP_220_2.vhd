...
entity clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_220_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clu_recvFrame_logic_1_Pipeline_VITIS_LOOP_220_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln220_reg_402 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln220_fu_184_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln222_fu_190_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln222_reg_406 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal trunc_ln226_fu_314_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln226_reg_439 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln223_fu_321_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal trunc_ln223_reg_444 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal zext_ln223_fu_331_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln224_fu_342_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln225_fu_363_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln226_fu_373_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln221_fu_274_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln227_fu_347_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal sub_ln222_fu_203_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln222_1_fu_208_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_fu_196_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln222_1_fu_218_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_6_fu_224_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal select_ln222_fu_233_p3 : STD_LOGIC_VECTOR (29 downto 0);
    signal shl_ln2_fu_241_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln221_fu_249_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln223_fu_325_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln224_fu_336_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln225_fu_358_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln226_fu_368_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln220_reg_402 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    canIndex_fu_88 <= add_ln227_fu_347_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                icmp_ln220_reg_402 <= icmp_ln220_fu_184_p2;
                trunc_ln223_reg_444 <= trunc_ln223_fu_321_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln220_fu_184_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln222_reg_406 <= add_ln222_fu_190_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                ...
                trunc_ln226_reg_439 <= trunc_ln226_fu_314_p1;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln220_reg_402 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                trunc_ln_reg_413 <= add_ln221_fu_249_p2(31 downto 2);
            end if;
        end if;
    end process;
    ...
    add_ln221_fu_249_p2 <= std_logic_vector(unsigned(shl_ln2_fu_241_p3) + unsigned(canbase));
    add_ln222_fu_190_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_Len_2) + unsigned(zext_ln206_cast_fu_163_p1));
    add_ln223_fu_325_p2 <= std_logic_vector(unsigned(trunc_ln223_fu_321_p1) + unsigned(ap_const_lv7_C));
    add_ln224_fu_336_p2 <= std_logic_vector(unsigned(trunc_ln223_fu_321_p1) + unsigned(ap_const_lv7_D));
    add_ln225_fu_358_p2 <= std_logic_vector(unsigned(trunc_ln223_reg_444) + unsigned(ap_const_lv7_E));
    add_ln226_fu_368_p2 <= std_logic_vector(unsigned(trunc_ln223_reg_444) + unsigned(ap_const_lv7_F));
    add_ln227_fu_347_p2 <= std_logic_vector(unsigned(canIndex_fu_88) + unsigned(ap_const_lv64_4));
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, icmp_ln220_reg_402)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln220_reg_402 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone))) then 
    ...
    can_frame_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0, ap_block_pp0_stage1, zext_ln224_fu_342_p1, zext_ln226_fu_373_p1)
    begin
        if ((ap_enable_reg_pp0_iter5 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address0 <= zext_ln226_fu_373_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_address0 <= zext_ln224_fu_342_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_address1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0, ap_block_pp0_stage1, zext_ln223_fu_331_p1, zext_ln225_fu_363_p1)
    begin
        if ((ap_enable_reg_pp0_iter5 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_address1 <= zext_ln225_fu_363_p1(7 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
                can_frame_address1 <= zext_ln223_fu_331_p1(7 - 1 downto 0);
            else 
    ...
    can_frame_d0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0, ap_block_pp0_stage1, trunc_ln3_reg_429, trunc_ln226_reg_439)
    begin
        if ((ap_enable_reg_pp0_iter5 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                can_frame_d0 <= trunc_ln226_reg_439;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    icmp_ln220_fu_184_p2 <= "1" when (unsigned(ap_sig_allocacmp_Len_2) < unsigned(zext_ln26_cast_fu_167_p1)) else "0";
    m_axi_can_addr_ARADDR <= sext_ln221_fu_274_p1;
    ...
    select_ln222_fu_233_p3 <= 
        sub_ln222_1_fu_218_p2 when (tmp_fu_196_p3(0) = '1') else 
        tmp_6_fu_224_p4;
        sext_ln221_fu_274_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_413),32));

    shl_ln2_fu_241_p3 <= (select_ln222_fu_233_p3 & ap_const_lv2_0);
    sub_ln222_1_fu_218_p2 <= std_logic_vector(unsigned(ap_const_lv30_0) - unsigned(trunc_ln222_1_fu_208_p4));
    sub_ln222_fu_203_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(add_ln222_reg_406));
    tmp_6_fu_224_p4 <= add_ln222_reg_406(31 downto 2);
    tmp_fu_196_p3 <= add_ln222_reg_406(31 downto 31);
    trunc_ln222_1_fu_208_p4 <= sub_ln222_fu_203_p2(31 downto 2);
    trunc_ln223_fu_321_p1 <= canIndex_fu_88(7 - 1 downto 0);
    trunc_ln226_fu_314_p1 <= m_axi_can_addr_RDATA(8 - 1 downto 0);
    zext_ln206_cast_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln206),32));
    zext_ln223_fu_331_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln223_fu_325_p2),32));
    zext_ln224_fu_342_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln224_fu_336_p2),32));
    zext_ln225_fu_363_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln225_fu_358_p2),32));
    zext_ln226_fu_373_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln226_fu_368_p2),32));
