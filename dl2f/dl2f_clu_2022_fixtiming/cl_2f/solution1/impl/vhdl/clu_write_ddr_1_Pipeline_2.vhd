...
attribute shreg_extract : string;
    ...
    signal empty_60_fu_118_p2 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    mux_42_8_1_1_U41 : component clu_mux_42_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond4_fu_112_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index_i_fu_56 <= empty_60_fu_118_p2;
    ...
    empty_60_fu_118_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_i_load) + unsigned(ap_const_lv3_1));
