...
attribute shreg_extract : string;
    ...
    signal icmp_ln115_reg_754 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln115_fu_421_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln117_1_fu_623_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln117_1_reg_831 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal add_ln122_1_fu_471_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln117_fu_487_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln18_fu_523_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state65 : BOOLEAN;
    signal add_ln116_fu_611_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal loop_index4_fu_114 : STD_LOGIC_VECTOR (4 downto 0);
    signal empty_50_fu_360_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal loop_index_fu_122 : STD_LOGIC_VECTOR (4 downto 0);
    signal empty_53_fu_507_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal loop_index_i_fu_126 : STD_LOGIC_VECTOR (2 downto 0);
    signal empty_57_fu_578_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal trunc_ln122_fu_427_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal trunc_ln122_1_fu_443_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal shl_ln_fu_430_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln122_1_fu_446_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal sub_ln122_fu_459_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln122_fu_465_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_588_p5 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln116_fu_607_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    urem_32ns_32ns_32_36_seq_1_U10 : component clu_urem_32ns_32ns_32_36_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
    ...
    mux_42_8_1_1_U11 : component clu_mux_42_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (m_axi_ps_ddr_ARREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                ...
                loop_index4_fu_114 <= empty_50_fu_360_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln115_fu_421_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state49))) then 
                loop_index_fu_122 <= ap_const_lv5_0;
            elsif (((exitcond55_fu_501_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state51))) then 
                loop_index_fu_122 <= empty_53_fu_507_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond55_fu_501_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state51))) then 
                ...
                loop_index_i_fu_126 <= empty_57_fu_578_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln115_fu_421_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state49))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond55_fu_501_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state51))) then
                ps_ddr_addr_3_reg_792 <= add_ln18_fu_523_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_ps_ddr_AWREADY, m_axi_ps_ddr_WREADY, m_axi_ps_ddr_ARREADY, m_axi_ps_ddr_RVALID, m_axi_ps_ddr_BVALID, ap_CS_fsm_state9, ap_CS_fsm_state66, ap_CS_fsm_state67, ap_CS_fsm_state72, ap_CS_fsm_state50, ap_CS_fsm_state53, ap_CS_fsm_state58, ap_CS_fsm_state54, ap_CS_fsm_state60, ap_CS_fsm_state65, icmp_ln115_reg_754, ap_CS_fsm_state8, exitcond66_fu_354_p2, ap_CS_fsm_state49, icmp_ln115_fu_421_p2, ap_CS_fsm_state51, exitcond55_fu_501_p2, ap_CS_fsm_state59, exitcond4_fu_572_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state65 => 
                if ((not(((icmp_ln115_reg_754 = ap_const_lv1_0) and (m_axi_ps_ddr_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state65))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state65;
                end if;
    ...
    add_ln116_fu_611_p2 <= std_logic_vector(unsigned(dropped_lin_counter) + unsigned(ap_const_lv16_1));
    add_ln117_1_fu_623_p2 <= std_logic_vector(unsigned(trunc_ln116_fu_607_p1) + unsigned(ap_const_lv8_1));
    add_ln117_fu_487_p2 <= std_logic_vector(unsigned(ddr_header) + unsigned(ap_const_lv32_4));
    add_ln122_1_fu_471_p2 <= std_logic_vector(unsigned(add_ln122_fu_465_p2) + unsigned(ddr_header));
    add_ln122_fu_465_p2 <= std_logic_vector(unsigned(sub_ln122_fu_459_p2) + unsigned(ap_const_lv32_1C));
    add_ln18_fu_523_p2 <= std_logic_vector(unsigned(ddr_header) + unsigned(ap_const_lv32_18));
    ...
    ap_ST_fsm_state65_blk_assign_proc : process(m_axi_ps_ddr_BVALID, icmp_ln115_reg_754)
    begin
        if (((icmp_ln115_reg_754 = ap_const_lv1_0) and (m_axi_ps_ddr_BVALID = ap_const_logic_0))) then 
    ...
    ap_block_state65_assign_proc : process(m_axi_ps_ddr_BVALID, icmp_ln115_reg_754)
    begin
                ap_block_state65 <= ((icmp_ln115_reg_754 = ap_const_lv1_0) and (m_axi_ps_ddr_BVALID = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_ps_ddr_BVALID, ap_CS_fsm_state65, icmp_ln115_reg_754)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or (not(((icmp_ln115_reg_754 = ap_const_lv1_0) and (m_axi_ps_ddr_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state65)))) then 
    ...
    ap_ready_assign_proc : process(m_axi_ps_ddr_BVALID, ap_CS_fsm_state65, icmp_ln115_reg_754)
    begin
        if ((not(((icmp_ln115_reg_754 = ap_const_lv1_0) and (m_axi_ps_ddr_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state65))) then 
    ...
    empty_50_fu_360_p2 <= std_logic_vector(unsigned(loop_index4_fu_114) + unsigned(ap_const_lv5_1));
    empty_53_fu_507_p2 <= std_logic_vector(unsigned(loop_index_fu_122) + unsigned(ap_const_lv5_1));
    empty_57_fu_578_p2 <= std_logic_vector(unsigned(loop_index_i_fu_126) + unsigned(ap_const_lv3_1));
    ...
    icmp_ln115_fu_421_p2 <= "1" when (grp_fu_403_p2 = readLinIndex_fu_409_p5) else "0";
    ...
    m_axi_ps_ddr_BREADY_assign_proc : process(m_axi_ps_ddr_BVALID, ap_CS_fsm_state72, ap_CS_fsm_state58, ap_CS_fsm_state65, icmp_ln115_reg_754)
    begin
        if (((not(((icmp_ln115_reg_754 = ap_const_lv1_0) and (m_axi_ps_ddr_BVALID = ap_const_logic_0))) and (icmp_ln115_reg_754 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state65)) or ((ap_const_logic_1 = ap_CS_fsm_state58) and (m_axi_ps_ddr_BVALID = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_ps_ddr_BVALID = ap_const_logic_1)))) then 
    ...
    m_axi_ps_ddr_WDATA_assign_proc : process(ap_CS_fsm_state67, ap_CS_fsm_state53, ap_CS_fsm_state60, data_load_reg_798, tmp_6_reg_826, add_ln117_1_reg_831)
    begin
    ...
    ps_ddr_blk_n_B_assign_proc : process(m_axi_ps_ddr_BVALID, ap_CS_fsm_state72, ap_CS_fsm_state58, ap_CS_fsm_state65, icmp_ln115_reg_754)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state58) or (ap_const_logic_1 = ap_CS_fsm_state72) or ((icmp_ln115_reg_754 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state65)))) then 
    ...
    shl_ln122_1_fu_446_p6 <= ((((trunc_ln122_1_fu_443_p1 & ringbuffer_header_bytes_load_9_reg_699) & reg_321) & reg_326) & ap_const_lv2_0);
    shl_ln_fu_430_p6 <= ((((trunc_ln122_fu_427_p1 & ringbuffer_header_bytes_load_9_reg_699) & reg_321) & reg_326) & ap_const_lv5_0);
    sub_ln122_fu_459_p2 <= std_logic_vector(unsigned(shl_ln_fu_430_p6) - unsigned(shl_ln122_1_fu_446_p6));
    tmp_6_fu_588_p5 <= loop_index_i_fu_126(2 - 1 downto 0);
    trunc_ln116_fu_607_p1 <= dropped_lin_counter(8 - 1 downto 0);
    trunc_ln122_1_fu_443_p1 <= ringbuffer_header_bytes_load_8_reg_692(6 - 1 downto 0);
    trunc_ln122_fu_427_p1 <= ringbuffer_header_bytes_load_8_reg_692(3 - 1 downto 0);
