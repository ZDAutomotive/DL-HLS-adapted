...
set C_modelArgMapList {[ 
	{ "Name" : "clu_addr", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "can_ptr","offset": { "type": "dynamic","port_name": "can_ptr","bundle": "EN"},"direction": "READWRITE"},{"cName": "uart_ptr","offset": { "type": "dynamic","port_name": "uart_ptr","bundle": "EN"},"direction": "READONLY"},{"cName": "lin_ptr","offset": { "type": "dynamic","port_name": "lin_ptr","bundle": "EN"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "linbase", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ linbase sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "linbase", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "linbase", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "5"],
		...
		"Port" : [
			{"Name" : "clu_addr", "Type" : "MAXI", "Direction" : "IO",
				...
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_single_lin_process_1_Pipeline_VITIS_LOOP_176_1_fu_441", "Port" : "clu_addr", "Inst_start_state" : "33", "Inst_end_state" : "34"}]},
			{"Name" : "linbase", "Type" : "None", "Direction" : "I"},
			{"Name" : "ps_ddr", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_write_lin_ddr_1_fu_450", "Port" : "ps_ddr", "Inst_start_state" : "43", "Inst_end_state" : "44"}]},
			...
			{"Name" : "dropped_lin_counter", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_write_lin_ddr_1_fu_450", "Port" : "dropped_lin_counter", "Inst_start_state" : "43", "Inst_end_state" : "44"}]}],
		"Loop" : [
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_single_lin_process_1_Pipeline_VITIS_LOOP_176_1_fu_441", "Parent" : "0", "Child" : ["4"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_single_lin_process_1_Pipeline_VITIS_LOOP_176_1_fu_441.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_lin_ddr_1_fu_450", "Parent" : "0", "Child" : ["6", "7", "8"],
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_lin_ddr_1_fu_450.ringbuffer_header_bytes_U", "Parent" : "5"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_lin_ddr_1_fu_450.urem_32ns_32ns_32_36_seq_1_U46", "Parent" : "5"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_lin_ddr_1_fu_450.mux_42_8_1_1_U47", "Parent" : "5"}]}
...
set Spec2ImplPortList { 
	...
	linbase { ap_none {  { linbase in_data 0 64 } } }
