...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { PL_Ctrl_fifo_index_address0 { O 3 vector } PL_Ctrl_fifo_index_ce0 { O 1 bit } PL_Ctrl_fifo_index_we0 { O 1 bit } PL_Ctrl_fifo_index_d0 { O 32 vector } } \
} "
} else {
