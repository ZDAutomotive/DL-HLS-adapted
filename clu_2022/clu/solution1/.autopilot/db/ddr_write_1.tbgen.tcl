...
set C_modelArgList {
	...
	{ PL_Ctrl_fifo_index int 32 regular {array 8 { 0 3 } 0 1 } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ps_ddr", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "can_ddr","offset": { "type": "dynamic","port_name": "can_ddr","bundle": "EN"},"direction": "READWRITE"},{"cName": "uart_ddr","offset": { "type": "dynamic","port_name": "uart_ddr","bundle": "EN"},"direction": "READWRITE"},{"cName": "lin_ddr","offset": { "type": "dynamic","port_name": "lin_ddr","bundle": "EN"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "PL_Ctrl_fifo_index", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ PL_Ctrl_fifo_index_d0 sc_out sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "PL_Ctrl_fifo_index_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "PL_Ctrl_fifo_index", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "7", "8", "9"],
		...
		"Port" : [
			{"Name" : "ps_ddr", "Type" : "MAXI", "Direction" : "IO",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_ddr_write_1_Pipeline_1_fu_366", "Port" : "ps_ddr", "Inst_start_state" : "51", "Inst_end_state" : "52"},
					{"ID" : "4", "SubInstance" : "grp_ddr_write_1_Pipeline_2_fu_376", "Port" : "ps_ddr", "Inst_start_state" : "58", "Inst_end_state" : "59"}]},
			...
			{"Name" : "uart_fifo", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_ddr_write_1_Pipeline_1_fu_366", "Port" : "uart_fifo", "Inst_start_state" : "51", "Inst_end_state" : "52"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_Pipeline_1_fu_366", "Parent" : "0", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_Pipeline_1_fu_366.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_Pipeline_2_fu_376", "Parent" : "0", "Child" : ["5", "6"],
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_Pipeline_2_fu_376.mux_42_8_1_1_U5", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ddr_write_1_Pipeline_2_fu_376.flow_control_loop_pipe_sequential_init_U", "Parent" : "4"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "138", "Max" : "358"}
	, {"Name" : "Interval", "Min" : "138", "Max" : "358"}
]}
...
set Spec2ImplPortList { 
	...
	PL_Ctrl_fifo_index { ap_memory {  { PL_Ctrl_fifo_index_address0 mem_address 1 3 }  { PL_Ctrl_fifo_index_ce0 mem_ce 1 1 }  { PL_Ctrl_fifo_index_we0 mem_we 1 1 }  { PL_Ctrl_fifo_index_d0 mem_din 1 32 } } }
