...
attribute shreg_extract : string;
    ...
    signal exitcond105_fu_103_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal uart_fifo_load_reg_156 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_cast_fu_125_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal loop_index_fu_52 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_74_fu_109_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_loop_index_load : STD_LOGIC_VECTOR (7 downto 0);
    signal loop_index_cast1_fu_115_p1 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    loop_index_fu_52_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond105_fu_103_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index_fu_52 <= empty_74_fu_109_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index_fu_52 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                uart_fifo_load_reg_156 <= uart_fifo_q0;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond105_fu_103_p2)
    begin
        if (((exitcond105_fu_103_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, loop_index_fu_52, ap_loop_init)
    begin
    ...
    empty_74_fu_109_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_load) + unsigned(ap_const_lv8_1));
    empty_75_fu_119_p2 <= std_logic_vector(unsigned(empty) + unsigned(loop_index_cast1_fu_115_p1));
    exitcond105_fu_103_p2 <= "1" when (ap_sig_allocacmp_loop_index_load = ap_const_lv8_CC) else "0";
    loop_index_cast1_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_loop_index_load),11));
    ...
    m_axi_ps_ddr_WDATA <= uart_fifo_load_reg_156;
    ...
    uart_fifo_address0 <= p_cast_fu_125_p1(11 - 1 downto 0);
