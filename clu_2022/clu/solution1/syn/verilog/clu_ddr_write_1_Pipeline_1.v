...
wire   [0:0] exitcond105_fu_103_p2;
...
reg   [7:0] uart_fifo_load_reg_156;
wire   [63:0] p_cast_fu_125_p1;
wire    ap_block_pp0_stage0_01001;
reg   [7:0] loop_index_fu_52;
wire   [7:0] empty_74_fu_109_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_loop_index_load;
wire   [10:0] loop_index_cast1_fu_115_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond105_fu_103_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_fu_52 <= empty_74_fu_109_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_52 <= 8'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond105_fu_103_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign empty_74_fu_109_p2 = (ap_sig_allocacmp_loop_index_load + 8'd1);

assign empty_75_fu_119_p2 = (empty + loop_index_cast1_fu_115_p1);

assign exitcond105_fu_103_p2 = ((ap_sig_allocacmp_loop_index_load == 8'd204) ? 1'b1 : 1'b0);

assign loop_index_cast1_fu_115_p1 = ap_sig_allocacmp_loop_index_load;
...
assign m_axi_ps_ddr_WDATA = uart_fifo_load_reg_156;
...
assign uart_fifo_address0 = p_cast_fu_125_p1;
