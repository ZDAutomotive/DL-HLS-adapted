...
set solution_dir "D:/clu_2022/clu/solution1"
set debug_dir "D:/clu_2022/clu/solution1/.debug"
...
set Interfaces {
    s_axi_EN {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 can_ptr_1 W 0x0 "Data signal of can_ptr" {{0 32 can_ptr W 0 "Bit 31 to 0 of can_ptr"}}} {0x14 can_ptr_2 W 0x0 "Data signal of can_ptr" {{0 32 can_ptr W 0 "Bit 63 to 32 of can_ptr"}}} {0x1c uart_ptr_1 W 0x0 "Data signal of uart_ptr" {{0 32 uart_ptr W 0 "Bit 31 to 0 of uart_ptr"}}} {0x20 uart_ptr_2 W 0x0 "Data signal of uart_ptr" {{0 32 uart_ptr W 0 "Bit 63 to 32 of uart_ptr"}}} {0x28 lin_ptr_1 W 0x0 "Data signal of lin_ptr" {{0 32 lin_ptr W 0 "Bit 31 to 0 of lin_ptr"}}} {0x2c lin_ptr_2 W 0x0 "Data signal of lin_ptr" {{0 32 lin_ptr W 0 "Bit 63 to 32 of lin_ptr"}}} {0x34 received_can R 0x0 "Data signal of received_can" {{0 32 received_can R 0 "Bit 31 to 0 of received_can"}}} {0x38 received_can_ctrl R 0x0 "Control signal of received_can" {{0 1 received_can_ap_vld R 0 "Control signal received_can_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x44 received_uart R 0x0 "Data signal of received_uart" {{0 32 received_uart R 0 "Bit 31 to 0 of received_uart"}}} {0x48 received_uart_ctrl R 0x0 "Control signal of received_uart" {{0 1 received_uart_ap_vld R 0 "Control signal received_uart_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x54 received_lin R 0x0 "Data signal of received_lin" {{0 32 received_lin R 0 "Bit 31 to 0 of received_lin"}}} {0x58 received_lin_ctrl R 0x0 "Control signal of received_lin" {{0 1 received_lin_ap_vld R 0 "Control signal received_lin_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x64 can_en W 0x0 "Data signal of can_en" {{0 32 can_en W 0 "Bit 31 to 0 of can_en"}}} {0x6c uart_en W 0x0 "Data signal of uart_en" {{0 8 uart_en W 0 "Bit 7 to 0 of uart_en"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 lin_en W 0x0 "Data signal of lin_en" {{0 32 lin_en W 0 "Bit 31 to 0 of lin_en"}}} {0x7c can_ddr_1 W 0x0 "Data signal of can_ddr" {{0 32 can_ddr W 0 "Bit 31 to 0 of can_ddr"}}} {0x80 can_ddr_2 W 0x0 "Data signal of can_ddr" {{0 32 can_ddr W 0 "Bit 63 to 32 of can_ddr"}}} {0x88 uart_ddr_1 W 0x0 "Data signal of uart_ddr" {{0 32 uart_ddr W 0 "Bit 31 to 0 of uart_ddr"}}} {0x8c uart_ddr_2 W 0x0 "Data signal of uart_ddr" {{0 32 uart_ddr W 0 "Bit 63 to 32 of uart_ddr"}}} {0x94 lin_ddr_1 W 0x0 "Data signal of lin_ddr" {{0 32 lin_ddr W 0 "Bit 31 to 0 of lin_ddr"}}} {0x98 lin_ddr_2 W 0x0 "Data signal of lin_ddr" {{0 32 lin_ddr W 0 "Bit 63 to 32 of lin_ddr"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
